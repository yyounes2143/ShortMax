...
public final class d extends BaseCampaignParser {
    ...
    public static final a f52817d = new a(null);
    ...
    protected CampaignInfo k(@NotNull String info, boolean z10) {
        ...
        Logger.f41511a.e("CampaignNewTag", "FBInstallReferrerParser decodedInfo -> " + decode);
        ...
        if (str != null && str.length() != 0) {
            ...
            logger.e("CampaignNewTag", "FBInstallReferrerParser decrypt result -> " + a10);
