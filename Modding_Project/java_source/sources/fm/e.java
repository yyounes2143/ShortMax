...
public class e extends j0 {
    ...
    private AdManagerInterstitialAd f51822h;
    ...
    private static final class a extends AdManagerInterstitialAdLoadCallback {
        ...
        private final e f51823a;
        @NonNull

        /* renamed from: b  reason: collision with root package name */
        private final n0 f51824b;
        ...
        public void onAdLoaded(@NonNull AdManagerInterstitialAd adManagerInterstitialAd) {
            this.f51823a.f51822h = adManagerInterstitialAd;
            this.f51823a.C();
            this.f51824b.a(this.f51823a);
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
            this.f51824b.b(this.f51823a, new fr.a(fr.a.f51921q, loadAdError.getCode(), loadAdError.getMessage()));
        }
    }
    ...
    protected void K(@NonNull Activity activity, @NonNull i0 i0Var) {
        AdManagerInterstitialAd adManagerInterstitialAd = this.f51822h;
        if (adManagerInterstitialAd != null) {
            adManagerInterstitialAd.setFullScreenContentCallback(new c(i0Var));
            this.f51822h.show(activity);
            return;
        }
