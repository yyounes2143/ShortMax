...
class d extends e0 {
    ...
    private final AdSize f51818h;
    @Nullable

    /* renamed from: i  reason: collision with root package name */
    private AdManagerAdView f51819i;
    ...
    private static final class b extends AdListener {
        ...
        private final InternalGAMAd f51820a;
        @NonNull

        /* renamed from: b  reason: collision with root package name */
        private final n0 f51821b;

        @Override // com.google.android.gms.ads.AdListener
        public void onAdClicked() {
            d0 k10 = this.f51820a.k();
            if (k10 != null) {
                k10.onAdClicked();
            }
        }
        ...
        public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
            this.f51821b.b(this.f51820a, new fr.a(fr.a.f51921q, loadAdError.getCode(), loadAdError.getMessage()));
        }
    ...
    public void B(@NonNull Context context, @NonNull n0 n0Var) {
        ...
        this.f51819i = adManagerAdView;
        adManagerAdView.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
        this.f51819i.setAdUnitId(l());
        this.f51819i.setAdListener(new b(this, n0Var));
        this.f51819i.setAdSize(this.f51818h);
        this.f51819i.loadAd(fm.b.a(n(), o()));
    }
    ...
    @UiThread
    protected void j() {
        AdManagerAdView adManagerAdView = this.f51819i;
