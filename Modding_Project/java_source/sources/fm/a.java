...
public class a extends dm.a {
    ...
    static /* synthetic */ class C0746a {
        ...
        static {
            ...
            try {
                f51816a[AdsFormat.Banner_320x50.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51816a[AdsFormat.Banner_728x90.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51816a[AdsFormat.Banner_300x250.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f51816a[AdsFormat.Interstitial.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f51816a[AdsFormat.InterstitialStatic.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51816a[AdsFormat.InterstitialVideo.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f51816a[AdsFormat.Rewarded.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f51816a[AdsFormat.RewardedStatic.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f51816a[AdsFormat.RewardedVideo.ordinal()] = 10;
    ...
    public InternalGAMAd e(@NonNull j jVar, @NonNull AdsFormat adsFormat, @NonNull t tVar) {
        switch (C0746a.f51816a[adsFormat.ordinal()]) {
            case 1:
            case 2:
