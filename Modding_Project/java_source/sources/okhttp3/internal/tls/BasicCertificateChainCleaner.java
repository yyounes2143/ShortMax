...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public static final Companion f64169c = new Companion(null);
    @NotNull

    /* renamed from: b  reason: collision with root package name */
    private final TrustRootIndex f64170b;
    ...
    public List<Certificate> a(@NotNull List<? extends Certificate> chain, @NotNull String hostname) throws SSLPeerUnverifiedException {
        ...
        for (int i10 = 0; i10 < 9; i10++) {
            ...
            X509Certificate findByIssuerAndSignature = this.f64170b.findByIssuerAndSignature(x509Certificate);
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if ((obj instanceof BasicCertificateChainCleaner) && Intrinsics.areEqual(((BasicCertificateChainCleaner) obj).f64170b, this.f64170b)) {
            return true;
        }
        return false;
    }
