...
public final class ConscryptSocketAdapter implements SocketAdapter {
    ...
    public static final Companion f64153a = new Companion(null);
    @NotNull

    /* renamed from: b  reason: collision with root package name */
    private static final DeferredSocketAdapter.Factory f64154b = new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.ConscryptSocketAdapter$Companion$factory$1
        ...
        public boolean matchesSocket(@NotNull SSLSocket sslSocket) {
            Intrinsics.checkNotNullParameter(sslSocket, "sslSocket");
            if (ConscryptPlatform.f64110e.c() && Conscrypt.isConscrypt(sslSocket)) {
                return true;
            }
            return false;
        }
    ...
    public static final class Companion {
        ...
        public final DeferredSocketAdapter.Factory a() {
            return ConscryptSocketAdapter.f64154b;
        }
    ...
    public boolean isSupported() {
        return ConscryptPlatform.f64110e.c();
    }
