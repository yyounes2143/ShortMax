...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    @NonNull
    public static NavHostFragment create(@NavigationRes int i10) {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        navHostController2.enableOnBackPressed(z10);
        Bundle bundle3 = null;
        ...
        if (i11 != 0) {
            this.mNavController.setGraph(i11);
        } else {
            ...
            if (i10 != 0) {
                this.mNavController.setGraph(i10, bundle3);
            }
        }
    ...
    @NonNull
    public static NavHostFragment create(@NavigationRes int i10, @Nullable Bundle bundle) {
        Bundle bundle2;
        if (i10 != 0) {
            bundle2 = new Bundle();
            bundle2.putInt(KEY_GRAPH_ID, i10);
        } else {
            bundle2 = null;
        }
        if (bundle != null) {
