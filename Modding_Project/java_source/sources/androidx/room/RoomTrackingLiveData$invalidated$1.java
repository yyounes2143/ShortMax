...
public final class RoomTrackingLiveData$invalidated$1 extends SuspendLambda implements Function2<g0, rs.c<? super Unit>, Object> {
    int label;
    final /* synthetic */ RoomTrackingLiveData<T> this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoomTrackingLiveData$invalidated$1(RoomTrackingLiveData<T> roomTrackingLiveData, rs.c<? super RoomTrackingLiveData$invalidated$1> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(g0 g0Var, rs.c<? super Unit> cVar) {
        return ((RoomTrackingLiveData$invalidated$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
