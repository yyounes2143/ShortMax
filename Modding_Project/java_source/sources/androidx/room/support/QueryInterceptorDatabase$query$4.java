...
@Metadata
@kotlin.coroutines.jvm.internal.d(c = "androidx.room.support.QueryInterceptorDatabase$query$4", f = "QueryInterceptorDatabase.android.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class QueryInterceptorDatabase$query$4 extends SuspendLambda implements Function2<g0, rs.c<? super Unit>, Object> {
    ...
    public QueryInterceptorDatabase$query$4(QueryInterceptorDatabase queryInterceptorDatabase, SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram, rs.c<? super QueryInterceptorDatabase$query$4> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(g0 g0Var, rs.c<? super Unit> cVar) {
        return ((QueryInterceptorDatabase$query$4) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
