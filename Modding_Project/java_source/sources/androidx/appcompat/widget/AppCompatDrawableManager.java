...
public final class AppCompatDrawableManager {
            ...
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                    ...
                    private void setPorterDuffColorFilter(Drawable drawable, int i10, PorterDuff.Mode mode) {
                        ...
                        mutate.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(i10, mode));
                    }
    ...
    synchronized Drawable onDrawableLoadedFromResources(@NonNull Context context, @NonNull VectorEnabledTintResources vectorEnabledTintResources, @DrawableRes int i10) {
