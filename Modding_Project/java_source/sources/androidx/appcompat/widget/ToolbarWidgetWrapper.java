...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void animateToVisibility(int i10) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = setupAnimatorToVisibility(i10, DEFAULT_FADE_DURATION_MS);
    ...
    public void setNavigationMode(int i10) {
        ...
        if (i10 != i11) {
            if (i11 != 1) {
                if (i11 == 2 && (view = this.mTabView) != null) {
                    ViewParent parent = view.getParent();
                    Toolbar toolbar = this.mToolbar;
                    if (parent == toolbar) {
                        toolbar.removeView(this.mTabView);
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i10, long j10) {
        ...
        return animate.alpha(f10).setDuration(j10).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
