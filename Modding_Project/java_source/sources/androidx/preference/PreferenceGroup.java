...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(obtainStyledAttributes, i12, i12, true);
    ...
    public <T extends Preference> T findPreference(@NonNull CharSequence charSequence) {
        ...
        if (charSequence != null) {
            ...
            int preferenceCount = getPreferenceCount();
            for (int i10 = 0; i10 < preferenceCount; i10++) {
                T t11 = (T) getPreference(i10);
                if (TextUtils.equals(t11.getKey(), charSequence)) {
                    return t11;
                }
                if ((t11 instanceof PreferenceGroup) && (t10 = (T) ((PreferenceGroup) t11).findPreference(charSequence)) != null) {
                    return t10;
                }
            }
            return null;
