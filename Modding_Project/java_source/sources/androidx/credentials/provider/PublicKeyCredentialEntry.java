...
public final class PublicKeyCredentialEntry extends CredentialEntry {
    ...
    public static final class Api28Impl {
        ...
        public static final Slice toSlice(@NotNull PublicKeyCredentialEntry entry) {
            ...
            Slice.Builder addIcon = new Slice.Builder(Uri.EMPTY, new SliceSpec(type, 1)).addText(typeDisplayName, null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_TYPE_DISPLAY_NAME)).addText(username, null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_TITLE)).addText(displayName, null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_SUBTITLE)).addText(str, null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_AUTO_ALLOWED)).addText(beginGetCredentialOption.getId(), null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_OPTION_ID)).addIcon(icon, null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_ICON));
            try {
                if (icon.getResId() == R.drawable.ic_passkey) {
                    addIcon.addInt(1, null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_DEFAULT_ICON_RES_ID));
                }
            ...
            if (CredentialOption.Companion.extractAutoSelectValue$credentials_release(beginGetCredentialOption.getCandidateQueryData())) {
                addIcon.addInt(1, null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_AUTO_SELECT_FROM_OPTION));
            }
            if (lastUsedTime != null) {
                addIcon.addLong(lastUsedTime.toEpochMilli(), null, CollectionsKt.e(PublicKeyCredentialEntry.SLICE_HINT_LAST_USED_TIME_MILLIS));
            }
    ...
    public static final class Builder {
        ...
        public final PublicKeyCredentialEntry build() {
            ...
            Icon icon = this.icon;
            Intrinsics.checkNotNull(icon);
            return new PublicKeyCredentialEntry(charSequence, charSequence2, string, pendingIntent, icon, this.lastUsedTime, this.autoSelectAllowed, this.beginGetPublicKeyCredentialOption, false, false, ViewUtils.EDGE_TO_EDGE_FLAGS, null);
        }
    ...
    public /* synthetic */ PublicKeyCredentialEntry(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, PendingIntent pendingIntent, Icon icon, Instant instant, boolean z10, BeginGetPublicKeyCredentialOption beginGetPublicKeyCredentialOption, boolean z11, boolean z12, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(charSequence, charSequence2, charSequence3, pendingIntent, icon, instant, z10, beginGetPublicKeyCredentialOption, (i10 & 256) != 0 ? false : z11, (i10 & 512) != 0 ? false : z12);
    }
    ...
    public PublicKeyCredentialEntry(@NotNull CharSequence username, @Nullable CharSequence charSequence, @NotNull CharSequence typeDisplayName, @NotNull PendingIntent pendingIntent, @NotNull Icon icon, @Nullable Instant instant, boolean z10, @NotNull BeginGetPublicKeyCredentialOption beginGetPublicKeyCredentialOption, boolean z11, boolean z12) {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public PublicKeyCredentialEntry(@org.jetbrains.annotations.NotNull android.content.Context r16, @org.jetbrains.annotations.NotNull java.lang.CharSequence r17, @org.jetbrains.annotations.NotNull android.app.PendingIntent r18, @org.jetbrains.annotations.NotNull androidx.credentials.provider.BeginGetPublicKeyCredentialOption r19, @org.jetbrains.annotations.Nullable java.lang.CharSequence r20, @org.jetbrains.annotations.Nullable java.time.Instant r21, @org.jetbrains.annotations.NotNull android.graphics.drawable.Icon r22, boolean r23) {
        /*
            r15 = this;
            r0 = r16
