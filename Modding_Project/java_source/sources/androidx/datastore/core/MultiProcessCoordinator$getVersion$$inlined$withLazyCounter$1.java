...
public final class MultiProcessCoordinator$getVersion$$inlined$withLazyCounter$1 extends SuspendLambda implements Function2<g0, c<? super Integer>, Object> {
    int label;
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super Integer> cVar) {
        return ((MultiProcessCoordinator$getVersion$$inlined$withLazyCounter$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            return kotlin.coroutines.jvm.internal.a.d(sharedCounter.getValue());
        }
