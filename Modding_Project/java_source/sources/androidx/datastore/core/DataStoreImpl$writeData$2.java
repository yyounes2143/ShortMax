...
@Metadata
@d(c = "androidx.datastore.core.DataStoreImpl$writeData$2", f = "DataStoreImpl.kt", l = {352, 353}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class DataStoreImpl$writeData$2<T> extends SuspendLambda implements Function2<WriteScope<T>, c<? super Unit>, Object> {
    ...
    public DataStoreImpl$writeData$2(Ref.IntRef intRef, DataStoreImpl<T> dataStoreImpl, T t10, boolean z10, c<? super DataStoreImpl$writeData$2> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull WriteScope<T> writeScope, @Nullable c<? super Unit> cVar) {
        return ((DataStoreImpl$writeData$2) create(writeScope, cVar)).invokeSuspend(Unit.f60915a);
    }
