...
final class SharedPreferencesMigrationKt$getMigrationFunction$1 extends SuspendLambda implements n<SharedPreferencesView, Preferences, c<? super Preferences>, Object> {
    ...
    @Override // at.n
    @Nullable
    public final Object invoke(@NotNull SharedPreferencesView sharedPreferencesView, @NotNull Preferences preferences, @Nullable c<? super Preferences> cVar) {
        ...
        return sharedPreferencesMigrationKt$getMigrationFunction$1.invokeSuspend(Unit.f60915a);
    }
