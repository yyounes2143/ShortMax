...
public final class PreferencesFileSerializer implements Serializer<Preferences> {
    ...
    @Nullable
    public Object readFrom(@NotNull InputStream inputStream, @NotNull c<? super Preferences> cVar) throws IOException, CorruptionException {
    ...
    public /* bridge */ /* synthetic */ Object writeTo(Preferences preferences, OutputStream outputStream, c cVar) {
        return writeTo2(preferences, outputStream, (c<? super Unit>) cVar);
    }
    ...
    public Object writeTo2(@NotNull Preferences preferences, @NotNull OutputStream outputStream, @NotNull c<? super Unit> cVar) throws IOException, CorruptionException {
