...
public final class FieldSet<T extends FieldDescriptorLite<T>> {
            ...
            if (key.isRepeated()) {
                if (!z10) {
                    ...
                    for (int i10 = 0; i10 < size; i10++) {
                        list.add(FieldSet.cloneIfMutable(list2.get(i10)));
                    }
                    return;
                }
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z10, boolean z11) {
        SmallSortedMap<T, Object> newFieldMap = SmallSortedMap.newFieldMap();
        int numArrayEntries = smallSortedMap.getNumArrayEntries();
        for (int i10 = 0; i10 < numArrayEntries; i10++) {
            cloneFieldEntry(newFieldMap, smallSortedMap.getArrayEntryAt(i10), z10, z11);
        }
        for (Map.Entry<T, Object> entry : smallSortedMap.getOverflowEntries()) {
            cloneFieldEntry(newFieldMap, entry, z10, z11);
        }
        return newFieldMap;
    }

    private static <T extends FieldDescriptorLite<T>> void cloneFieldEntry(Map<T, Object> map, Map.Entry<T, Object> entry, boolean z10, boolean z11) {
        T key = entry.getKey();
        Object value = entry.getValue();
        if (z11 && (value instanceof LazyField)) {
    ...
    public static int computeFieldSize(FieldDescriptorLite<?> fieldDescriptorLite, Object obj) {
        ...
        if (fieldDescriptorLite.isRepeated()) {
            ...
            if (fieldDescriptorLite.isPacked()) {
                ...
                int i11 = 0;
                while (i10 < size) {
                    i11 += computeElementSizeNoTag(liteType, list.get(i10));
                    i10++;
                }
            ...
            int i12 = 0;
            while (i10 < size) {
                i12 += computeElementSize(liteType, number, list.get(i10));
                i10++;
            }
            return i12;
        }
        ...
        if (fieldDescriptorLite.isRepeated()) {
            ...
            if (fieldDescriptorLite.isPacked()) {
                ...
                for (int i12 = 0; i12 < size; i12++) {
                    i11 += computeElementSizeNoTag(liteType, list.get(i12));
                }
