...
interface Reader {
    ...
    <T> void mergeGroupField(T t10, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void mergeMessageField(T t10, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;
