...
public final class Utf8 {
    ...
    public static abstract class Processor {
            ...
            if ((i10 | i11 | ((byteBuffer.limit() - i10) - i11)) >= 0) {
                ...
                while (i10 < i12) {
                    ...
                    if (DecodeUtil.isOneByte(b11)) {
                        ...
                        int i18 = i10 + 3;
                        i10 += 4;
                        DecodeUtil.handleFourBytes(b11, b13, byteBuffer.get(i10 + 2), byteBuffer.get(i18), cArr, i14);
                        i14 += 2;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
        ...
        abstract int encodeUtf8(String str, byte[] bArr, int i10, int i11);
        ...
        final void encodeUtf8Default(String str, ByteBuffer byteBuffer) {
            ...
            while (i11 < length) {
                try {
                    ...
                    throw new ArrayIndexOutOfBoundsException("Failed writing " + str.charAt(i11) + " at index " + (byteBuffer.position() + Math.max(i11, (position - byteBuffer.position()) + 1)));
                }
            }
            if (i11 == length) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int encode(String str, byte[] bArr, int i10, int i11) {
        return processor.encodeUtf8(str, bArr, i10, i11);
    }
        ...
        while (true) {
            if (i10 < length) {
                ...
                if (charAt < 2048) {
                    ...
                    i11 += encodedLengthGeneral(str, i10);
                    break;
                }
            } else {
                break;
    ...
    private static int encodedLengthGeneral(String str, int i10) {
        int length = str.length();
        int i11 = 0;
        while (i10 < length) {
            char charAt = str.charAt(i10);
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        private static int unsafeEstimateConsecutiveAscii(byte[] bArr, long j10, int i10) {
            ...
            while (true) {
                int i13 = i11 + 8;
                if (i13 > i10 || (UnsafeUtil.getLong((Object) bArr, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j10) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j10 += 8;
                i11 = i13;
            ...
            if ((i10 | i11 | ((byteBuffer.limit() - i10) - i11)) >= 0) {
                ...
                while (addressOffset < j10) {
                    ...
                    if (DecodeUtil.isOneByte(b11)) {
                        ...
                        addressOffset += 4;
                        DecodeUtil.handleFourBytes(b11, UnsafeUtil.getByte(j11), UnsafeUtil.getByte(2 + addressOffset), UnsafeUtil.getByte(j13), cArr, i13);
                        i13 += 2;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
        ...
        @Override // androidx.datastore.preferences.protobuf.Utf8.Processor
        int encodeUtf8(String str, byte[] bArr, int i10, int i11) {
            long j10;
            String str2;
            String str3;
            int i12;
                ...
                while (i12 < length) {
                    ...
                    if (charAt2 < c10 && position < limit) {
                        ...
                        if (charAt2 < 2048 && position <= limit - 2) {
                            ...
                            } else if (55296 <= charAt2 && charAt2 <= 57343 && ((i10 = i12 + 1) == length || !Character.isSurrogatePair(charAt2, str.charAt(i10)))) {
        ...
        */
        ...
        private static int unsafeEstimateConsecutiveAscii(long j10, int i10) {
            ...
            int i13 = i10 - i11;
            while (i13 >= 8 && (UnsafeUtil.getLong(j10) & (-9187201950435737472L)) == 0) {
                j10 += 8;
                i13 -= 8;
            }
            return i10 - i13;
            ...
            if ((i10 | i11 | ((bArr.length - i10) - i11)) >= 0) {
                ...
                while (i10 < i12) {
                    ...
                    if (DecodeUtil.isOneByte(b11)) {
                        ...
                        int i18 = i10 + 3;
                        i10 += 4;
                        DecodeUtil.handleFourBytes(b11, b13, bArr[i10 + 2], bArr[i18], cArr, i14);
                        i14 += 2;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
