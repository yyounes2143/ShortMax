    ...
    public static final class StringSet extends GeneratedMessageLite<StringSet, Builder> implements StringSetOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<StringSet, Builder> implements StringSetOrBuilder {
            ...
            public Builder setStrings(int i10, String str) {
                copyOnWrite();
                ((StringSet) this.instance).setStrings(i10, str);
                return this;
            }
    ...
    public static final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
            ...
            public Builder setBoolean(boolean z10) {
                copyOnWrite();
                ((Value) this.instance).setBoolean(z10);
                return this;
            }
            ...
            public Builder setDouble(double d10) {
                copyOnWrite();
                ((Value) this.instance).setDouble(d10);
                return this;
            }

            public Builder setFloat(float f10) {
                copyOnWrite();
                ((Value) this.instance).setFloat(f10);
                return this;
            }

            public Builder setInteger(int i10) {
                copyOnWrite();
                ((Value) this.instance).setInteger(i10);
                return this;
            }

            public Builder setLong(long j10) {
                copyOnWrite();
                ((Value) this.instance).setLong(j10);
                return this;
            }
