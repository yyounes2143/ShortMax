...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract e<Long> getLastCancelAllTimeMillis();

    @NonNull
    public abstract LiveData<Long> getLastCancelAllTimeMillisLiveData();

    @NonNull
    public abstract e<WorkInfo> getWorkInfoById(@NonNull UUID uuid);
    ...
    @NonNull
    public abstract e<List<WorkInfo>> getWorkInfosByTag(@NonNull String str);

    @NonNull
    public abstract LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String str);

    @NonNull
    public abstract e<List<WorkInfo>> getWorkInfosForUniqueWork(@NonNull String str);
    ...
    @NonNull
    public abstract e<UpdateResult> updateWork(@NonNull WorkRequest workRequest);
