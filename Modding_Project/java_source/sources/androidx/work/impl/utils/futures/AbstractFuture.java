...
public abstract class AbstractFuture<V> implements e<V> {
    ...
    public static final class Cancellation {
        ...
        Cancellation(boolean z10, @Nullable Throwable th2) {
    ...
    public static final class SetFuture<V> implements Runnable {
        final e<? extends V> future;
        final AbstractFuture<V> owner;

        SetFuture(AbstractFuture<V> abstractFuture, e<? extends V> eVar) {
    ...
    static Object getFutureValue(e<?> eVar) {
        if (eVar instanceof AbstractFuture) {
            Object obj = ((AbstractFuture) eVar).value;
            if (obj instanceof Cancellation) {
        ...
        try {
            ...
            if (!isCancelled) {
                return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + eVar, e10));
            }
    ...
    public final boolean cancel(boolean z10) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractFuture, obj, cancellation)) {
                ...
                e<? extends V> eVar = ((SetFuture) obj).future;
                if (eVar instanceof AbstractFuture) {
                    abstractFuture = (AbstractFuture) eVar;
    ...
    public boolean setFuture(e<? extends V> eVar) {
        ...
        if (obj == null) {
            if (eVar.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(eVar))) {
                    return false;
                }
                complete(this);
                return true;
        ...
        if (obj instanceof Cancellation) {
            eVar.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
