...
public final class DrawModifierKt {
    ...
    public static final Modifier drawBehind(@NotNull Modifier modifier, @NotNull final Function1<? super DrawScope, Unit> onDraw) {
        ...
        if (InspectableValueKt.isDebugInspectorInfoEnabled()) {
            noInspectorInfo = new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.DrawModifierKt$drawBehind$$inlined$debugInspectorInfo$1
                {
                    super(1);
                }
        ...
        return modifier.then(new DrawBackgroundModifier(onDraw, noInspectorInfo));
    }
    ...
    public static final Modifier drawWithCache(@NotNull Modifier modifier, @NotNull final Function1<? super CacheDrawScope, DrawResult> onBuildDrawCache) {
        ...
        if (InspectableValueKt.isDebugInspectorInfoEnabled()) {
            noInspectorInfo = new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.DrawModifierKt$drawWithCache$$inlined$debugInspectorInfo$1
                {
                    super(1);
                }
        ...
        return ComposedModifierKt.composed(modifier, noInspectorInfo, new n<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.ui.draw.DrawModifierKt$drawWithCache$2
    ...
    public static final Modifier drawWithContent(@NotNull Modifier modifier, @NotNull final Function1<? super ContentDrawScope, Unit> onDraw) {
        ...
        Intrinsics.checkNotNullParameter(onDraw, "onDraw");
        if (InspectableValueKt.isDebugInspectorInfoEnabled()) {
            noInspectorInfo = new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.DrawModifierKt$drawWithContent$$inlined$debugInspectorInfo$1
                {
                    super(1);
                }
        ...
        return modifier.then(new DrawWithContentModifier(onDraw, noInspectorInfo));
    }
}
