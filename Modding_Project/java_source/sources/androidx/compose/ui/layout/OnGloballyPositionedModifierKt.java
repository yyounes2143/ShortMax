...
public final class OnGloballyPositionedModifierKt {
    ...
    public static final Modifier onGloballyPositioned(@NotNull Modifier modifier, @NotNull final Function1<? super LayoutCoordinates, Unit> onGloballyPositioned) {
        ...
        if (InspectableValueKt.isDebugInspectorInfoEnabled()) {
            noInspectorInfo = new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.layout.OnGloballyPositionedModifierKt$onGloballyPositioned$$inlined$debugInspectorInfo$1
                {
                    super(1);
                }
