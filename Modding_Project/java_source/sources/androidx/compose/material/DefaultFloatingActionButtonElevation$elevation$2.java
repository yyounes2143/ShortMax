...
final class DefaultFloatingActionButtonElevation$elevation$2 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {
    ...
    public DefaultFloatingActionButtonElevation$elevation$2(Animatable<Dp, AnimationVector1D> animatable, DefaultFloatingActionButtonElevation defaultFloatingActionButtonElevation, float f10, Interaction interaction, c<? super DefaultFloatingActionButtonElevation$elevation$2> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super Unit> cVar) {
        return ((DefaultFloatingActionButtonElevation$elevation$2) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
