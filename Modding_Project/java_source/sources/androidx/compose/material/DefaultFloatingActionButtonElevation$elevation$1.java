...
@Metadata
@d(c = "androidx.compose.material.DefaultFloatingActionButtonElevation$elevation$1", f = "FloatingActionButton.kt", l = {MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_HTTP_REQ_FINSIH_TIME}, m = "invokeSuspend")
/* loaded from: classes.dex */
final class DefaultFloatingActionButtonElevation$elevation$1 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super Unit> cVar) {
        return ((DefaultFloatingActionButtonElevation$elevation$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 != 0) {
            ...
            kt.c<Interaction> cVar = new kt.c<Interaction>() { // from class: androidx.compose.material.DefaultFloatingActionButtonElevation$elevation$1.1
                @Override // kt.c
