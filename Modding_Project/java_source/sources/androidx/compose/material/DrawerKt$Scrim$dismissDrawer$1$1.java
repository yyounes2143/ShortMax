...
public final class DrawerKt$Scrim$dismissDrawer$1$1 extends SuspendLambda implements Function2<PointerInputScope, c<? super Unit>, Object> {
    ...
    public DrawerKt$Scrim$dismissDrawer$1$1(Function0<Unit> function0, c<? super DrawerKt$Scrim$dismissDrawer$1$1> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull PointerInputScope pointerInputScope, @Nullable c<? super Unit> cVar) {
        return ((DrawerKt$Scrim$dismissDrawer$1$1) create(pointerInputScope, cVar)).invokeSuspend(Unit.f60915a);
    }
        ...
        if (i10 != 0) {
            ...
            Function1<Offset, Unit> function1 = new Function1<Offset, Unit>() { // from class: androidx.compose.material.DrawerKt$Scrim$dismissDrawer$1$1.1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m1063invokek4lQ0M(offset.m1616unboximpl());
                    return Unit.f60915a;
                }

                /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                public final void m1063invokek4lQ0M(long j10) {
                    function0.invoke();
                }
            };
            this.label = 1;
