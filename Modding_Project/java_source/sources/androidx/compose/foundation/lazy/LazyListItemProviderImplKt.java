...
public final class LazyListItemProviderImplKt {
    ...
    public static final Map<Object, Integer> generateKeyToIndexMap(@NotNull IntRange range, @NotNull IntervalList<LazyListIntervalContent> list) {
        ...
        if (c10 >= 0) {
            ...
            list.forEach(c10, min, new Function1<IntervalList.Interval<LazyListIntervalContent>, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImplKt$generateKeyToIndexMap$1$1
