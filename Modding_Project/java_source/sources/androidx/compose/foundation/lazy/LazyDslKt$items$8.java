...
public final class LazyDslKt$items$8 extends Lambda implements o<LazyItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ o<LazyItemScope, T, Composer, Integer, Unit> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyDslKt$items$8(o<? super LazyItemScope, ? super T, ? super Composer, ? super Integer, Unit> oVar, T[] tArr) {
        super(4);
