...
final class LazyListState$scrollToItem$2 extends SuspendLambda implements Function2<ScrollScope, c<? super Unit>, Object> {
    ...
    public LazyListState$scrollToItem$2(LazyListState lazyListState, int i10, int i11, c<? super LazyListState$scrollToItem$2> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull ScrollScope scrollScope, @Nullable c<? super Unit> cVar) {
        return ((LazyListState$scrollToItem$2) create(scrollScope, cVar)).invokeSuspend(Unit.f60915a);
    }
