...
public final class LazyDslKt$itemsIndexed$8 extends Lambda implements o<LazyItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ p<LazyItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyDslKt$itemsIndexed$8(p<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> pVar, T[] tArr) {
        super(4);
