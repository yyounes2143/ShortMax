...
@Metadata
@d(c = "androidx.compose.foundation.lazy.grid.LazyGridItemPlacementAnimator$startAnimationsIfNeeded$1$1", f = "LazyGridItemPlacementAnimator.kt", l = {420}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class LazyGridItemPlacementAnimator$startAnimationsIfNeeded$1$1 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super Unit> cVar) {
        return ((LazyGridItemPlacementAnimator$startAnimationsIfNeeded$1$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i10 != 0) {
                ...
                IntOffset m4158boximpl = IntOffset.m4158boximpl(this.$placeableInfo.m655getTargetOffsetnOccac());
                this.label = 1;
