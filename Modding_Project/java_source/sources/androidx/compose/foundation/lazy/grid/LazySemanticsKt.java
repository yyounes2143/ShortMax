...
public final class LazySemanticsKt {
    @Composable
    @NotNull
    public static final Modifier lazyGridSemantics(@NotNull Modifier modifier, @NotNull final LazyGridItemProvider itemProvider, @NotNull final LazyGridState state, @NotNull final g0 coroutineScope, final boolean z10, boolean z11, boolean z12, @Nullable Composer composer, int i10) {
        ...
        if (z13 || rememberedValue == Composer.Companion.getEmpty()) {
                ...
                public final Integer invoke(@NotNull Object needle) {
                    ...
                    while (true) {
                        if (i12 >= itemCount) {
                            i12 = -1;
                            break;
                        } else if (Intrinsics.areEqual(lazySemanticsKt$lazyGridSemantics$1$indexForKeyMapping$1$key$1.invoke((LazySemanticsKt$lazyGridSemantics$1$indexForKeyMapping$1$key$1) Integer.valueOf(i12)), needle)) {
                            break;
                        } else {
                            i12++;
                        }
            ...
            if (z12) {
                function2 = new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.lazy.grid.LazySemanticsKt$lazyGridSemantics$1$scrollByAction$1
                    ...
                    public static final class AnonymousClass1 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        AnonymousClass1(LazyGridState lazyGridState, float f10, c<? super AnonymousClass1> cVar) {
                            super(2, cVar);
            ...
            if (z12) {
                function1 = new Function1<Integer, Boolean>() { // from class: androidx.compose.foundation.lazy.grid.LazySemanticsKt$lazyGridSemantics$1$scrollToIndexAction$1
                    ...
                    public static final class AnonymousClass2 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        AnonymousClass2(LazyGridState lazyGridState, int i10, c<? super AnonymousClass2> cVar) {
                            super(2, cVar);
                            this.$state = lazyGridState;
                            this.$index = i10;
                        }
                    ...
                    public final Boolean invoke(int i12) {
                        boolean z14 = i12 >= 0 && i12 < LazyGridState.this.getLayoutInfo().getTotalItemsCount();
                        LazyGridState lazyGridState = LazyGridState.this;
                        if (z14) {
                            g.d(coroutineScope, null, null, new AnonymousClass2(lazyGridState, i12, null), 3, null);
                            return Boolean.TRUE;
                        }
            ...
            rememberedValue = SemanticsModifierKt.semantics$default(Modifier.Companion, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazySemanticsKt$lazyGridSemantics$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
