...
public final class LazyGridDslKt$items$5 extends Lambda implements o<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ o<LazyGridItemScope, T, Composer, Integer, Unit> $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$items$5(o<? super LazyGridItemScope, ? super T, ? super Composer, ? super Integer, Unit> oVar, List<? extends T> list) {
        super(4);
