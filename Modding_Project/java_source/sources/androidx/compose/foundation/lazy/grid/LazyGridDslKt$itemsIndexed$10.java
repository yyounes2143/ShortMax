...
public final class LazyGridDslKt$itemsIndexed$10 extends Lambda implements o<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ p<LazyGridItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$itemsIndexed$10(p<? super LazyGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> pVar, T[] tArr) {
        super(4);
