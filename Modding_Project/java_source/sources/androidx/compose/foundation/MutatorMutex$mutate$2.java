...
@Metadata
@d(c = "androidx.compose.foundation.MutatorMutex$mutate$2", f = "MutatorMutex.kt", l = {173, 119}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class MutatorMutex$mutate$2<R> extends SuspendLambda implements Function2<g0, c<? super R>, Object> {
    ...
    public MutatorMutex$mutate$2(MutatePriority mutatePriority, MutatorMutex mutatorMutex, Function1<? super c<? super R>, ? extends Object> function1, c<? super MutatorMutex$mutate$2> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super R> cVar) {
        return ((MutatorMutex$mutate$2) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        qt.a aVar;
        Function1<c<? super R>, Object> function1;
        ...
        try {
            try {
                if (r12 != 0) {
                    if (r12 != 1) {
                        if (r12 == 2) {
                            ...
                            try {
                                ...
                                androidx.compose.animation.core.a.a(atomicReference2, mutator2, null);
                                aVar2.unlock(null);
                                return obj;
                            } catch (Throwable th3) {
                                th2 = th3;
                                atomicReference = mutatorMutex2.currentMutator;
                                androidx.compose.animation.core.a.a(atomicReference, mutator2, null);
                                throw th2;
                            }
                        }
                    ...
                    Function1<c<? super R>, Object> function12 = this.$block;
