...
final class TransformableStateKt$panBy$2 extends SuspendLambda implements Function2<TransformScope, c<? super Unit>, Object> {
    ...
    public final Object invoke(@NotNull TransformScope transformScope, @Nullable c<? super Unit> cVar) {
        return ((TransformableStateKt$panBy$2) create(transformScope, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            f.b(obj);
            ((TransformScope) this.L$0).mo276transformByd4ec7I(1.0f, this.$offset, 0.0f);
            return Unit.f60915a;
        }
