...
public final class DraggableKt$draggable$2 extends SuspendLambda implements n<g0, Float, c<? super Unit>, Object> {
    int label;
    ...
    public final Object invoke(@NotNull g0 g0Var, float f10, @Nullable c<? super Unit> cVar) {
        return new DraggableKt$draggable$2(cVar).invokeSuspend(Unit.f60915a);
    }
