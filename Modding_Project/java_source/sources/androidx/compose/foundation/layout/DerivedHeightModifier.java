...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Intrinsics.areEqual(this.insets, derivedHeightModifier.insets) && Intrinsics.areEqual(this.heightCalc, derivedHeightModifier.heightCalc)) {
            return true;
        }
        return false;
    }
    ...
    public MeasureResult mo57measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        final Placeable mo3335measureBRTryo0 = measurable.mo3335measureBRTryo0(Constraints.m3996copyZbe2FdA$default(j10, 0, 0, intValue, intValue, 3, null));
        return MeasureScope.layout$default(measure, mo3335measureBRTryo0.getWidth(), intValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
