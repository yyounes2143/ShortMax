...
final class TextFieldGestureModifiersKt$mouseDragGestureDetector$1 extends SuspendLambda implements Function2<PointerInputScope, c<? super Unit>, Object> {
    ...
    public TextFieldGestureModifiersKt$mouseDragGestureDetector$1(MouseSelectionObserver mouseSelectionObserver, c<? super TextFieldGestureModifiersKt$mouseDragGestureDetector$1> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull PointerInputScope pointerInputScope, @Nullable c<? super Unit> cVar) {
        return ((TextFieldGestureModifiersKt$mouseDragGestureDetector$1) create(pointerInputScope, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 != 0) {
            ...
            this.label = 1;
            if (TextSelectionMouseDetectorKt.mouseSelectionDetector((PointerInputScope) this.L$0, mouseSelectionObserver, this) == f10) {
                return f10;
            }
        }
        return Unit.f60915a;
