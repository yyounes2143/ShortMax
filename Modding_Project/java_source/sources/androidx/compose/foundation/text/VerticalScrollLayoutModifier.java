...
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    @NotNull
    public final VerticalScrollLayoutModifier copy(@NotNull TextFieldScrollerPosition scrollerPosition, int i10, @NotNull TransformedText transformedText, @NotNull Function0<TextLayoutResultProxy> textLayoutResultProvider) {
        Intrinsics.checkNotNullParameter(scrollerPosition, "scrollerPosition");
        Intrinsics.checkNotNullParameter(transformedText, "transformedText");
        Intrinsics.checkNotNullParameter(textLayoutResultProvider, "textLayoutResultProvider");
    ...
    public MeasureResult mo57measure3p2s80s(@NotNull final MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        final Placeable mo3335measureBRTryo0 = measurable.mo3335measureBRTryo0(Constraints.m3996copyZbe2FdA$default(j10, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo3335measureBRTryo0.getHeight(), Constraints.m4004getMaxHeightimpl(j10));
        return MeasureScope.layout$default(measure, mo3335measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.access$getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, mo3335measureBRTryo0.getWidth()), min, mo3335measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(layout, mo3335measureBRTryo0, 0, a.c(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
