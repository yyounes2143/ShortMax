...
public final class Recomposer$join$2 extends SuspendLambda implements Function2<Recomposer.State, rs.c<? super Boolean>, Object> {
    /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public Recomposer$join$2(rs.c<? super Recomposer$join$2> cVar) {
        super(2, cVar);
    }
    ...
    public final Object invoke(Recomposer.State state, rs.c<? super Boolean> cVar) {
        return ((Recomposer$join$2) create(state, cVar)).invokeSuspend(Unit.f60915a);
    }
