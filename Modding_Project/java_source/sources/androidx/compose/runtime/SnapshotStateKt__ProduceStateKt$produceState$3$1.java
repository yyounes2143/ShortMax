...
@Metadata
@kotlin.coroutines.jvm.internal.d(c = "androidx.compose.runtime.SnapshotStateKt__ProduceStateKt$produceState$3$1", f = "ProduceState.kt", l = {141}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class SnapshotStateKt__ProduceStateKt$produceState$3$1 extends SuspendLambda implements Function2<gt.g0, rs.c<? super Unit>, Object> {
    ...
    public SnapshotStateKt__ProduceStateKt$produceState$3$1(Function2<? super ProduceStateScope<T>, ? super rs.c<? super Unit>, ? extends Object> function2, MutableState<T> mutableState, rs.c<? super SnapshotStateKt__ProduceStateKt$produceState$3$1> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(gt.g0 g0Var, rs.c<? super Unit> cVar) {
        return ((SnapshotStateKt__ProduceStateKt$produceState$3$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
