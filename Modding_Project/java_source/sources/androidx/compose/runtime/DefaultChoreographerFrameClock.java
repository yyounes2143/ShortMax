...
public final class DefaultChoreographerFrameClock implements MonotonicFrameClock {
    ...
    private static final Choreographer choreographer = (Choreographer) gt.e.e(q0.c().m(), new DefaultChoreographerFrameClock$choreographer$1(null));
    ...
    public <R> Object withFrameNanos(@NotNull final Function1<? super Long, ? extends R> function1, @NotNull rs.c<? super R> cVar) {
        ...
        eVar.u(new Function1<Throwable, Unit>() { // from class: androidx.compose.runtime.DefaultChoreographerFrameClock$withFrameNanos$2$1
