...
@Metadata
@d(c = "androidx.compose.runtime.collection.ScatterSetWrapper$iterator$1", f = "ScatterSetWrapper.kt", l = {31}, m = "invokeSuspend")
...
final class ScatterSetWrapper$iterator$1<T> extends RestrictedSuspendLambda implements Function2<i<? super T>, c<? super Unit>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    */
    ...
    public final Object invoke(i<? super T> iVar, c<? super Unit> cVar) {
        return ((ScatterSetWrapper$iterator$1) create(iVar, cVar)).invokeSuspend(Unit.f60915a);
    }
}
