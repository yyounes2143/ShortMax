...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    private static final class Api35Impl {
        ...
        @DoNotInline
        public static void setFrameContentVelocity(View view, float f10) {
            try {
    ...
    public static class EdgeEffectFactory {
        ...
        @NonNull
        protected EdgeEffect createEdgeEffect(@NonNull RecyclerView recyclerView, int i10) {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i10, @Nullable Bundle bundle) {
            ...
            if (bundle != null) {
                f10 = bundle.getFloat(AccessibilityNodeInfoCompat.ACTION_ARGUMENT_SCROLL_AMOUNT_FLOAT, 1.0f);
                if (f10 < 0.0f) {
                    if (RecyclerView.sDebugAssertionsEnabled) {
    ...
    */
    ...
    private boolean shouldAbsorb(@NonNull EdgeEffect edgeEffect, int i10, int i11) {
        ...
        if (getSplineFlingDistance(-i10) < EdgeEffectCompat.getDistance(edgeEffect) * i11) {
            return true;
        }
        return false;
    }
    ...
    */
    ...
    int getAdapterPositionInRecyclerView(ViewHolder viewHolder) {
        if (!viewHolder.hasAnyOfTheFlags(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_STREAM_DURATION) && viewHolder.isBound()) {
    ...
    */
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (this.mLayout != null && !this.mLayoutSuppressed && motionEvent.getAction() == 8) {
            ...
            if (z10) {
                OverScroller overScroller = this.mViewFlinger.mOverScroller;
                smoothScrollBy(i12 + (overScroller.getFinalX() - overScroller.getCurrX()), i11 + (overScroller.getFinalY() - overScroller.getCurrY()), null, Integer.MIN_VALUE, true);
            } else {
