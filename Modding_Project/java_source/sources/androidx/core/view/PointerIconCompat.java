...
public final class PointerIconCompat {
    ...
    static class Api24Impl {
        ...
        @DoNotInline
        static PointerIcon create(Bitmap bitmap, float f10, float f11) {
            return PointerIcon.create(bitmap, f10, f11);
        }

        @DoNotInline
        static PointerIcon getSystemIcon(Context context, int i10) {
            return PointerIcon.getSystemIcon(context, i10);
        }

        @DoNotInline
        static PointerIcon load(Resources resources, int i10) {
