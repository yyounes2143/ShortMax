...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    */
    ...
    private boolean shouldAbsorb(@NonNull EdgeEffect edgeEffect, int i10) {
        ...
        if (getSplineFlingDistance(-i10) < EdgeEffectCompat.getDistance(edgeEffect) * getHeight()) {
            return true;
        }
        return false;
    }
    ...
    public boolean onGenericMotionEvent(@NonNull MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (f10 != 0.0f) {
                scrollBy(-((int) (f10 * getVerticalScrollFactorCompat())), i11, 1, MotionEventCompat.isFromSource(motionEvent, 8194));
                if (i10 != 0) {
