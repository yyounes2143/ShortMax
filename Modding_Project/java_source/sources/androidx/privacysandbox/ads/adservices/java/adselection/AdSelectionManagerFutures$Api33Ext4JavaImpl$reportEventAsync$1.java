...
@Metadata
@d(c = "androidx.privacysandbox.ads.adservices.java.adselection.AdSelectionManagerFutures$Api33Ext4JavaImpl$reportEventAsync$1", f = "AdSelectionManagerFutures.kt", l = {TTVideoEngineInterface.PLAYER_OPTION_AE_LU_RANG}, m = "invokeSuspend")
/* loaded from: classes2.dex */
final class AdSelectionManagerFutures$Api33Ext4JavaImpl$reportEventAsync$1 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {
    ...
    public final Object invoke(g0 g0Var, c<? super Unit> cVar) {
        return ((AdSelectionManagerFutures$Api33Ext4JavaImpl$reportEventAsync$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            this.label = 1;
            if (adSelectionManager.reportEvent(reportEventRequest, this) == f10) {
                return f10;
            }
        }
        return Unit.f60915a;
