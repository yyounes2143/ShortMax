...
final class AdSelectionManagerFutures$Api33Ext4JavaImpl$reportImpressionAsync$1 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {
    ...
    public final Object invoke(g0 g0Var, c<? super Unit> cVar) {
        return ((AdSelectionManagerFutures$Api33Ext4JavaImpl$reportImpressionAsync$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            this.label = 1;
            if (adSelectionManager.reportImpression(reportImpressionRequest, this) == f10) {
                return f10;
            }
        }
        return Unit.f60915a;
