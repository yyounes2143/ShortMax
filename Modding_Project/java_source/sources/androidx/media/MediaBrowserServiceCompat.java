...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        class MediaBrowserServiceApi21 extends MediaBrowserService {
            ...
            public MediaBrowserService.BrowserRoot onGetRoot(String str, int i10, Bundle bundle) {
                ...
                BrowserRoot onGetRoot = mediaBrowserServiceImplApi21.onGetRoot(str, i10, bundle2);
                if (onGetRoot == null) {
                    return null;
                }
            ...
            if (!this.mRootExtrasList.isEmpty()) {
                ...
                if (c10 != null) {
                    for (Bundle bundle : this.mRootExtrasList) {
                        BundleCompat.putBinder(bundle, MediaBrowserProtocol.EXTRA_SESSION_BINDER, c10.asBinder());
                    }
                }
                this.mRootExtrasList.clear();
            }
            this.mServiceFwk.setSessionToken((MediaSession.Token) token.d());
        }
    ...
    boolean isValidPackage(String str, int i10) {
        if (str == null) {
            return false;
        }
    ...
    public static class Result<T> {
        ...
        void onResultSent(@Nullable T t10) {
        }
    }
