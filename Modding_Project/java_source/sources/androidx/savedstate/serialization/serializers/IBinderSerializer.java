...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    @NotNull
    private static final SerialDescriptor descriptor = k.f("android.os.IBinder", new SerialDescriptor[0], null, 4, null);
    ...
    public IBinder deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m4345getBinderimpl(SavedStateReader.m4338constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull IBinder value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m4429putBinderimpl(SavedStateWriter.m4424constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
            return;
        }
