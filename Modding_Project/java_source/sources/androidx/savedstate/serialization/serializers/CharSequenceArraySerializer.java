...
public final class CharSequenceArraySerializer implements KSerializer<CharSequence[]> {
    ...
    @NotNull
    private static final SerialDescriptor descriptor = k.f("kotlin.Array<kotlin.CharSequence>", new SerialDescriptor[0], null, 4, null);
    ...
    public CharSequence[] deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m4356getCharSequenceArrayimpl(SavedStateReader.m4338constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull CharSequence[] value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m4435putCharSequenceArrayimpl(SavedStateWriter.m4424constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
            return;
        }
