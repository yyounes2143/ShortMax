...
public class WebViewCompat {
    ...
    public static void addNavigationListener(WebView webView, Executor executor, NavigationListener navigationListener) {
        if (WebViewFeatureInternal.NAVIGATION_LISTENER_V1.isSupportedByWebView()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$startUpWebView$1(final WebViewStartUpCallback webViewStartUpCallback, final WebViewStartUpResult webViewStartUpResult) {
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.webkit.f
    ...
    public static /* synthetic */ void lambda$startUpWebView$3(WebViewStartUpConfig webViewStartUpConfig, final WebViewStartUpCallback webViewStartUpCallback, Context context) {
        ...
        if (WebViewFeatureInternal.ASYNC_WEBVIEW_STARTUP.isSupportedByWebView()) {
            getFactory().startUpWebView(webViewStartUpConfig, new WebViewStartUpCallback() { // from class: androidx.webkit.g
                ...
                public final void onSuccess(WebViewStartUpResult webViewStartUpResult) {
                    WebViewCompat.lambda$startUpWebView$1(WebViewCompat.WebViewStartUpCallback.this, webViewStartUpResult);
                }
            });
            return;
        }
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.webkit.h
            @Override // java.lang.Runnable
            public final void run() {
                WebViewCompat.lambda$startUpWebView$2(WebViewCompat.WebViewStartUpCallback.this);
            }
        });
    }

    @UiThread
    public static void postVisualStateCallback(WebView webView, long j10, final VisualStateCallback visualStateCallback) {
    ...
    @UiThread
    public static void saveState(WebView webView, Bundle bundle, @IntRange(from = 1) int i10, boolean z10) {
        if (WebViewFeatureInternal.SAVE_STATE.isSupportedByWebView()) {
            getProvider(webView).saveState(bundle, i10, z10);
            return;
        }
        throw WebViewFeatureInternal.getUnsupportedOperationException();
    }
    ...
    public static void setDefaultTrafficStatsTag(int i10) {
        if (WebViewFeatureInternal.DEFAULT_TRAFFICSTATS_TAGGING.isSupportedByWebView()) {
            getFactory().getStatics().setDefaultTrafficStatsTag(i10);
            return;
        }
        throw WebViewFeatureInternal.getUnsupportedOperationException();
    }
    ...
    public static void startUpWebView(final Context context, final WebViewStartUpConfig webViewStartUpConfig, final WebViewStartUpCallback webViewStartUpCallback) {
        webViewStartUpConfig.getBackgroundExecutor().execute(new Runnable() { // from class: androidx.webkit.e
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static void addNavigationListener(WebView webView, NavigationListener navigationListener) {
        addNavigationListener(webView, new androidx.emoji2.text.a(new Handler(Looper.getMainLooper())), navigationListener);
    }
