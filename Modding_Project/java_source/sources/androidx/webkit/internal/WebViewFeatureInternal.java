...
public class WebViewFeatureInternal {
    ...
    public static final ApiFeature.NoFramework USER_AGENT_METADATA_FORM_FACTORS = new ApiFeature.NoFramework(WebViewFeature.USER_AGENT_METADATA_FORM_FACTORS, WebViewFeature.USER_AGENT_METADATA) { // from class: androidx.webkit.internal.WebViewFeatureInternal.2
        @Override // androidx.webkit.internal.ApiFeature
        public boolean isSupportedByWebView() {
            PackageInfo currentLoadedWebViewPackage;
            if (!super.isSupportedByWebView() || (currentLoadedWebViewPackage = WebViewCompat.getCurrentLoadedWebViewPackage()) == null || PackageInfoCompat.getLongVersionCode(currentLoadedWebViewPackage) < 636700000) {
                return false;
            }
            return true;
        }
    };
    public static final ApiFeature.NoFramework MULTI_PROFILE = new ApiFeature.NoFramework(WebViewFeature.MULTI_PROFILE, WebViewFeature.MULTI_PROFILE) { // from class: androidx.webkit.internal.WebViewFeatureInternal.3
        @Override // androidx.webkit.internal.ApiFeature
        public boolean isSupportedByWebView() {
    ...
    public static final ApiFeature.NoFramework BACK_FORWARD_CACHE_SETTINGS = new ApiFeature.NoFramework(WebViewFeature.BACK_FORWARD_CACHE_SETTINGS, WebViewFeature.BACK_FORWARD_CACHE_SETTINGS);
    ...
    public static final ApiFeature.NoFramework PROFILE_URL_PREFETCH = new ApiFeature.NoFramework(WebViewFeature.PROFILE_URL_PREFETCH, WebViewFeature.PROFILE_URL_PREFETCH) { // from class: androidx.webkit.internal.WebViewFeatureInternal.4
        @Override // androidx.webkit.internal.ApiFeature
        public boolean isSupportedByWebView() {
    ...
    public static final ApiFeature.NoFramework ASYNC_WEBVIEW_STARTUP_ASYNC_STARTUP_LOCATIONS = new ApiFeature.NoFramework("IMPLEMENTATION_ONLY_FEATURE", "ASYNC_WEBVIEW_STARTUP_ASYNC_STARTUP_LOCATIONS");
    ...
    public static final ApiFeature.NoFramework PRERENDER_WITH_URL = new ApiFeature.NoFramework(WebViewFeature.PRERENDER_WITH_URL, "PRERENDER_URL_V3");
    ...
    public static final ApiFeature.NoFramework NAVIGATION_LISTENER_V1 = new ApiFeature.NoFramework(WebViewFeature.NAVIGATION_LISTENER_V1, "WEB_VIEW_NAVIGATION_LISTENER_V1");
    public static final ApiFeature.NoFramework PROVIDER_WEAKLY_REF_WEBVIEW = new ApiFeature.NoFramework(WebViewFeature.PROVIDER_WEAKLY_REF_WEBVIEW, WebViewFeature.PROVIDER_WEAKLY_REF_WEBVIEW);
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public static final ApiFeature.NoFramework WEBVIEW_BUILDER_V1 = new ApiFeature.NoFramework(WebViewFeature.WEBVIEW_BUILDER_EXPERIMENTAL_V1, "WEBVIEW_BUILDER_V1");
    public static final ApiFeature.NoFramework COOKIE_INTERCEPT = new ApiFeature.NoFramework(WebViewFeature.COOKIE_INTERCEPT, WebViewFeature.COOKIE_INTERCEPT);
    @Profile.ExperimentalWarmUpRendererProcess
    public static final ApiFeature.NoFramework WARM_UP_RENDERER_PROCESS = new ApiFeature.NoFramework(WebViewFeature.WARM_UP_RENDERER_PROCESS, WebViewFeature.WARM_UP_RENDERER_PROCESS);
    @Profile.ExperimentalOriginMatchedHeader
    public static final ApiFeature.NoFramework ORIGIN_MATCHED_HEADERS = new ApiFeature.NoFramework(WebViewFeature.ORIGIN_MATCHED_HEADERS, "EXTRA_HEADER_FOR_ORIGINS");
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public static final ApiFeature.NoFramework CUSTOM_REQUEST_HEADERS = new ApiFeature.NoFramework(WebViewFeature.CUSTOM_REQUEST_HEADERS, WebViewFeature.CUSTOM_REQUEST_HEADERS);
    ...
    public static final ApiFeature.NoFramework PRECONNECT = new ApiFeature.NoFramework(WebViewFeature.PRECONNECT, WebViewFeature.PRECONNECT);
    public static final ApiFeature.NoFramework ADD_QUIC_HINTS_V1 = new ApiFeature.NoFramework(WebViewFeature.ADD_QUIC_HINTS_V1, "ADD_QUIC_HINTS_V1");
    public static final ApiFeature.NoFramework HYPERLINK_CONTEXT_MENU_ITEMS = new ApiFeature.NoFramework(WebViewFeature.HYPERLINK_CONTEXT_MENU_ITEMS, WebViewFeature.HYPERLINK_CONTEXT_MENU_ITEMS);
