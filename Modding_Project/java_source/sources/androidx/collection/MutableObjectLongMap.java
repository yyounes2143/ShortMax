...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    public final long getOrPut(K k10, @NotNull Function0<Long> defaultValue) {
    ...
    public final void put(K k10, long j10) {
        set(k10, j10);
    }
    ...
    public final void resizeStorage$collection(int i10) {
        ...
        while (i15 < i13) {
            if (((jArr[i15 >> 3] >> ((i15 & 7) << 3)) & 255) < 128) {
                ...
                long j11 = (j10 << i19) | (jArr3[i18] & (~(255 << i19)));
                jArr3[i18] = j11;
                jArr3[(((findFirstAvailableSlot - 7) & i14) + (i14 & 7)) >> 3] = j11;
                objArr2[findFirstAvailableSlot] = obj;
                jArr4[findFirstAvailableSlot] = jArr2[i11];
            } else {
                i11 = i15;
            }
            i15 = i11 + 1;
    ...
    public final void set(K k10, long j10) {
        int findIndex = findIndex(k10);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        }
        this.keys[findIndex] = k10;
        this.values[findIndex] = j10;
    }
    ...
    public final long put(K k10, long j10, long j11) {
        int findIndex = findIndex(k10);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        } else {
            j11 = this.values[findIndex];
        }
        this.keys[findIndex] = k10;
        this.values[findIndex] = j10;
        return j11;
    ...
    public final boolean remove(K k10, long j10) {
        int findKeyIndex = findKeyIndex(k10);
