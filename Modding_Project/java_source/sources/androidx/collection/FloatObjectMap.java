...
public abstract class FloatObjectMap<V> {
    ...
    public static /* synthetic */ String joinToString$default(FloatObjectMap floatObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj == null) {
            ...
            return floatObjectMap.joinToString(charSequence, str, str2, i12, charSequence4);
        }
    ...
    */
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            ...
                            } else if (!Intrinsics.areEqual(obj2, floatObjectMap.get(f10))) {
                                return false;
                            }
                        }
                        j10 >>= 8;
    ...
    public final int findKeyIndex$collection(float f10) {
    ...
    */
    ...
    public final V getOrElse(float f10, @NotNull Function0<? extends V> defaultValue) {
    ...
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i10, @NotNull CharSequence truncated, @NotNull Function2<? super Float, ? super V, ? extends CharSequence> transform) {
        float[] fArr;
        float[] fArr2;
