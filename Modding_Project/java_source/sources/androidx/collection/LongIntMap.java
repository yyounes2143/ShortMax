...
public abstract class LongIntMap {
    ...
    public static /* synthetic */ String joinToString$default(LongIntMap longIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj == null) {
            ...
            return longIntMap.joinToString(charSequence, str, str2, i12, charSequence4);
        }
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((255 & j10) < 128) {
                            ...
                            long j11 = jArr[i15];
                            int i16 = iArr[i15];
                            int findKeyIndex = longIntMap.findKeyIndex(j11);
                            if (findKeyIndex < 0 || i16 != longIntMap.values[findKeyIndex]) {
                                break loop0;
                            }
                            i12 = 8;
                        } else {
    ...
    public final int getOrDefault(long j10, int i10) {
        int findKeyIndex = findKeyIndex(j10);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
    ...
    public final int getOrElse(long j10, @NotNull Function0<Integer> defaultValue) {
                    ...
                    if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i19 < i18) {
                            if ((j10 & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb2.append((CharSequence) transform.invoke(valueOf, Integer.valueOf(i21)));
                                i15++;
                                i12 = 8;
                            } else {
                                jArr2 = jArr4;
    ...
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i10, @NotNull CharSequence truncated, @NotNull Function2<? super Long, ? super Integer, ? extends CharSequence> transform) {
