...
public abstract class LongFloatMap {
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj == null) {
            ...
            return longFloatMap.joinToString(charSequence, str, str2, i12, charSequence4);
        }
        ...
        if (length >= 0) {
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    int i11 = 8 - ((~(i10 - length)) >>> 31);
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128 && f10 == fArr[(i10 << 3) + i12]) {
                            return true;
                        }
                        j10 >>= 8;
                    }
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((255 & j10) < 128) {
                            ...
                            long j11 = jArr[i15];
                            float f10 = fArr[i15];
                            int findKeyIndex = longFloatMap.findKeyIndex(j11);
                            if (findKeyIndex < 0 || f10 != longFloatMap.values[findKeyIndex]) {
                                break loop0;
                            }
                            i12 = 8;
                        } else {
    ...
    public final float get(long j10) {
        ...
        if (findKeyIndex < 0) {
            RuntimeHelpersKt.throwNoSuchElementException("Cannot find value for key " + j10);
        }
    ...
    public final float getOrDefault(long j10, float f10) {
        int findKeyIndex = findKeyIndex(j10);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
    ...
    public final float getOrElse(long j10, @NotNull Function0<Float> defaultValue) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i14 = 0; i14 < i13; i14++) {
                        if ((255 & j10) < 128) {
                            int i15 = (i11 << 3) + i14;
                            long j11 = jArr[i15];
                            i12 += Float.hashCode(fArr[i15]) ^ Long.hashCode(j11);
                        }
                        j10 >>= 8;
                    }
                    if (i13 != 8) {
                    ...
                    if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i19 < i18) {
                            if ((j10 & 255) < 128) {
                                ...
                                jArr2 = jArr4;
                                sb2.append((CharSequence) transform.invoke(valueOf, Float.valueOf(f10)));
                                i15++;
                                i12 = 8;
                            } else {
                                jArr2 = jArr4;
    ...
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i10, @NotNull CharSequence truncated, @NotNull Function2<? super Long, ? super Float, ? extends CharSequence> transform) {
