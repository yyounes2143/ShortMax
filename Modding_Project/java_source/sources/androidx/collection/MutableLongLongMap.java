...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final long getOrPut(long j10, @NotNull Function0<Long> defaultValue) {
    ...
    public final void resizeStorage$collection(int i10) {
        ...
        while (i13 < i11) {
            if (((jArr2[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableLongLongMap.findFirstAvailableSlot(i14 >>> 7);
                long j11 = i14 & 127;
                ...
                jArr5[i15] = j12;
                jArr5[(((findFirstAvailableSlot - 7) & i12) + (i12 & 7)) >> 3] = j12;
                jArr6[findFirstAvailableSlot] = j10;
                jArr7[findFirstAvailableSlot] = jArr4[i13];
            } else {
                jArr = jArr2;
            }
            i13++;
