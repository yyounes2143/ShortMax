...
public final class MutableFloatFloatMap extends FloatFloatMap {
            ...
            if (j12 != 128 && j12 == 254) {
                ...
                if (((findFirstAvailableSlot - i19) & i11) / 8 == ((i15 - i19) & i11) / 8) {
                    ...
                    if (((j13 >> i21) & 255) == 128) {
                        ...
                        fArr[findFirstAvailableSlot] = fArr[i15];
                        fArr[i15] = f10;
                        float f11 = fArr2[findFirstAvailableSlot];
                        fArr2[findFirstAvailableSlot] = fArr2[i15];
                        fArr2[i15] = f11;
                        i15--;
                    }
    ...
    public final float getOrPut(float f10, @NotNull Function0<Float> defaultValue) {
    ...
    public final void resizeStorage$collection(int i10) {
        ...
        int i11 = mutableFloatFloatMap._capacity;
        ...
        while (i13 < i11) {
            if (((jArr2[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableFloatFloatMap.findFirstAvailableSlot(i14 >>> 7);
                long j10 = i14 & 127;
                ...
                fArr4[findFirstAvailableSlot] = fArr2[i13];
            } else {
                jArr = jArr2;
            }
            i13++;
