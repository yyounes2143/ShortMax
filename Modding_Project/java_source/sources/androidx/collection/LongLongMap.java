...
public abstract class LongLongMap {
    ...
    public static /* synthetic */ String joinToString$default(LongLongMap longLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj == null) {
            ...
            return longLongMap.joinToString(charSequence, str, str2, i12, charSequence4);
        }
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((255 & j10) < 128) {
                            ...
                            long j11 = jArr[i15];
                            long j12 = jArr2[i15];
                            int findKeyIndex = longLongMap.findKeyIndex(j11);
                            if (findKeyIndex < 0 || j12 != longLongMap.values[findKeyIndex]) {
                                break loop0;
                            }
                            i12 = 8;
                        } else {
    ...
    public final long getOrElse(long j10, @NotNull Function0<Long> defaultValue) {
    ...
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i10, @NotNull CharSequence truncated, @NotNull Function2<? super Long, ? super Long, ? extends CharSequence> transform) {
