...
public abstract class ObjectLongMap<K> {
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj == null) {
            ...
            return objectLongMap.joinToString(charSequence, str, str2, i12, charSequence4);
        }
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            ...
                            if (findKeyIndex < 0 || j11 != objectLongMap.values[findKeyIndex]) {
                                break loop0;
                            }
                        }
                        j10 >>= 8;
    ...
    public final long getOrElse(K k10, @NotNull Function0<Long> defaultValue) {
    ...
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i10, @NotNull CharSequence truncated, @NotNull Function2<? super K, ? super Long, ? extends CharSequence> transform) {
        Object[] objArr;
        Object[] objArr2;
