...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    public final void put(long j10, float f10) {
        set(j10, f10);
    }
    ...
    public final void resizeStorage$collection(int i10) {
        ...
        while (i13 < i11) {
            if (((jArr2[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableLongFloatMap.findFirstAvailableSlot(i14 >>> 7);
                long j11 = i14 & 127;
    ...
    public final void set(long j10, float f10) {
    ...
    public final float put(long j10, float f10, float f11) {
        int findInsertIndex = findInsertIndex(j10);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(long j10, float f10) {
        int findKeyIndex = findKeyIndex(j10);
