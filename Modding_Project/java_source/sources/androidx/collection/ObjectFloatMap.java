...
public abstract class ObjectFloatMap<K> {
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj == null) {
            ...
            return objectFloatMap.joinToString(charSequence, str, str2, i12, charSequence4);
        }
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            ...
                            if (findKeyIndex < 0 || f10 != objectFloatMap.values[findKeyIndex]) {
                                break loop0;
                            }
                        }
                        j10 >>= 8;
    ...
    public final float getOrDefault(K k10, float f10) {
        int findKeyIndex = findKeyIndex(k10);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
    ...
    public final float getOrElse(K k10, @NotNull Function0<Float> defaultValue) {
    ...
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i10, @NotNull CharSequence truncated, @NotNull Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        Object[] objArr;
        Object[] objArr2;
