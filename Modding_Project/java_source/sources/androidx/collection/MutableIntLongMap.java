...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final long getOrPut(int i10, @NotNull Function0<Long> defaultValue) {
    ...
    public final void put(int i10, long j10) {
        set(i10, j10);
    }
    ...
    public final void resizeStorage$collection(int i10) {
        ...
        int i11 = mutableIntLongMap._capacity;
        ...
        while (i13 < i11) {
            if (((jArr2[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableIntLongMap.findFirstAvailableSlot(i15 >>> 7);
                long j10 = i15 & 127;
                int i16 = findFirstAvailableSlot >> 3;
                int i17 = (findFirstAvailableSlot & 7) << 3;
                jArr = jArr2;
                long j11 = (jArr4[i16] & (~(255 << i17))) | (j10 << i17);
                jArr4[i16] = j11;
    ...
    public final long put(int i10, long j10, long j11) {
        int findInsertIndex = findInsertIndex(i10);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(int i10, long j10) {
        int findKeyIndex = findKeyIndex(i10);
