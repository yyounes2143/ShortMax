...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float getOrPut(K k10, @NotNull Function0<Float> defaultValue) {
    ...
    public final void put(K k10, float f10) {
        set(k10, f10);
    }
    ...
    public final void set(K k10, float f10) {
        int findIndex = findIndex(k10);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        }
        this.keys[findIndex] = k10;
        this.values[findIndex] = f10;
    }
    ...
    public final float put(K k10, float f10, float f11) {
        int findIndex = findIndex(k10);
        if (findIndex < 0) {
            findIndex = ~findIndex;
        } else {
            f11 = this.values[findIndex];
        }
        this.keys[findIndex] = k10;
        this.values[findIndex] = f10;
        return f11;
    ...
    public final boolean remove(K k10, float f10) {
        int findKeyIndex = findKeyIndex(k10);
