...
public abstract class FloatIntMap {
    ...
    public static /* synthetic */ String joinToString$default(FloatIntMap floatIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj == null) {
            ...
            return floatIntMap.joinToString(charSequence, str, str2, i12, charSequence4);
        }
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            ...
                            float f10 = fArr[i13];
                            int i14 = iArr[i13];
                            int findKeyIndex = floatIntMap.findKeyIndex(f10);
                            if (findKeyIndex < 0 || i14 != floatIntMap.values[findKeyIndex]) {
                                break loop0;
                            }
                        }
                        j10 >>= 8;
    ...
    public final int get(float f10) {
    ...
    public final int getOrDefault(float f10, int i10) {
        int findKeyIndex = findKeyIndex(f10);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
    ...
    public final int getOrElse(float f10, @NotNull Function0<Integer> defaultValue) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i14 = 0; i14 < i13; i14++) {
                        if ((255 & j10) < 128) {
                            int i15 = (i11 << 3) + i14;
                            float f10 = fArr[i15];
                            i12 += Integer.hashCode(iArr[i15]) ^ Float.hashCode(f10);
                        }
                        j10 >>= 8;
                    }
                    if (i13 != 8) {
    ...
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i10, @NotNull CharSequence truncated, @NotNull Function2<? super Float, ? super Integer, ? extends CharSequence> transform) {
