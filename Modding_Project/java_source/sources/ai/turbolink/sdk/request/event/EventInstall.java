...
public final class EventInstall extends ServerRequestSession {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EventInstall(@NotNull Context context, @Nullable TurboLinkEvent.TurboLinkEventCallback turboLinkEventCallback, boolean z10) {
        super(context, TurboLinkDefaultEvent.INSTALL.getEvent(), z10);
    ...
    public void handleSuccess(@NotNull ServerResponse response) {
        ...
        sDKAccessInfo.setInstallEventStatus(1);
