...
/* compiled from: EventLogout.kt */
@Metadata
/* loaded from: classes.dex */
public final class EventLogout extends ServerRequestURL {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EventLogout(@NotNull Context context, @Nullable TurboLinkEvent.TurboLinkEventCallback turboLinkEventCallback) {
        super(context, TurboLinkDefaultEvent.LOGOUT.getEvent());
