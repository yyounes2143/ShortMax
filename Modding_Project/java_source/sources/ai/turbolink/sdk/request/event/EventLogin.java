...
public final class EventLogin extends ServerRequestURL {
    ...
    public EventLogin(@NotNull Context context, @Nullable TurboLinkEvent.TurboLinkEventCallback turboLinkEventCallback, @NotNull Activity activity, @NotNull String userId) {
