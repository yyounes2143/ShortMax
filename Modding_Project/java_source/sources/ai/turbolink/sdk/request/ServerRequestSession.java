...
public abstract class ServerRequestSession extends ServerRequest {
    @NotNull
    ...
    @NotNull
    private EventRequestData requestData;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ServerRequestSession(@NotNull Context context, @NotNull String event, boolean z10) {
    ...
    public final boolean getInitiatedByClient() {
        return this.initiatedByClient;
    }
    ...
    public void setPost(@NotNull JSONObject post) {
        ...
        try {
            ...
            TurboLinkLogger.w("Initialize request data raise exception on session " + e10.getMessage());
        }
        super.setPost(this.requestData);
    }
}
