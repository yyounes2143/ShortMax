...
public abstract class EnhancedIntentService extends Service {
    ...
    public final int onStartCommand(final Intent intent, int i10, int i11) {
        ...
        processIntent.addOnCompleteListener(new androidx.credentials.a(), new OnCompleteListener() { // from class: com.google.firebase.messaging.g
