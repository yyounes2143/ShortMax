...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
        ...
        protected void onPopulateNodeForVirtualView(int i10, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i10 == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    accessibilityNodeInfoCompat.setContentDescription(context.getString(i11, str).trim());
                }
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (getParent() instanceof ChipGroup) {
            ...
            wrap.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(chipGroup.getRowIndex(this), 1, i10, 1, false, isChecked()));
        }
    }
