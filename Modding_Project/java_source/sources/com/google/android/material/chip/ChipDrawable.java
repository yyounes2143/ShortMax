...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i10, @StyleRes int i11) {
        ...
        int i12 = obtainStyledAttributes.getInt(R.styleable.Chip_android_ellipsize, 0);
        if (i12 != 1) {
            if (i12 != 2) {
                if (i12 == 3) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (!bounds.isEmpty() && getAlpha() != 0) {
            int i11 = this.alpha;
            if (i11 < 255) {
                i10 = CanvasCompat.saveLayerAlpha(canvas, bounds.left, bounds.top, bounds.right, bounds.bottom, i11);
            } else {
                i10 = 0;
            }
    ...
    private boolean onStateChange(@NonNull int[] iArr, @NonNull int[] iArr2) {
        ...
        boolean z12 = hasState(getState(), 16842912) && this.checkable;
