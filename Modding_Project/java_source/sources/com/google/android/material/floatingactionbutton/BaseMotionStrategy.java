...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(@NonNull MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(TextureRenderKeys.KEY_IS_SCALE)) {
            arrayList.add(motionSpec.getAnimator(TextureRenderKeys.KEY_IS_SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(TextureRenderKeys.KEY_IS_SCALE, this.fab, View.SCALE_X));
        }
