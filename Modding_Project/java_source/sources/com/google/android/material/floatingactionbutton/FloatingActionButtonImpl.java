...
public class FloatingActionButtonImpl {
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f10, float f11, float f12) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.view, View.ALPHA, f10);
        motionSpec.getTiming("opacity").apply(ofFloat);
        arrayList.add(ofFloat);
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.view, View.SCALE_X, f11);
        motionSpec.getTiming(TextureRenderKeys.KEY_IS_SCALE).apply(ofFloat2);
        workAroundOreoBug(ofFloat2);
        arrayList.add(ofFloat2);
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.view, View.SCALE_Y, f11);
        motionSpec.getTiming(TextureRenderKeys.KEY_IS_SCALE).apply(ofFloat3);
    ...
    private AnimatorSet createDefaultAnimator(final float f10, final float f11, final float f12, int i10, int i11) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                FloatingActionButtonImpl.this.view.setAlpha(AnimationUtils.lerp(alpha, f10, 0.0f, 0.2f, floatValue));
                FloatingActionButtonImpl.this.view.setScaleX(AnimationUtils.lerp(scaleX, f11, floatValue));
                FloatingActionButtonImpl.this.view.setScaleY(AnimationUtils.lerp(scaleY, f11, floatValue));
                FloatingActionButtonImpl.this.imageMatrixScale = AnimationUtils.lerp(f13, f12, floatValue);
    ...
    public void getPadding(@NonNull Rect rect) {
        ...
        if (this.shadowPaddingEnabled) {
            f10 = getElevation() + this.pressedTranslationZ;
        } else {
            f10 = 0.0f;
        }
        int max = Math.max(touchTargetPadding, (int) Math.ceil(f10));
        int max2 = Math.max(touchTargetPadding, (int) Math.ceil(f10 * SHADOW_MULTIPLIER));
