...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    private void getTouchTargetRect(@NonNull Rect rect) {
        ...
        int i10 = -this.impl.getTouchTargetPadding();
        rect.inset(i10, i10);
    }
    ...
    */
    ...
    void hide(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z10) {
        getImpl().hide(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z10);
    }

    void show(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z10) {
