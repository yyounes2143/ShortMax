...
public abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    @VisibleForTesting
    void setMockHideAnimationRunning(boolean z10, @FloatRange(from = 0.0d, to = 1.0d) float f10) {
        this.mockHideAnimationRunning = z10;
        this.mockGrowFraction = f10;
    }

    @VisibleForTesting
    void setMockShowAnimationRunning(boolean z10, @FloatRange(from = 0.0d, to = 1.0d) float f10) {
