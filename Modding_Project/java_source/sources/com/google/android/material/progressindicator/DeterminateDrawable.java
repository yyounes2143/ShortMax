        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            ...
            if (i10 > 0) {
                if (!(this.drawingDelegate instanceof LinearDrawingDelegate)) {
                    i10 = (int) ((i10 * MathUtils.clamp(getIndicatorFraction(), 0.0f, 0.01f)) / 0.01f);
                }
                this.drawingDelegate.fillTrack(canvas, this.paint, getIndicatorFraction(), 1.0f, this.baseSpec.trackColor, getAlpha(), i10);
            } else {
