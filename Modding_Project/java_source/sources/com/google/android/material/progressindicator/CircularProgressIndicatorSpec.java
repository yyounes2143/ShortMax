...
public final class CircularProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    int getIndicatorTrackGapSizeDegree() {
        int i10 = this.indicatorTrackGapSize;
        if (i10 == 0) {
            return 0;
        }
        return (int) Math.round(360.0d / ((((this.indicatorSize - (this.indicatorInset * 2)) - this.trackThickness) * 3.141592653589793d) / (i10 + this.trackCornerRadius)));
    }
