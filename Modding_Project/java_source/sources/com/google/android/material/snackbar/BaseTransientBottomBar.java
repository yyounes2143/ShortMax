...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @NonNull
    public static GradientDrawable createGradientDrawableBackground(@ColorInt int i10, @NonNull Resources resources) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @NonNull
    public static MaterialShapeDrawable createMaterialShapeDrawableBackground(@ColorInt int i10, @NonNull ShapeAppearanceModel shapeAppearanceModel) {
    ...
    public void updateMargins() {
        ...
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
            ...
            int i11 = this.view.originalMargins.bottom + i10;
            int i12 = this.view.originalMargins.left + this.extraLeftMarginWindowInset;
            int i13 = this.view.originalMargins.right + this.extraRightMarginWindowInset;
            int i14 = this.view.originalMargins.top;
