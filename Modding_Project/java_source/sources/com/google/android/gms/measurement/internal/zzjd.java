...
public final class zzjd extends zzga {
    ...
    public final /* synthetic */ void zzK(Bundle bundle, String str, zzr zzrVar) {
        ...
        try {
            ...
            zzj2.zzu.zzaV().zzb().zzc("Error storing default event parameters. appId", zzgu.zzl(str), e11);
        }
    ...
    public final zzao zzw(zzr zzrVar) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to get consent. appId", zzgu.zzl(zzrVar.zza), e10);
    ...
    public final List zzx(zzr zzrVar, Bundle bundle) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to get trigger URIs. appId", zzgu.zzl(zzrVar.zza), e11);
            return Collections.emptyList();
        }
    }
