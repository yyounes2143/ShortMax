...
public final class zzbe {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("name", this.zza).add("minBound", Double.valueOf(this.zzc)).add("maxBound", Double.valueOf(this.zzb)).add("percent", Double.valueOf(this.zzd)).add(MetricsSQLiteCacheKt.METRICS_COUNT, Integer.valueOf(this.zze)).toString();
    }
}
