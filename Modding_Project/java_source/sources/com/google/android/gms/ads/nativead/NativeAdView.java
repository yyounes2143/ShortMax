...
public final class NativeAdView extends FrameLayout {
    ...
    public static /* synthetic */ void zzb(@NonNull NativeAdView nativeAdView, @NonNull ImageView.ScaleType scaleType) {
        ...
        if (zzbgtVar != null && scaleType != null) {
            try {
                ...
                zzo.zzh("Unable to call setMediaViewImageScaleType on delegate", e10);
            }
        }
    }
    ...
    public static /* synthetic */ void zzc(@NonNull NativeAdView nativeAdView, @NonNull MediaContent mediaContent) {
        ...
        try {
            ...
            zzo.zzh("Unable to call setMediaContent on delegate", e10);
        }
    }
    ...
    private final void zzf(String str, @Nullable View view) {
        ...
        try {
            ...
            zzo.zzh("Unable to call setAssetView on delegate", e10);
        }
    }
    ...
    public void destroy() {
        ...
        try {
            ...
            zzo.zzh("Unable to destroy native ad view", e10);
        }
    }
        ...
        if (zzbgtVar != null) {
            if (((Boolean) zzbd.zzc().zzb(zzbde.zzlW)).booleanValue()) {
                try {
                    ...
                    zzo.zzh("Unable to call handleTouchEvent on delegate", e10);
                }
            }
        }
    ...
    public final void onVisibilityChanged(@NonNull View view, int i10) {
        ...
        try {
            zzbgtVar.zze(ObjectWrapper.wrap(view), i10);
        } catch (RemoteException e10) {
            zzo.zzh("Unable to call onVisibilityChanged on delegate", e10);
        }
    }
    ...
    public final void setClickConfirmingView(@Nullable View view) {
        ...
        try {
            ...
            zzo.zzh("Unable to call setClickConfirmingView on delegate", e10);
        }
    }
    ...
    public void setNativeAd(@NonNull NativeAd nativeAd) {
        ...
        try {
            ...
            zzo.zzh("Unable to call setNativeAd on delegate", e10);
        }
    }
    ...
    protected final View zza(@NonNull String str) {
        ...
        if (zzbgtVar != null) {
            try {
                ...
                zzo.zzh("Unable to call getAssetView on delegate", e10);
            }
        }
        return null;
    }
