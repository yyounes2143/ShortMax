...
public final class zzbs {
    ...
    public static String zzm(@Nullable zzfcf zzfcfVar) {
        if (zzfcfVar == null) {
            return null;
        }
        ...
        try {
            ...
            int i10 = zze.zza;
            com.google.android.gms.ads.internal.util.client.zzo.zzh("Error when writing JSON.", e10);
            return null;
        }
    }
