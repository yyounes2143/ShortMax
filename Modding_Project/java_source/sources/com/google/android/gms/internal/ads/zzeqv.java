...
public final class zzeqv implements zzhgr {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        zzeur zzb = ((zzeus) this.zza).zzb();
        zzeou zzeouVar = (zzeou) this.zzb.zzb();
        ScheduledExecutorService scheduledExecutorService = (ScheduledExecutorService) this.zzd.zzb();
        if (((List) this.zzc.zzb()).contains("39")) {
            return new zzeso(zzeouVar, ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbde.zzmw)).intValue(), scheduledExecutorService);
        }
        return new zzeso(zzb, ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbde.zzmw)).intValue(), scheduledExecutorService);
    }
}
