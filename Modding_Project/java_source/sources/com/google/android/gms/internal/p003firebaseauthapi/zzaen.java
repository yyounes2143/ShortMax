...
public final class zzaen {
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p003firebaseauthapi.zzaen.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).b().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).b().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).b().endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }
    ...
    public static FirebaseException zza(Status status, AuthCredential authCredential, @Nullable String str, @Nullable String str2) {
        ...
        return new FirebaseAuthUserCollisionException(zza(statusCode), zza(zzb(statusCode), status)).d(authCredential).e(str);
    }
    ...
    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, @Nullable FirebaseUser firebaseUser) {
        ...
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzal.o(zzaasVar, firebaseAuth, firebaseUser));
    }
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).b().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
