...
public final class zzepz implements zzhgr {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (((List) this.zzc.zzb()).contains("10")) {
            return new zzeso(zzeouVar, ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbde.zzmC)).intValue(), scheduledExecutorService);
        }
        return new zzeso(zzb, ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbde.zzmC)).intValue(), scheduledExecutorService);
    }
}
