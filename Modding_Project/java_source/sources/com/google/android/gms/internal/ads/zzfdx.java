...
public final class zzfdx {
    public static com.google.android.gms.ads.internal.client.zze zza(Throwable th2) {
        if (th2 instanceof zzedq) {
            zzedq zzedqVar = (zzedq) th2;
            return zzc(zzedqVar.zza(), zzedqVar.zzb());
        } else if (th2 instanceof zzdwm) {
            if (th2.getMessage() == null) {
                return zzd(((zzdwm) th2).zza(), null, null);
            }
            return zzd(((zzdwm) th2).zza(), th2.getMessage(), null);
    ...
    public static com.google.android.gms.ads.internal.client.zze zzb(Throwable th2, @Nullable zzedr zzedrVar) {
