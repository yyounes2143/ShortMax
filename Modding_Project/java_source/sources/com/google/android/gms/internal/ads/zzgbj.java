...
public final class zzgbj {
    ...
    public static int zza(double d10, RoundingMode roundingMode) {
        ...
        boolean zzd;
        boolean z11 = false;
        if (d10 > 0.0d && zzgbk.zzb(d10)) {
            z10 = true;
        } else {
            z10 = false;
        }
        zzfvp.zzf(z10, "x must be positive and finite");
    ...
    */
    public static long zzb(double r8, java.math.RoundingMode r10) {
        /*
            boolean r0 = com.google.android.gms.internal.ads.zzgbk.zzb(r8)
            if (r0 == 0) goto Lbc
            int[] r0 = com.google.android.gms.internal.ads.zzgbi.zza
            int r1 = r10.ordinal()
            r0 = r0[r1]
            r1 = 1
            r2 = 0
        ...
        L77:
            boolean r0 = zzc(r8)
            com.google.android.gms.internal.ads.zzgbp.zzb(r0)
        L7e:
            r2 = r8
        L7f:
        ...
        Lbc:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzgbj.zzb(double, java.math.RoundingMode):long");
    }
    ...
    public static boolean zzc(double d10) {
        ...
        if (d10 != 0.0d && 52 - Long.numberOfTrailingZeros(zzgbk.zza(d10)) > Math.getExponent(d10)) {
            return false;
        }
        return true;
    }
