...
/* renamed from: com.google.android.gms.internal.firebase-auth-api.zzaol  reason: invalid package */
...
interface zzaol {
    ...
    void zza(int i10, zzajv zzajvVar) throws IOException;

    <K, V> void zza(int i10, zzamd<K, V> zzamdVar, Map<K, V> map) throws IOException;

    void zza(int i10, Object obj) throws IOException;

    @Deprecated
    void zza(int i10, Object obj, zzanb zzanbVar) throws IOException;

    void zza(int i10, String str) throws IOException;

    void zza(int i10, List<zzajv> list) throws IOException;

    @Deprecated
    void zza(int i10, List<?> list, zzanb zzanbVar) throws IOException;
    ...
    void zzb(int i10, Object obj, zzanb zzanbVar) throws IOException;

    void zzb(int i10, List<String> list) throws IOException;

    void zzb(int i10, List<?> list, zzanb zzanbVar) throws IOException;
