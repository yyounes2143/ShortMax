...
public final class zzbvs {
    ...
    public zzbvs(JSONObject jSONObject) {
        ...
        this.zzj = zzl(jSONObject.optString(MetricsSQLiteCacheKt.METRICS_START_TIME)).longValue();
        this.zzk = zzl(jSONObject.optString(MetricsSQLiteCacheKt.METRICS_END_TIME)).longValue();
    }
