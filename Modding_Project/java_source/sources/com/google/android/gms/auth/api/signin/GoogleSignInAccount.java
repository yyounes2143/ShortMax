...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static GoogleSignInAccount zab(@Nullable String str) throws JSONException {
        ...
        if (jSONObject.has(CommonConstant.KEY_DISPLAY_NAME)) {
            str4 = jSONObject.optString(CommonConstant.KEY_DISPLAY_NAME);
        } else {
            str4 = null;
        }
        if (jSONObject.has(CommonConstant.KEY_GIVEN_NAME)) {
            str5 = jSONObject.optString(CommonConstant.KEY_GIVEN_NAME);
        } else {
            str5 = null;
        }
        if (jSONObject.has(CommonConstant.KEY_FAMILY_NAME)) {
            str6 = jSONObject.optString(CommonConstant.KEY_FAMILY_NAME);
        } else {
            str6 = null;
        }
        ...
        if (jSONObject.has(CommonConstant.KEY_SERVER_AUTH_CODE)) {
            str7 = jSONObject.optString(CommonConstant.KEY_SERVER_AUTH_CODE);
        }
        zaa2.zai = str7;
        return zaa2;
    }
    ...
    public int hashCode() {
        return ((this.zak.hashCode() + TTVideoEngineInterface.PLAYER_OPTION_ABR_STALL_PENALTY_PARAMETER) * 31) + getRequestedScopes().hashCode();
    }
    ...
    public final String zad() {
        ...
        try {
            ...
            if (getServerAuthCode() != null) {
                jSONObject.put(CommonConstant.KEY_SERVER_AUTH_CODE, getServerAuthCode());
            }
