...
public class AppLovinBannerAd implements MediationBannerAd, AppLovinAdLoadListener, AppLovinAdDisplayListener, AppLovinAdClickListener, AppLovinAdViewEventListener {
    ...
    public void adFailedToDisplay(AppLovinAd appLovinAd, AppLovinAdView appLovinAdView, AppLovinAdViewDisplayErrorCode appLovinAdViewDisplayErrorCode) {
        String str = TAG;
        Log.w(str, "Banner failed to display: " + appLovinAdViewDisplayErrorCode);
    }
    ...
    public void adReceived(AppLovinAd appLovinAd) {
        String str = TAG;
        Log.d(str, "Banner did load ad for zone: " + this.zoneId);
    ...
    public void failedToReceiveAd(int i10) {
        ...
        String str = TAG;
        Log.w(str, "Failed to load banner ad with error: " + i10);
    ...
    public void loadAd() {
        ...
        this.appLovinInitializer.initialize(this.context, string, new AppLovinInitializer.OnInitializeSuccessListener() { // from class: com.google.ads.mediation.applovin.AppLovinBannerAd.1
            ...
            public void onInitializeSuccess() {
                ...
                String str = AppLovinBannerAd.TAG;
                Log.d(str, "Requesting banner of size " + appLovinAdSizeFromAdMobAdSize + " for zone: " + AppLovinBannerAd.this.zoneId);
                AppLovinBannerAd appLovinBannerAd2 = AppLovinBannerAd.this;
                appLovinBannerAd2.appLovinAdViewWrapper = appLovinBannerAd2.appLovinAdFactory.createAdView(AppLovinBannerAd.this.sdk, appLovinAdSizeFromAdMobAdSize, adSize, AppLovinBannerAd.this.context);
