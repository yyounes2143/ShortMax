...
public class MintegralMediationAdapter extends RtbAdapter {
    ...
    public /* synthetic */ void lambda$initialize$0(Map map, final Context context, final InitializationCompleteCallback initializationCompleteCallback) {
    ...
    public void initialize(@NonNull final Context context, @NonNull final InitializationCompleteCallback initializationCompleteCallback, @NonNull List<MediationConfiguration> list) {
        ...
        if (size > 0 && size2 > 0) {
            ...
            this.executorService.submit(new Runnable() { // from class: com.google.ads.mediation.mintegral.a
                @Override // java.lang.Runnable
                public final void run() {
                    MintegralMediationAdapter.this.lambda$initialize$0(mBConfigurationMap, context, initializationCompleteCallback);
                }
            });
            return;
        }
