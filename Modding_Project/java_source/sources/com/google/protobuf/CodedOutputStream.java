...
public abstract class CodedOutputStream extends ByteOutput {
        ...
        final void bufferUInt32NoTag(int i10) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((i10 & (-128)) != 0) {
                    ...
                    int i11 = this.position;
                    this.position = i11 + 1;
                    s0.putByte(bArr, i11, (byte) ((i10 & 127) | 128));
                    i10 >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i12 = this.position;
                this.position = i12 + 1;
                s0.putByte(bArr2, i12, (byte) i10);
    ...
    public static class c extends CodedOutputStream {
        ...
        @Override // com.google.protobuf.CodedOutputStream
        final void writeMessage(int i10, MessageLite messageLite, l0 l0Var) throws IOException {
            writeTag(i10, 2);
        ...
        @Override // com.google.protobuf.CodedOutputStream
        final void writeMessageNoTag(MessageLite messageLite, l0 l0Var) throws IOException {
            writeUInt32NoTag(((AbstractMessageLite) messageLite).getSerializedSize(l0Var));
            l0Var.writeTo(messageLite, this.wrapper);
        }
    ...
    private static final class d extends b {
        ...
        @Override // com.google.protobuf.CodedOutputStream
        void writeMessage(int i10, MessageLite messageLite, l0 l0Var) throws IOException {
            writeTag(i10, 2);
            writeMessageNoTag(messageLite, l0Var);
        }

        @Override // com.google.protobuf.CodedOutputStream
        void writeMessageNoTag(MessageLite messageLite, l0 l0Var) throws IOException {
            writeUInt32NoTag(((AbstractMessageLite) messageLite).getSerializedSize(l0Var));
            l0Var.writeTo(messageLite, this.wrapper);
        }
        ...
        public void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                if (computeUInt32SizeNoTag2 == computeUInt32SizeNoTag) {
                    ...
                    q.position(this.buffer, position2);
                    encode(str);
                    int position3 = this.buffer.position();
                    q.position(this.buffer, position);
                    writeUInt32NoTag(position3 - position2);
                    q.position(this.buffer, position3);
                } else {
                    writeUInt32NoTag(Utf8.encodedLength(str));
                    encode(str);
                }
        ...
        public void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                if (computeUInt32SizeNoTag2 == computeUInt32SizeNoTag) {
                    ...
                    q.position(this.buffer, bufferPos);
                    Utf8.encodeUtf8(str, this.buffer);
        ...
        public void write(byte[] bArr, int i10, int i11) throws IOException {
            if (bArr != null && i10 >= 0 && i11 >= 0 && bArr.length - i11 >= i10) {
                ...
                if (this.limit - j10 >= j11) {
                    s0.copyMemory(bArr, i10, j11, j10);
                    this.position += j10;
                    return;
                }
            }
    ...
    abstract void writeMessageNoTag(MessageLite messageLite, l0 l0Var) throws IOException;
    ...
    @Deprecated
    static int computeGroupSizeNoTag(MessageLite messageLite, l0 l0Var) {
    ...
    @Deprecated
    final void writeGroupNoTag(MessageLite messageLite, l0 l0Var) throws IOException {
        l0Var.writeTo(messageLite, this.wrapper);
    }
