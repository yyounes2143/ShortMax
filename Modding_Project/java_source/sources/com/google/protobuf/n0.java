...
public final class n0 {
    ...
    public static int computeSizeInt64ListNoTag(List<Long> list) {
        ...
        if (list instanceof s) {
            ...
            i10 = 0;
            while (i11 < size) {
                i10 += CodedOutputStream.computeInt64SizeNoTag(sVar.getLong(i11));
                i11++;
            }
        } else {
            i10 = 0;
    ...
    public static int computeSizeMessage(int i10, Object obj, l0 l0Var) {
        ...
        return CodedOutputStream.computeMessageSize(i10, (MessageLite) obj, l0Var);
    }
    ...
    public static int computeSizeSInt64ListNoTag(List<Long> list) {
        ...
        if (list instanceof s) {
            ...
            i10 = 0;
            while (i11 < size) {
                i10 += CodedOutputStream.computeSInt64SizeNoTag(sVar.getLong(i11));
                i11++;
            }
        } else {
            i10 = 0;
    ...
    public static int computeSizeUInt64ListNoTag(List<Long> list) {
        ...
        if (list instanceof s) {
            ...
            i10 = 0;
            while (i11 < size) {
                i10 += CodedOutputStream.computeUInt64SizeNoTag(sVar.getLong(i11));
                i11++;
            }
        } else {
            i10 = 0;
        ...
        if (list instanceof RandomAccess) {
            ...
            for (int i12 = 0; i12 < size; i12++) {
                ...
                if (enumLiteMap.findValueByNumber(intValue) != null) {
                    ...
                    ub2 = (UB) storeUnknownEnum(obj, i10, intValue, ub2, q0Var);
                }
            }
            if (i11 != size) {
            ...
            while (it.hasNext()) {
                ...
                if (enumLiteMap.findValueByNumber(intValue2) == null) {
                    ub2 = (UB) storeUnknownEnum(obj, i10, intValue2, ub2, q0Var);
                    it.remove();
                }
            }
        }
    ...
    public static <T, FT extends FieldSet.FieldDescriptorLite<FT>> void mergeExtensions(j<FT> jVar, T t10, T t11) {
        FieldSet<FT> extensions = jVar.getExtensions(t11);
    ...
    public static int computeSizeGroupList(int i10, List<MessageLite> list, l0 l0Var) {
        ...
        int i11 = 0;
        for (int i12 = 0; i12 < size; i12++) {
            i11 += CodedOutputStream.computeGroupSize(i10, list.get(i12), l0Var);
        }
        return i11;
    }
    ...
    public static int computeSizeMessageList(int i10, List<?> list, l0 l0Var) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (obj instanceof LazyFieldLite) {
                ...
                computeMessageSizeNoTag = CodedOutputStream.computeMessageSizeNoTag((MessageLite) obj, l0Var);
            }
            computeTagSize += computeMessageSizeNoTag;
        }
        return computeTagSize;
