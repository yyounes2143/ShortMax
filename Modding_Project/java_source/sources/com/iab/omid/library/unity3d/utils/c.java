...
public class c {
    ...
    private static WindowManager f23188a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f23189b = {TextureRenderKeys.KEY_IS_X, TextureRenderKeys.KEY_IS_Y, "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    static float f23190c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", a10.f23192a);
            jSONObject.put("height", a10.f23193b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f23188a != null) {
            ...
            f23188a.getDefaultDisplay().getRealSize(point);
            f10 = a(point.x);
            f11 = a(point.y);
        } else {
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f23190c = context.getResources().getDisplayMetrics().density;
            f23188a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0342a c0342a) {
        com.iab.omid.library.unity3d.internal.e a10 = c0342a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0342a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f23191a[outputDeviceStatus.ordinal()] == 1;
    }
