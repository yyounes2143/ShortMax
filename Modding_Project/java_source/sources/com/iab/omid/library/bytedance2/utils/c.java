...
public class c {
    ...
    private static WindowManager f22789a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f22790b = {TextureRenderKeys.KEY_IS_X, TextureRenderKeys.KEY_IS_Y, "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    static float f22791c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", a10.f22793a);
            jSONObject.put("height", a10.f22794b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f22789a != null) {
            ...
            f22789a.getDefaultDisplay().getRealSize(point);
            f10 = a(point.x);
            f11 = a(point.y);
        } else {
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f22791c = context.getResources().getDisplayMetrics().density;
            f22789a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0330a c0330a) {
        com.iab.omid.library.bytedance2.internal.e a10 = c0330a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0330a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f22792a[outputDeviceStatus.ordinal()] == 1;
    }
