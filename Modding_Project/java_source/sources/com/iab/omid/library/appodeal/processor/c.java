...
public class c implements a {
    ...
    ArrayList<View> a() {
        ...
        if (c10 != null) {
            Collection<com.iab.omid.library.appodeal.adsession.a> a10 = c10.a();
            IdentityHashMap identityHashMap = new IdentityHashMap((a10.size() * 2) + 3);
            for (com.iab.omid.library.appodeal.adsession.a aVar : a10) {
                View e10 = aVar.e();
    ...
    public JSONObject a(View view) {
        JSONObject a10 = com.iab.omid.library.appodeal.utils.c.a(0, 0, 0, 0);
        com.iab.omid.library.appodeal.utils.c.a(a10, e.a());
        return a10;
    }
    ...
    public void a(View view, JSONObject jSONObject, a.InterfaceC0324a interfaceC0324a, boolean z10, boolean z11) {
        ...
        while (it.hasNext()) {
            interfaceC0324a.a(it.next(), this.f22639a, jSONObject, z11);
        }
    }
}
