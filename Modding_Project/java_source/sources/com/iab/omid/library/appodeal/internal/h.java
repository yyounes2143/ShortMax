...
public class h {
    ...
    private static h f22622a = new h();
    ...
    public class a implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ WebView f22623a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ String f22624b;

        a(WebView webView, String str) {
            this.f22623a = webView;
            this.f22624b = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            h.this.c(this.f22623a, this.f22624b);
        }
    }
    ...
    public boolean c(WebView webView, String str) {
        if (webView != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                com.iab.omid.library.appodeal.utils.d.b("Unable to inject javascript: " + e10.getMessage());
            }
        }
        return false;
    }
