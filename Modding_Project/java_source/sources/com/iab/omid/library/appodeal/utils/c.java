...
public class c {
    ...
    private static WindowManager f22659a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f22660b = {TextureRenderKeys.KEY_IS_X, TextureRenderKeys.KEY_IS_Y, "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    static float f22661c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", a10.f22663a);
            jSONObject.put("height", a10.f22664b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f22659a != null) {
            ...
            f22659a.getDefaultDisplay().getRealSize(point);
            f10 = a(point.x);
            f11 = a(point.y);
        } else {
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f22661c = context.getResources().getDisplayMetrics().density;
            f22659a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0326a c0326a) {
        com.iab.omid.library.appodeal.internal.e a10 = c0326a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0326a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f22662a[outputDeviceStatus.ordinal()] == 1;
    }
