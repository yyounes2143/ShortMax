...
public class c {
    ...
    private static WindowManager f23059a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f23060b = {TextureRenderKeys.KEY_IS_X, TextureRenderKeys.KEY_IS_Y, "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    static float f23061c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", a10.f23063a);
            jSONObject.put("height", a10.f23064b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f23059a != null) {
            ...
            f23059a.getDefaultDisplay().getRealSize(point);
            f10 = a(point.x);
            f11 = a(point.y);
        } else {
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f23061c = context.getResources().getDisplayMetrics().density;
            f23059a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0338a c0338a) {
        com.iab.omid.library.mmadbridge.internal.e a10 = c0338a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0338a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f23062a[outputDeviceStatus.ordinal()] == 1;
    }
