...
public class c {
    ...
    private static WindowManager f23322a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f23323b = {TextureRenderKeys.KEY_IS_X, TextureRenderKeys.KEY_IS_Y, "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    static float f23324c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", a10.f23326a);
            jSONObject.put("height", a10.f23327b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f23322a != null) {
            ...
            f23322a.getDefaultDisplay().getRealSize(point);
            f10 = a(point.x);
            f11 = a(point.y);
        } else {
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f23324c = context.getResources().getDisplayMetrics().density;
            f23322a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0346a c0346a) {
        com.iab.omid.library.vungle.internal.e a10 = c0346a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0346a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f23325a[outputDeviceStatus.ordinal()] == 1;
    }
