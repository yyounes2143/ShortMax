...
public class c {
    ...
    private static WindowManager f22523a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f22524b = {TextureRenderKeys.KEY_IS_X, TextureRenderKeys.KEY_IS_Y, "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    static float f22525c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", a10.f22527a);
            jSONObject.put("height", a10.f22528b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f22523a != null) {
            ...
            f22523a.getDefaultDisplay().getRealSize(point);
            f10 = a(point.x);
            f11 = a(point.y);
        } else {
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f22525c = context.getResources().getDisplayMetrics().density;
            f22523a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0322a c0322a) {
        com.iab.omid.library.applovin.internal.e a10 = c0322a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0322a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f22526a[outputDeviceStatus.ordinal()] == 1;
    }
