...
public class c extends com.bykv.vk.openvk.preload.b.d<Pair<Uri, UpdatePackage>, Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> {
    ...
    private com.bykv.vk.openvk.preload.geckox.b f11383d;

    /* renamed from: e  reason: collision with root package name */
    private File f11384e;

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.bykv.vk.openvk.preload.b.d
    public final void a(Object... objArr) {
        super.a(objArr);
        this.f11383d = (com.bykv.vk.openvk.preload.geckox.b) objArr[0];
        this.f11384e = (File) objArr[1];
    }
    ...
    public Object a(com.bykv.vk.openvk.preload.b.b<Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        try {
            this.f11383d.i().downloadFile(uri, length, new BufferOutputStream(a10));
            try {
            ...
            a10.e();
            throw new com.bykv.vk.openvk.preload.geckox.b.a("download patch zip failed, url:" + uri + ", channel:" + updatePackage.getChannel() + ", pkg id:" + updatePackage.getPatch().getId() + ", caused by:" + th2.getMessage(), th2);
        }
    }
}
