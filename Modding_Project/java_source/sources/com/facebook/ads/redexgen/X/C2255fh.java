...
public final class C2255fh extends R8 implements MediaViewApi, Repairable, SM {
    ...
    private void A07() {
        ...
        EnumC1817Wq.A04(this.A09, EnumC1817Wq.A0B);
        EnumC1817Wq.A04(this.A05, EnumC1817Wq.A0B);
        EnumC1817Wq.A04(this.A01, EnumC1817Wq.A0B);
    }
    ...
    private void A0A(View view, C1652Qc c1652Qc) {
        if (this.A0B != null) {
        ...
        String A1D = c1652Qc.A1D();
        if (this.A03.getContext() == null) {
            return;
        }
        this.A0B = AbstractC2086cv.A01(this.A07, A1D);
        if (this.A0B != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0C(C2111dL c2111dL, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2111dL, attributeSet, i10, i11));
        A0H(new C1890Zl(c2111dL, attributeSet, i10, i11));
        this.A08 = new C0L(c2111dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2111dL, attributeSet, i10, i11));
        A07();
    }

    private final void A0D(C2111dL c2111dL, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2111dL, attributeSet, i10));
        A0H(new C1890Zl(c2111dL, attributeSet, i10));
        this.A08 = new C0L(c2111dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2111dL, attributeSet, i10));
        A07();
    }

    private final void A0E(C2111dL c2111dL, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2111dL, attributeSet));
        A0H(new C1890Zl(c2111dL, attributeSet));
        this.A08 = new C0L(c2111dL, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2111dL, attributeSet));
        A07();
    }

    private final void A0F(C2111dL c2111dL, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2111dL));
        A0H(new C1890Zl(c2111dL));
        this.A08 = new C0L(c2111dL);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2111dL));
        A07();
    }

    private void A0G(C1652Qc c1652Qc, boolean z10, C1767Up c1767Up) {
        KZ A04 = new KZ(this.A02, this.A07).A04();
        if (z10) {
            A04.A06(new C2262fo(this, c1652Qc));
        }
        A04.A07(c1767Up.getUrl());
    }

    private void A0H(C1890Zl c1890Zl) {
        if (!this.A0D) {
            if (this.A09 != null) {
                this.A03.removeView(this.A09);
            }
            c1890Zl.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c1890Zl, layoutParams);
            this.A09 = c1890Zl;
            return;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:67:0x02f3, code lost:
        new com.facebook.ads.redexgen.X.KZ(r17.A03, r17.A07).A05(r17.A03.getHeight(), r17.A03.getWidth()).A06(new com.facebook.ads.redexgen.X.C2258fk(r17, r2)).A07(r2.getAdCoverImage().getUrl());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:70:0x0326, code lost:
        android.util.Log.i(com.facebook.ads.redexgen.X.C2255fh.A0G, A04(com.ss.ttm.player.MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_GET_CACHE_TIMESTAMP, 9, 49) + ((com.facebook.ads.redexgen.X.RK) r18.getNativeAdApi()).A02());
     */
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C2255fh.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C2111dL A12 = ((C1652Qc) nativeAdBaseApi).A12();
        C2111dL adObjectContext = this.A07;
        adObjectContext.A0L(A12);
        A12.A0O(this);
        this.A0D = true;
        C1652Qc A0L = C1652Qc.A0L(nativeAdBaseApi);
        A0L.A1S(this.A03);
        ...
        if (this.A01 != null) {
            ...
            if (this.A01 instanceof C1881Zc) {
                ((C1881Zc) this.A01).A04();
            } else {
                ((C11556g) this.A01).setAdapter(null);
            }
        }
        this.A02.setVisibility(0);
        bringChildToFront(this.A02);
        this.A00 = this.A02;
        C1767Up adIcon = A0L.getAdIcon();
        if (adIcon != null) {
            SF A11 = A0L.A11();
            if (A0F[1].charAt(7) == 'A') {
                throw new RuntimeException();
            ...
            if (A0N != null) {
                ...
                if (z10) {
                    this.A03.post(new C2263fp(this, A0L));
                }
            } else {
                A0G(A0L, z10, adIcon);
            }
            ...
            if (nativeAdBaseApi.isAdLoaded()) {
                C2111dL adObjectContext2 = this.A07;
                adObjectContext2.A08().AAy(A04(258, 3, 44), AbstractC1722Sv.A0W, new C1723Sw(A04(192, 23, 42)));
            }
        }
        A0A(this.A02, A0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C2255fh.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C2255fh.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C2255fh.getMediaWidth():int");
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        switch (adViewConstructorParams.getInitializationType()) {
            ...
            case 2:
                ...
                A0D(c2111dL, attributeSet, adViewConstructorParams.getDefStyleAttr(), mediaView);
                break;
            case 3:
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ...
            ((RH) this.A05.getMediaViewVideoRendererApi()).A07(new C2256fi(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C2255fh) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
