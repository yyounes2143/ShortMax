...
public final class KY {
    ...
    private int A00(InterfaceC2585lN interfaceC2585lN) {
        this.A07.A0i(AbstractC10974a.A07);
        this.A03 = true;
        interfaceC2585lN.AI1();
        return 0;
    }

    private int A01(InterfaceC2585lN interfaceC2585lN, C1413Gt c1413Gt, int i10) throws IOException {
        int min = (int) Math.min(this.A06, interfaceC2585lN.A8G());
        ...
        this.A07.A0d(min);
        interfaceC2585lN.AI1();
        interfaceC2585lN.AG9(this.A07.A0l(), 0, min);
        this.A01 = A03(this.A07, i10);
        this.A04 = true;
        return 0;
    }

    private int A02(InterfaceC2585lN interfaceC2585lN, C1413Gt c1413Gt, int i10) throws IOException {
        long inputLength = interfaceC2585lN.A8G();
        int min = (int) Math.min(this.A06, inputLength);
        long inputLength2 = inputLength - min;
        if (interfaceC2585lN.A8f() != inputLength2) {
            c1413Gt.A00 = inputLength2;
            return 1;
        }
        this.A07.A0d(min);
        interfaceC2585lN.AI1();
    ...
    private long A03(C4J c4j, int i10) {
        ...
        for (int A092 = c4j.A09(); A092 < A0A2; A092++) {
            ...
            if (searchEndPosition == 71) {
                long A01 = AbstractC1503Kg.A01(c4j, A092, i10);
    ...
    private long A04(C4J c4j, int i10) {
        ...
        for (int i11 = A0A2 - 188; i11 >= A092; i11--) {
            if (AbstractC1503Kg.A03(c4j.A0l(), A092, A0A2, i11)) {
                long A01 = AbstractC1503Kg.A01(c4j, i11, i10);
                int searchStartPosition = (A01 > (-9223372036854775807L) ? 1 : (A01 == (-9223372036854775807L) ? 0 : -1));
                if (searchStartPosition != 0) {
                    return A01;
                }
    ...
    public final int A07(InterfaceC2585lN interfaceC2585lN, C1413Gt c1413Gt, int i10) throws IOException {
        if (i10 <= 0) {
            return A00(interfaceC2585lN);
        }
        if (!this.A05) {
            return A02(interfaceC2585lN, c1413Gt, i10);
        }
        if (this.A02 == -9223372036854775807L) {
            return A00(interfaceC2585lN);
        }
        if (!this.A04) {
            int A01 = A01(interfaceC2585lN, c1413Gt, i10);
            if (A0A[0].charAt(2) != 'O') {
