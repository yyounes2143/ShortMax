...
public final class C2497jl implements KJ {
    ...
    public C2497jl(String str) {
        this.A0K = str;
    }

    private int A00(C4I c4i) throws C10532i {
        int A01 = c4i.A01();
    ...
    private int A01(C4I c4i) throws C10532i {
        int tmp;
        int i10 = 0;
    ...
    private void A06(C4I c4i) throws C10532i {
    ...
    @RequiresNonNull({"output"})
    private void A08(C4I c4i) throws C10532i {
        int i10;
        boolean A0H;
        int A04 = c4i.A04(1);
        if (A04 == 1) {
            ...
            if (c4i.A0H()) {
                ...
                if (A042 == 0 && A043 == 0) {
                    if (A04 == 0) {
                        ...
                        C2796or A14 = new C2D().A0y(this.A0F).A11(A03(0, 15, 91)).A0w(this.A0E).A0b(this.A02).A0m(this.A05).A12(Collections.singletonList(bArr)).A10(this.A0K).A14();
    ...
    public final void A5U(GY gy, C1501Ke c1501Ke) {
        c1501Ke.A05();
        this.A0D = gy.AJh(c1501Ke.A03(), 1);
        this.A0F = c1501Ke.A04();
    }
