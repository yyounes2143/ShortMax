...
public final class JS extends AbstractC1945ae {
    public RelativeLayout A00;
    public RelativeLayout A01;
    public InterfaceC2069ce A02;
    public EG A03;
    public E1 A04;
    public C10793i A05;
    ...
    public static final int A0V = (int) (AbstractC1812Wl.A02 * 24.0f);
    public static final int A0U = (int) (AbstractC1812Wl.A02 * 8.0f);
    public static final int A0N = (int) (AbstractC1812Wl.A02 * 1.0f);
    public static final int A0O = (int) (AbstractC1812Wl.A02 * 24.0f);
    public static final int A0T = (int) (AbstractC1812Wl.A02 * 3.0f);
    public static final int A0I = (int) (AbstractC1812Wl.A02 * 5.0f);
    public static final int A0W = (int) (AbstractC1812Wl.A02 * 8.0f);
    public static final int A0J = (int) (AbstractC1812Wl.A02 * 16.0f);
    public static final int A0L = (int) (AbstractC1812Wl.A02 * 16.0f);
    public static final int A0K = (int) (AbstractC1812Wl.A02 * 8.0f);
    public static final int A0M = (int) (AbstractC1812Wl.A02 * 8.0f);
    public static final int A0P = (int) (AbstractC1812Wl.A02 * 12.0f);
    public static final int A0H = (int) (AbstractC1812Wl.A02 * 40.0f);
    public static final int A0S = (int) (AbstractC1812Wl.A02 * 16.0f);
    public static final int A0R = (int) (AbstractC1812Wl.A02 * 24.0f);
    public static final int A0Q = (int) (AbstractC1812Wl.A02 * 16.0f);
    public static final int A0G = (int) (AbstractC1812Wl.A02 * 6.0f);

    public JS(C1949ai c1949ai) {
        super(c1949ai, false);
        this.A0E = new DP() { // from class: com.facebook.ads.redexgen.X.5c
            ...
            public final void A03(DQ dq2) {
                ...
                interfaceC2069ce = JS.this.A02;
                if (interfaceC2069ce == null) {
                    return;
                }
                interfaceC2069ce2 = JS.this.A02;
    ...
    private LinearLayout A00() {
        ...
        if (!TextUtils.isEmpty(A0B)) {
            XX xx = XX.RATINGS;
            AbstractC2392hy A052 = this.A0C.A05();
            String[] strArr = A0F;
    ...
    private LinearLayout A01(XX xx, String str) {
        ...
        C1919aE c1919aE = new C1919aE(this.A0C.A06(), 0, -1, xx);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(A0P, A0P);
        layoutParams2.gravity = 16;
        c1919aE.setLayoutParams(layoutParams2);
    ...
    private final RelativeLayout A02(String str, int i10, XX xx) {
        ...
        C1919aE iconView = new C1919aE(this.A0C.A06(), 0, -1, xx);
    ...
    private E1 A05() {
        ...
        this.A05 = new C10793i(this.A0B, getAdEventManager(), e12, this.A0C.A05().A25(), 0, 0, true, null, null);
        if (U7.A1v(this.A0B)) {
    ...
    private void A07() {
        ...
        this.A00.setOnClickListener(new View$OnClickListenerC1978bB(this));
        this.A01.setOnClickListener(new View$OnClickListenerC1979bC(this));
    }

    private void A08() {
        new C1752Ua(this.A0C.A05().A25(), getAdEventManager()).A04(UZ.A0f, null);
        AbstractC1932aR.A00(this.A0C.A06(), this, this.A0C.A05().A20().A0H().A08());
        ...
        this.A04.A0h(EnumC2127db.A02, 20);
