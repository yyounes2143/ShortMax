...
public abstract class AbstractC2358hQ implements VT {
    ...
    static {
        A08();
        XR.A02();
        A0I = AbstractC2358hQ.class.getSimpleName();
        A0F = new Handler(Looper.getMainLooper());
    }

    public AbstractC2358hQ(C2111dL c2111dL, NT nt2) {
        this.A0B = c2111dL;
        this.A08 = nt2;
        if (A0H != null) {
            this.A06 = A0H;
    ...
    private void A09(TE te2) {
        ...
        if (te2.A0C() != null) {
            sharedPreferences.edit().putString(A07(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_ASYNC, 12, 110), te2.A0C()).putLong(A07(342, 16, 54), System.currentTimeMillis()).apply();
            return;
        }
    ...
    private void A0B(PW pw) {
        ...
        if (placement == null || placement.A05() == null) {
            String A07 = A07(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_OPEN_TIMEOUT, 29, 53);
        ...
        this.A00 = null;
        TE te2 = this.A04;
        JSONObject A0E2 = te2.A0E();
        String A072 = A07(MediaPlayer.MEDIA_PLAYER_OPTION_LOOP_PERFER_VIDEO, 3, 13);
        if (A0E2 == null) {
            TC A04 = te2.A04();
            if (!A0F(te2, A04)) {
                return;
            ...
            if (this.A00 == null) {
                this.A0B.A08().AAy(A072, AbstractC1722Sv.A0a, new C1723Sw(A07(81, 26, 5), A04.A02()));
                ADB(V1.A00(AdErrorType.INTERNAL_ERROR));
                return;
            }
            A0R(this.A00, te2, A04, new NU(A04.A04(), te2.A05(), this.A08.A0A, te2.A05().A0C()));
        } else {
            ...
            if (mp2 == null) {
                this.A0B.A08().AAy(A072, AbstractC1722Sv.A0a, new C1723Sw(A07(56, 25, 40), ((TC) arrayList.get(0)).A02()));
                ADB(V1.A00(AdErrorType.INTERNAL_ERROR));
                return;
            }
            boolean z10 = false;
            try {
                if (arrayList.size() > 1 && this.A00 != null && this.A00.AJa()) {
                    ...
                    for (TC tc2 : arrayList) {
                        jSONArray.put(tc2.A04());
                    }
                    jSONObject.put(A07(192, 3, 111), jSONArray);
                    jSONObject.put(A07(198, 12, 124), te2.A0E());
                    A0R(this.A00, te2, A042, new NU(jSONObject, te2.A05(), this.A08.A0A, te2.A05().A0C()));
                    z10 = true;
                }
            ...
            if (!z10) {
                if (arrayList.isEmpty()) {
                    ...
                    this.A0B.A08().AAy(A072, AbstractC1722Sv.A0a, new C1723Sw(A07(22, 34, 82), ((TC) arrayList.get(0)).A02()));
                    ADB(V1.A00(AdErrorType.INTERNAL_ERROR));
                    return;
                } else {
                    TC tc3 = (TC) arrayList.get(0);
                    A0R(this.A00, te2, tc3, new NU(tc3.A04(), te2.A05(), this.A08.A0A, te2.A05().A0C()));
                }
            }
        }
        A09(placement);
    ...
    private boolean A0F(TE te2, TC tc2) {
        ...
        String A02 = tc2.A02();
        MP A00 = this.A0A.A00(this.A0B, te2.A05().A0D());
        if (A00 == null) {
            this.A0B.A08().AAy(A07(MediaPlayer.MEDIA_PLAYER_OPTION_LOOP_PERFER_VIDEO, 3, 13), AbstractC1722Sv.A0a, new C1723Sw(A07(0, 22, 38), A02));
            ADB(V1.A00(AdErrorType.INTERNAL_ERROR));
            return false;
            ...
            if (A04 != null) {
                ...
                JSONObject dataObject = A04.optJSONObject(A07(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_HTTP_RES_FINSIH_TIME, 17, 80));
                A0D(dataObject);
                if (this.A05 == null) {
    ...
    public final void A0L() {
        ...
        new C1752Ua(A7G, this.A09).A04(UZ.A08, hashMap);
    }

    public final void A0M() {
        MP mp2 = this.A01;
        String A07 = A07(MediaPlayer.MEDIA_PLAYER_OPTION_LOOP_PERFER_VIDEO, 3, 13);
        if (mp2 == null) {
            String A072 = A07(107, 26, 102);
            this.A0B.A08().AAy(A07, AbstractC1722Sv.A0Q, new C1723Sw(A072));
            ...
            this.A0B.A08().AAy(A07, AbstractC1722Sv.A0M, new C1723Sw(A073));
    ...
    public final void A0V(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            new C1752Ua(str, this.A09).A04(UZ.A04, null);
        }
    }
    ...
    public final synchronized void AFO(PW pw) {
        try {
            ...
            this.A0B.A08().AAy(A07(MediaPlayer.MEDIA_PLAYER_OPTION_LOOP_PERFER_VIDEO, 3, 13), AbstractC1722Sv.A0T, new C1723Sw(e10));
        }
    }
}
