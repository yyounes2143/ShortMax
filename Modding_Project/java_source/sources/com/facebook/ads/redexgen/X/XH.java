...
public final class XH {
    ...
    public static void A02() {
        A0I = new byte[]{0, 12, 115, ByteCompanionObject.MAX_VALUE, 60, 51, 54, 60, 52, 56, 42, 62, 45, 59, 11, 54, 50, 58, 101, ByteCompanionObject.MAX_VALUE, 75, 78, 122, 69, 89, 67, 94, 67, 69, 68, 114, 94, 91, 111, 80, 76, 86, 75, 86, 80, 81, 102, 105, 102, 99, 105, 97, 78, 111, 102, 107, 115, 94, 99, 103, 111, 119, 120, 125, 119, ByteCompanionObject.MAX_VALUE, 76, 47, 32, 37, 47, 39, 21, 95, 80, 85, 95, 87, 89, 88, 106, 85, 89, 75, 104, 93, 91, 1, 10, 0, 48, 13, 9, 1, 115, 120, 114, 78, 46, 37, 47, 18, 20, 29, 0, 17, 23, 108, 97, 109, 99, 108, 112, 56, 34, 18, 61, 56, 50, 58, 22, 36, 48, 35, 53, 20, 63, 48, 51, 61, 52, 53, 107, 113, 84, 71, 66, 79, 83, 85, 126, 118, 101, 96, 109, 113, 119, 93, 14, 25, 31, 19, 14, 24, 21, 18, 27, 92, 21, 17, 12, 14, 25, 15, 15, 21, 19, 18, 70, 92, 99, 100, 113, 98, 100, 68, 121, 125, 117, 115, 116, 97, 114, 116, 88, 36, 35, 54, 37, 35, 14, 15, 17, 28, 12, 16};
    }
    ...
    private EnumC1817Wq A00() {
        if (this.A0G == null || this.A0F == null) {
            return EnumC1817Wq.A0J;
        }
        View view = this.A0G;
        String[] strArr = A0J;
        if (strArr[6].length() == strArr[4].length()) {
            ...
            strArr2[4] = "";
            if (view != this.A0F) {
                EnumC1817Wq enumC1817Wq = EnumC1817Wq.A0H;
                String[] strArr3 = A0J;
            ...
            Object tag = this.A0G.getTag(EnumC1817Wq.A02);
            if (tag == null) {
                return EnumC1817Wq.A0I;
            }
            if (!(tag instanceof EnumC1817Wq)) {
                EnumC1817Wq enumC1817Wq2 = EnumC1817Wq.A0K;
                if (A0J[2].charAt(2) == 'm') {
                    A0J[0] = "fnwPYOgaVMSkQLAdq2SZMccx8Jl2b0fK";
                    return enumC1817Wq2;
                }
            } else {
                return (EnumC1817Wq) tag;
            }
        }
        throw new RuntimeException();
    }
    ...
    public final void A06(C2111dL c2111dL, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c2111dL.A0F().AK0();
            return;
        }
        ...
        switch (motionEvent.getAction()) {
            case 0:
                this.A04 = (int) (iArr[0] / AbstractC1812Wl.A02);
                this.A05 = (int) (iArr[1] / AbstractC1812Wl.A02);
                this.A06 = (int) (view.getWidth() / AbstractC1812Wl.A02);
                this.A03 = (int) (view.getHeight() / AbstractC1812Wl.A02);
                this.A09 = 1;
                this.A0E = System.currentTimeMillis();
                this.A0A = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC1812Wl.A02);
                int touchStartYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A0B = (int) (touchStartYInPx / AbstractC1812Wl.A02);
            ...
            case 3:
                ...
                this.A07 = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC1812Wl.A02);
                int touchEndYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A08 = (int) (touchEndYInPx / AbstractC1812Wl.A02);
                this.A0F = view2;
                return;
            case 2:
