...
public enum EnumC2394i2 {
    ...
    public static EnumC2394i2[] valuesCustom() {
        EnumC2394i2[] enumC2394i2Arr = (EnumC2394i2[]) values().clone();
        String[] strArr = A01;
        if (strArr[5].charAt(20) != strArr[4].charAt(20)) {
            A01[3] = "UcBpUNe8sR";
            return enumC2394i2Arr;
        }
        throw new RuntimeException();
    }
}
