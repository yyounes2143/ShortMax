...
public abstract class GF {
    ...
    public static void A0B() {
        A00 = new byte[]{100, 112, 97, 108, 106, 42, 100, 102, 54, 107, ByteCompanionObject.MAX_VALUE, 110, 99, 101, 37, 111, 107, 105, 57, 39, 51, 34, 47, 41, 105, 35, 39, 37, 117, 107, 44, 41, 37};
    }

    static {
        A0B();
        A03 = new int[]{1, 2, 3, 6};
        A05 = new int[]{48000, 44100, RedeemCodeVip.REDEMPTION_MEMBER_CANNOT_CLAIM};
        A06 = new int[]{24000, 22050, 16000};
        A04 = new int[]{2, 1, 2, 3, 3, 4, 4, 5};
        A02 = new int[]{32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, MediaPlayer.MEDIA_PLAYER_OPTION_RENDER_STALL_500, FileUtils.S_IRWXU, 512, 576, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_FRAME_DTS_CHECK};
        A07 = new int[]{69, 87, 104, 121, 139, 174, 208, 243, MediaPlayer.MEDIA_PLAYER_OPTION_STOP_SOURCE_ASYNC, 348, 417, TTVideoEngineInterface.PLAYER_OPTION_SET_NETSPEED_LEVEL, 557, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_FIRST_LIVE_PACKET_READ_TIME, MediaPlayer.MEDIA_PLAYER_OPTION_RTM_SIGNAL_OFFER_CREATED_TIME, 975, 1114, MediaPlayer.MEDIA_PLAYER_OPTION_CACHE_OPEN_END_TIME, 1393};
    }
    ...
    public static int A02(ByteBuffer byteBuffer) {
        ...
        for (int i11 = position; i11 <= i10; i11++) {
            ...
            int endIndex = AbstractC10974a.A0F(byteBuffer, startIndex2) & (-2);
    ...
    public static C2796or A07(C4J c4j, String str, String str2, DrmInitData drmInitData) {
        C4I c4i = new C4I();
        c4i.A0C(c4j);
        int fscod = c4i.A04(2);
    ...
    public static C2796or A08(C4J c4j, String str, String str2, DrmInitData drmInitData) {
        C4I c4i = new C4I();
        c4i.A0C(c4j);
