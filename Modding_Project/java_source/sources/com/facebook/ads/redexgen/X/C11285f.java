...
public final class C11285f extends AbstractC1493Jw {
    ...
    public final AbstractC1839Xm A07;
    ...
    public C11285f(C1949ai c1949ai) {
        super(c1949ai, true);
        this.A03 = new Handler(Looper.getMainLooper());
        this.A02 = false;
        this.A08 = c1949ai.A0D();
        this.A07 = c1949ai.A0C();
        this.A06 = new RelativeLayout(c1949ai.A06());
        this.A05 = new RelativeLayout(c1949ai.A06());
        XP.A0I(this.A05);
        XP.A0I(this.A06);
        this.A04 = c1949ai.A02();
        A04();
        this.A06.addView(this.A05, new RelativeLayout.LayoutParams(-2, -2));
        addView(this.A06, new RelativeLayout.LayoutParams(-1, -1));
        AbstractC1932aR.A00(c1949ai.A06(), this.A06, getAdInfo().A0H().A08());
        A03();
        ((AbstractC1945ae) this).A06.A06().A0F().AJw(AbstractC1803Wa.A00(this.A00), getResources().getConfiguration().orientation, false, false, MH.A0C(((AbstractC1945ae) this).A06.A04()));
    }

    private void A02() {
        XP.A0Z(this.A07, getAdDetailsView(), getCtaButton());
        this.A01 = new C2101dA(((AbstractC1945ae) this).A06.A06(), getAdDataBundle(), this.A08, getCtaButton(), this.A03, ((AbstractC1945ae) this).A06.A08());
    ...
    private void A04() {
        ...
        XP.A0I(this.A04);
        C1807Wg A02 = this.A09.A02(getAdDataBundle());
        ((AbstractC1945ae) this).A06.A06().A0H().A00(A02.A01);
        ...
        if (A02.A00) {
            this.A04.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.ac
                ...
                public final void onClick(View view) {
                    C11285f.this.A1W(view);
                }
            });
        } else if (!U7.A1I(getAdContextWrapper())) {
        } else {
            AbstractC1897Zs.A00(this.A04, U7.A1J(getAdContextWrapper()), new View$OnClickListenerC1944ad(this));
        }
    }
    ...
    private void A05() {
        ...
        if (getAdInfo().A0K().A00() >= 0) {
            this.A02 = true;
            if (this.A07 != null) {
                AbstractC1839Xm abstractC1839Xm = this.A07;
                if (getAdDataBundle().A2G()) {
                    i10 = 8;
                }
                abstractC1839Xm.setToolbarActionMode(i10);
                this.A07.setProgressImmediate(0.0f);
            }
            new C1806Wd((int) getAdInfo().A0K().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C1490Jt(this)).A07();
        }
    }
