...
public final class B5<K, V> extends AbstractC2531kJ<K, V> {
    public int A00;
    @ParametricNullness
    public final K A01;
    public final /* synthetic */ C2618lv A02;
     ...
     */
    @Override // com.facebook.ads.redexgen.X.AbstractC2531kJ, java.util.Map.Entry
    @ParametricNullness
    public final V getValue() {
        Object A0F;
        Map<K, V> A0h = this.A02.A0h();
        if (A0h != null) {
            return (V) AbstractC2770oQ.A01(A0h.get(this.A01));
        }
        A00();
        if (this.A00 == -1) {
            return (V) AbstractC2770oQ.A00();
        }
    ...
    public final V setValue(@ParametricNullness V value) {
        ...
        Map<K, V> A0h = this.A02.A0h();
        if (A0h != null) {
            return (V) AbstractC2770oQ.A01(A0h.put(this.A01, value));
        }
        A00();
        if (this.A00 == -1) {
    ...
    public B5(final C2618lv this$0, int index) {
        Object A0E;
        this.A02 = this$0;
