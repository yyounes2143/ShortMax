...
public final class C8T {
    ...
    private long A00() {
        ...
        if (this.A0M != -9223372036854775807L) {
            ...
            long A0Q = AbstractC10974a.A0Q(elapsedTimeSinceStopUs, this.A00);
    ...
    private void A04() {
        ...
        if (playbackPositionUs - systemTimeUs >= 30000) {
            ...
            long[] jArr = this.A0W;
            int i11 = this.A02;
            long systemTimeUs2 = AbstractC10974a.A0R(A01, this.A00);
    ...
    private void A08(long j10) {
        if (this.A0R && this.A0P != null && j10 - this.A09 >= 500000) {
            try {
                this.A0E = (((Integer) AbstractC10974a.A0f((Integer) this.A0P.invoke(C3M.A01(this.A0N), new Object[0]))).intValue() * 1000) - this.A06;
    ...
    private void A09(long j10) {
        ...
        int state3 = AbstractC10974a.A02;
        if (state3 <= 29) {
    ...
    public static boolean A0B(int i10) {
        return AbstractC10974a.A02 < 23 && (i10 == 5 || i10 == 6);
    }
    ...
    public final long A0D(boolean z10) {
        ...
        if (useGetTimestampMode) {
            A0Q = A02(c8q.A01()) + AbstractC10974a.A0Q(nanoTime - c8q.A02(), this.A00);
        } else {
            int i10 = this.A05;
            if (A0Y[0].charAt(8) != '9') {
                throw new RuntimeException();
            ...
            if (i10 == 0) {
                ...
                A0Q = AbstractC10974a.A0Q(this.A0K + nanoTime, this.A00);
            }
            if (!z10) {
        ...
        if (j10 < 1000000) {
            long A0Q2 = this.A0G + AbstractC10974a.A0Q(j10, this.A00);
            long j11 = (j10 * 1000) / 1000000;
            A0Q = ((A0Q * j11) + ((1000 - j11) * A0Q2)) / 1000;
        }
        if (!this.A0U && A0Q > this.A0B) {
            this.A0U = true;
            this.A0V.AEg(System.currentTimeMillis() - AbstractC10974a.A0P(AbstractC10974a.A0R(AbstractC10974a.A0P(A0Q - this.A0B), this.A00)));
        }
        this.A0D = nanoTime;
        this.A0B = A0Q;
    ...
    public final void A0I(AudioTrack audioTrack, boolean z10, int i10, int i11, int i12) {
        ...
        this.A0R = AbstractC10974a.A15(i10);
    ...
    public final boolean A0N(long j10) {
        ...
        if (hadData && !this.A0Q && playState != 1) {
            this.A0V.AFY(this.A01, AbstractC10974a.A0P(this.A06));
        }
        return true;
    }
}
