...
public final class C2789ok implements C1S {
    ...
    public static final C2789ok A07 = new C2O().A05();
    public static final C1R<C2789ok> A06 = new C1R() { // from class: com.facebook.ads.redexgen.X.ol
        @Override // com.facebook.ads.redexgen.X.C1R
        public final C1S A6X(Bundle bundle) {
            return C2789ok.A00(bundle);
        }
    };

    @Deprecated
    public C2789ok(long j10, long j11, long j12, float f10, float f11) {
        this.A04 = j10;
        this.A03 = j11;
        this.A02 = j12;
        this.A01 = f10;
    ...
    */
    public C2789ok(com.facebook.ads.redexgen.X.C2O r10) {
        /*
            r9 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C2789ok.<init>(com.facebook.ads.redexgen.X.2O):void");
    }

    public static /* synthetic */ C2789ok A00(Bundle bundle) {
        return new C2789ok(bundle.getLong(A01(0), -9223372036854775807L), bundle.getLong(A01(1), -9223372036854775807L), bundle.getLong(A01(2), -9223372036854775807L), bundle.getFloat(A01(3), -3.4028235E38f), bundle.getFloat(A01(4), -3.4028235E38f));
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C2789ok) {
            C2789ok c2789ok = (C2789ok) obj;
            if (this.A04 == c2789ok.A04 && this.A03 == c2789ok.A03) {
                long j10 = this.A02;
                ...
                if (j10 == c2789ok.A02) {
                    int i10 = (this.A01 > c2789ok.A01 ? 1 : (this.A01 == c2789ok.A01 ? 0 : -1));
                    String[] strArr = A05;
