...
public final class KU {
    ...
    private int A00(InterfaceC2585lN interfaceC2585lN) {
        this.A06.A0i(AbstractC10974a.A07);
        this.A03 = true;
        interfaceC2585lN.AI1();
        return 0;
    }

    private int A01(InterfaceC2585lN interfaceC2585lN, C1413Gt c1413Gt) throws IOException {
        int min = (int) Math.min(20000L, interfaceC2585lN.A8G());
        ...
        if (bytesToSearch != 30) {
            ...
            c4j.A0d(min);
            interfaceC2585lN.AI1();
            interfaceC2585lN.AG9(this.A06.A0l(), 0, min);
    ...
    private int A02(InterfaceC2585lN interfaceC2585lN, C1413Gt c1413Gt) throws IOException {
        long A8G = interfaceC2585lN.A8G();
        int min = (int) Math.min(20000L, A8G);
        long j10 = A8G - min;
        long searchStartPosition = interfaceC2585lN.A8f();
    ...
    */
    ...
    public final int A0B(InterfaceC2585lN interfaceC2585lN, C1413Gt c1413Gt) throws IOException {
        if (!this.A05) {
            return A02(interfaceC2585lN, c1413Gt);
        }
