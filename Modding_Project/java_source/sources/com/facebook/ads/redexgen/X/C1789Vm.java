...
public final class C1789Vm<T> implements InterfaceC1746Tu<T> {
    ...
    public C1738Tm A00;
    public C1738Tm A01;
    public List<C1789Vm<T>.RecordFileBasedFetch> A02 = new ArrayList();
    public boolean A03;
    public final C1737Tl A04;
    public final U1 A05;
    ...
    public synchronized boolean A06(C1790Vn c1790Vn) {
        if (this.A02.remove(c1790Vn)) {
            if (c1790Vn.A6P() > 0 && c1790Vn.A01().A02.A05(c1790Vn.A01().A01).equals(this.A01)) {
                this.A01 = c1790Vn.A00().A02;
            }
            return true;
        }
        return false;
    ...
    public C1789Vm(C1743Tr c1743Tr, InterfaceC1751Tz interfaceC1751Tz) throws IOException {
        this.A05 = new U1(c1743Tr.A04(A00(515, 4, 103)), interfaceC1751Tz);
        this.A04 = new C1737Tl(new File(c1743Tr.A05(), A00(509, 6, 60)));
        this.A00 = this.A04.A03();
        A05(interfaceC1751Tz);
        this.A01 = this.A00;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    private void A02(int i10, int i11) throws IOException {
        this.A00 = new C1738Tm(i10, i11);
    ...
    public synchronized void A03(C1790Vn c1790Vn) throws U3 {
        if (!this.A03) {
            if (A06(c1790Vn)) {
                if (c1790Vn.A6P() == 0) {
                    return;
                }
                if (this.A00.A04(c1790Vn.A00().A02) == 0) {
                    try {
                        for (C1750Ty c1750Ty : c1790Vn.A00) {
                            if (c1750Ty.A00 == this.A05.A07() && this.A05.A0D()) {
                                A02(this.A05.A06(), 0);
                            } else {
                                A02(this.A05.A06(), c1790Vn.A00().A00);
                                break;
                            }
                        }
            ...
            throw new U3(A00(MediaPlayer.MEDIA_PLAYER_OPTION_SOCKET_ERR_CODE, 43, 59));
        }
        throw new U3(A00(TTVideoEngineInterface.PLAYER_OPTION_HIJACK_RETRY, 39, 60));
    }
    ...
    */
    private void A05(com.facebook.ads.redexgen.X.InterfaceC1751Tz r13) throws java.io.IOException {
        /*
            r12 = this;
        ...
        L7c:
            ...
            goto L5c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1789Vm.A05(com.facebook.ads.redexgen.X.Tz):void");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vn != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T>$RecordFileBasedFetch */
    @Override // com.facebook.ads.redexgen.X.InterfaceC1746Tu
    public final synchronized InterfaceC1745Tt A6O(byte[] bArr, int[] iArr) throws U3 {
        C1789Vm<T>.RecordFileBasedFetch c1790Vn;
        if (!this.A03) {
            int i10 = 0;
            int i11 = 0;
            try {
                ...
                while (true) {
                    C1741Tp A0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i10, iArr, i11);
                    int A00 = A0A.A01().A00();
                    ...
                    i10 += storageOffset2;
                    i11 += i12;
                    if (A0A.A01().A03() == EnumC1739Tn.A03) {
                        arrayList.add(A0A);
                    }
                    if (A0A.A01().A03() == EnumC1739Tn.A04) {
                        break;
                    } else if (A0A.A01().A03() == EnumC1739Tn.A05) {
                        ...
                        this.A01 = new C1738Tm(storageOffset5 + 1, 0);
                    } else {
                        this.A01 = this.A01.A05(i12);
                    }
                }
                c1790Vn = new C1790Vn(this, arrayList, mayHaveMoreData);
                this.A02.add(c1790Vn);
                if (!arrayList.isEmpty()) {
                    C1738Tm c1738Tm = c1790Vn.A01().A02;
                    int storageOffset6 = c1790Vn.A01().A01;
                    this.A01 = c1738Tm.A05(storageOffset6);
                }
            } catch (IOException e10) {
                throw new U3(A00(306, 29, 84), e10);
            }
        } else {
            throw new U3(A00(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_MAX_RETRANSMISSIONS, 36, 123));
        }
        return c1790Vn;
    }
    ...
    public final synchronized void clear() throws U3 {
        try {
            ...
            throw new U3(A00(MediaPlayer.MEDIA_PLAYER_OPTION_GET_LOW_UI_FPS, 24, 87), e10);
        }
    }
