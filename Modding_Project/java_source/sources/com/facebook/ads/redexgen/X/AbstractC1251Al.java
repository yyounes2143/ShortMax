...
public abstract class AbstractC1251Al<E> extends AbstractC2658ma<E> implements Set<E> {
    ...
    @CheckForNull
    @LazyInit
    public transient AbstractC1252Am<E> A00;
    ...
    public AbstractC1252Am<E> A0J() {
        AbstractC1252Am<E> abstractC1252Am = this.A00;
        if (abstractC1252Am == null) {
            AbstractC1252Am<E> A0M = A0M();
            this.A00 = A0M;
            return A0M;
        }
        return abstractC1252Am;
    }

    public abstract AbstractC2831pg<E> A0N();
    ...
    */
    public static int A03(int r6) {
        ...
        L26:
            ...
            com.facebook.ads.redexgen.X.AbstractC2461jA.A0E(r4, r0)
            return r3
        L34:
            r4 = 0
            goto L26
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AbstractC1251Al.A03(int):int");
    }

    public static <E> AbstractC1251Al<E> A04(int n10, Object... elements) {
        ...
        switch (n10) {
            ...
            default:
                ...
                for (int j10 = 0; j10 < n10; j10++) {
                    Object A00 = AbstractC2771oR.A00(objArr[j10], j10);
                    int hashCode = A00.hashCode();
                    int tableSize = AbstractC2652mU.A00(hashCode);
                    while (true) {
                ...
                return new C1W(objArr, uniques, objArr2, i10, i11);
        }
        throw new RuntimeException();
    }

    public static <E> AbstractC1251Al<E> A05(E e12, E e22) {
        return A04(2, e12, e22);
    }

    public static <E> AbstractC1251Al<E> A06(E e12, E e22, E e32) {
    ...
    public static <E> AbstractC1251Al<E> A07(Collection<? extends E> elements) {
        if ((elements instanceof AbstractC1251Al) && !(elements instanceof SortedSet)) {
            AbstractC1251Al<E> abstractC1251Al = (AbstractC1251Al) elements;
            if (!abstractC1251Al.A0K()) {
    ...
    public static <E> AbstractC1251Al<E> A08(E[] elements) {
    ...
    public static <E> AbstractC1251Al<E> A09() {
        return C1W.A05;
    }

    public static <E> AbstractC1251Al<E> A0A(E element) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Al != com.google.common.collect.ImmutableSet<E> */
    public AbstractC1252Am<E> A0M() {
        return AbstractC1252Am.A06(toArray());
    }
    ...
    public boolean equals(@CheckForNull Object object) {
        ...
        if ((object instanceof AbstractC1251Al) && A0O() && ((AbstractC1251Al) object).A0O() && hashCode() != object.hashCode()) {
            return false;
        }
        return AbstractC2799ou.A09(this, object);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Al != com.google.common.collect.ImmutableSet<E> */
    @Override // java.util.Collection, java.util.Set
    public int hashCode() {
        return AbstractC2799ou.A00(this);
    }
