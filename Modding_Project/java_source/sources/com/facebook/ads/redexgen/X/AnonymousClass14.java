...
public abstract class AnonymousClass14 extends C9Z {
    ...
    public final C2718nY A0q;
    public final C2718nY A0r;
    public final C6N A0s;
    public final C9U A0t;
    public final InterfaceC1257Ar A0u;
    public final ArrayDeque<C1240Aa> A0v;
    public final List<Long> A0w;
    public final boolean A0x;
    public final boolean A0y;
    public final boolean A0z;
    public final C2386hs A10;
    public final C2389hv A11;
    ...
    public AnonymousClass14(int i10, C2389hv c2389hv, C2386hs c2386hs, InterfaceC1257Ar interfaceC1257Ar, C9U c9u, boolean z10, boolean z11, int i11, int i12) {
        super(i10);
        this.A09 = -9223372036854775807L;
        this.A08 = -9223372036854775807L;
        this.A0m = false;
        this.A0k = false;
        C3M.A08(AbstractC10974a.A02 >= 16);
        this.A11 = (C2389hv) C3M.A01(c2389hv);
        this.A10 = (C2386hs) C3M.A01(c2386hs);
        this.A0u = (InterfaceC1257Ar) C3M.A01(interfaceC1257Ar);
        this.A0t = c9u;
        this.A0z = z10;
        this.A0x = z11;
        this.A0o = i11;
        this.A0n = i12;
        this.A0q = new C2718nY(0);
        this.A0r = C2718nY.A02();
        this.A0s = new C6N();
        ...
        this.A0y = C2397i5.A03(EnumC2394i2.A1r);
        this.A12 = C2397i5.A03(EnumC2394i2.A1c);
    }
    ...
    private int A0w(String str) {
        if (AbstractC10974a.A02 <= 25) {
            ...
            if (A14[0].length() == 4) {
                ...
                if (A0x.equals(str) && (AbstractC10974a.A06.startsWith(A0x(681, 7, 108)) || AbstractC10974a.A06.startsWith(A0x(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SKIP_FIND_UNNECESSARY_STREAM, 7, 115)) || AbstractC10974a.A06.startsWith(A0x(660, 7, 123)) || AbstractC10974a.A06.startsWith(A0x(674, 7, 4)))) {
                    return 2;
                }
            }
        ...
        if (AbstractC10974a.A02 < 24) {
            if (A0x(331, 22, 29).equals(str) || A0x(353, 29, 9).equals(str)) {
                ...
                if (strArr2[4].length() != strArr2[3].length()) {
                    ...
                    if (!A0x(TTVideoEngineInterface.NETWORK_PREDICTOR_DEFAULT_INITIAL_SPEED, 8, 7).equals(str2)) {
                        if (!A0x(TTVideoEngineInterface.PLAYER_OPTION_ENABLE_OPTIMIZE_SEEK_CLK, 12, 76).equals(AbstractC10974a.A03)) {
                            if (!A0x(MediaPlayer.MEDIA_PLAYER_OPTION_SET_PCDN_ENABLE, 7, 39).equals(AbstractC10974a.A03)) {
                                if (!A0x(MediaPlayer.MEDIA_PLAYER_OPTION_ABR_ABI_VERSION, 7, 33).equals(AbstractC10974a.A03)) {
                                    return 0;
                                }
                            }
                        }
    ...
    private List<AR> A10(boolean z10) throws C1261Av {
        String alternativeMimeType;
        List<AR> A1l = A1l(this.A0u, this.A0i, z10);
        if (A1l.isEmpty() && z10) {
        ...
        if (A1l.isEmpty() && this.A0l && (alternativeMimeType = C1264Ay.A0P(this.A0i)) != null) {
            List<AR> A7g = this.A0u.A7g(alternativeMimeType, false, false);
            if (AbstractC10974a.A02 >= 26) {
                if (A0x(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_DIFF_LIST, 18, 102).equals(this.A0i.A0W) && !A7g.isEmpty()) {
                    return A7g;
                }
                return A1l;
            }
    ...
    private void A16(AR ar2, MediaCrypto mediaCrypto) throws Exception {
        ...
        try {
            ...
            new C2672mo().A00();
            ao2 = AV.A02().A0K(A22(), this.A11, this.A10.A00(), EnumC2384hq.A05, str);
            try {
                this.A0K = str;
                C4S.A00();
                C4S.A02(A0x(701, 14, 16));
                try {
                    A1w(ar2, ao2, this.A0i, mediaCrypto);
                    C4S.A00();
                    C4S.A02(A0x(MediaPlayer.MEDIA_PLAYER_OPTION_HTTP_REQ_FINSIH_TIME, 10, 114));
                    ao2.start();
                    C4S.A00();
    ...
    private void A17(AR ar2, AR ar3, MediaCrypto mediaCrypto) throws Exception {
        int A00 = C2397i5.A00(EnumC2395i3.A06);
        if (A00 >= 0) {
            try {
                A16(ar3, mediaCrypto);
                return;
                ...
                if (ar3 == ar2) {
                    AnonymousClass44.A07(A0x(220, 18, 67), A0x(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_SOCKET_CREATE_SUCCESS_TIME, 63, 38));
                    Thread.sleep(A00);
                    A16(ar3, mediaCrypto);
                    return;
                }
    ...
    private void A18(C1240Aa c1240Aa) {
        this.A0J = c1240Aa;
        if (c1240Aa.A02 != -9223372036854775807L) {
            this.A0a = true;
        }
    }
    ...
    private boolean A1A() throws C9Y {
        ...
        if (this.A04 == 1) {
            ...
            if (this.A0g) {
                ...
                boolean A03 = C2397i5.A03(EnumC2394i2.A10);
            ...
            if (result == -5) {
                ...
                try {
                    ...
                    C2796or c2796or = this.A0i;
                    int adaptiveReconfigurationBytes = e10.getErrorCode();
                    throw A1S(e10, c2796or, AbstractC10974a.A02(adaptiveReconfigurationBytes));
                }
                ...
                if (bufferEncrypted4 && !skipIfSampleTooLarge) {
                    AbstractC1410Gq.A0G(this.A0q.A02);
                ...
                try {
                    ...
                    C2796or c2796or2 = this.A0i;
                    int adaptiveReconfigurationBytes2 = e11.getErrorCode();
                    throw A1S(e11, c2796or2, AbstractC10974a.A02(adaptiveReconfigurationBytes2));
                }
            }
        }
    }
    ...
    */
        ...
        if (!this.A0M.isEmpty()) {
            ...
            do {
                ...
                try {
                    ...
                    AnonymousClass44.A0A(A0x(220, 18, 67), A0x(156, 30, 18) + peekFirst2, e11);
                    this.A0M.removeFirst();
                    AY ay = new AY(this.A0i, e11, z10, peekFirst2);
                    if (this.A0I == null) {
                        this.A0I = ay;
                    } else {
                        A00 = this.A0I.A00(ay);
    ...
    public static boolean A1G(C2796or c2796or) {
        return c2796or.A07 == 0 || c2796or.A07 == 2;
    }
    ...
    */
    public static boolean A1I(java.lang.String r6) {
        ...
        L34:
            ...
            r0 = 19
            if (r1 > r0) goto L96
            java.lang.String r3 = com.facebook.ads.redexgen.X.AbstractC10974a.A03
    ...
    public static boolean A1J(String str) {
        return AbstractC10974a.A02 == 21 && A0x(519, 22, 41).equals(str);
    }

    public static boolean A1K(String str) {
        if (AbstractC10974a.A02 >= 18 && (AbstractC10974a.A02 != 18 || (!A0x(MediaPlayer.MEDIA_PLAYER_OPTION_RENDER_STALL_300, 15, 68).equals(str) && !A0x(MediaPlayer.MEDIA_PLAYER_OPTION_HURRY_MILLISECOND, 22, 77).equals(str)))) {
            if (AbstractC10974a.A02 == 19 && AbstractC10974a.A06.startsWith(A0x(667, 7, 124))) {
    ...
    public static boolean A1L(String str, C2796or c2796or) {
        return AbstractC10974a.A02 < 21 && c2796or.A0X.isEmpty() && A0x(306, 25, 22).equals(str);
    }

    public static boolean A1M(String str, C2796or c2796or) {
        return AbstractC10974a.A02 <= 18 && c2796or.A06 == 1 && A0x(MediaPlayer.MEDIA_PLAYER_OPTION_SET_FFMPEG_LOG_LEVEL, 25, 33).equals(str);
    }
    ...
    private boolean A1N(boolean z10) throws C9Y {
        ...
        throw A1S(A7s, c2796or, drmSessionState);
    }
    ...
    public void A1b(boolean z10, boolean z11) throws C9Y {
        this.A0j = new C11295g();
        this.A0h = 0L;
    }

    @Override // com.facebook.ads.redexgen.X.C9Z
    public void A1c(C2796or[] c2796orArr, long j10, long j11) throws C9Y {
    }
    ...
    public void A1n() {
        ...
        if (this.A0G != null) {
            this.A0j.A03++;
            try {
                AV.A02().A0L(A22(), this.A11, this.A10.A00(), EnumC2384hq.A05, this.A0K, this.A0G);
                this.A0G = null;
                C9G c9g = this.A0E;
                String[] strArr = A14;
                if (strArr[6].length() == strArr[5].length()) {
    ...
    public final void A1p() throws C9Y {
        ...
        if (this.A0E != null) {
            ...
            if (0 == 0) {
                ...
                throw new NullPointerException(A0x(MediaPlayer.MEDIA_PLAYER_OPTION_GET_PLAYER_READ_STATE, 21, 39));
            }
        }
        try {
            if (!A1F(null, false)) {
    ...
    public void A1r(C2796or c2796or) {
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void A1s(com.facebook.ads.redexgen.X.C2796or r9) throws com.facebook.ads.redexgen.X.C9Y {
        /*
    ...
    public void A1t(C2796or c2796or) throws C9Y {
    }

    public void A1z(String str, C2796or c2796or) throws C9Y {
        A1t(c2796or);
    }
    ...
    public final boolean A24(C2796or c2796or) {
        if (c2796or == null || !this.A0m || !A0x(MediaPlayer.MEDIA_PLAYER_OPTION_RTM_TLS_HANDSHAKE_TIME, 10, 89).equalsIgnoreCase(c2796or.A0W)) {
            return false;
        }
        return true;
    }
    ...
    public boolean AAV() {
        if (this.A0i == null) {
            super.A0B = EnumC2365hX.A07;
        } else if (this.A0g) {
            super.A0B = EnumC2365hX.A0A;
        } else if (!A1d() && !A1B()) {
            super.A0B = EnumC2365hX.A06;
        }
        if (this.A0i != null) {
    ...
    public final int AJb(C2796or c2796or) throws C9Y {
        try {
            return A1h(this.A0u, this.A0t, c2796or);
        } catch (C1261Av e10) {
            throw A1S(e10, c2796or, 4002);
        }
    }
