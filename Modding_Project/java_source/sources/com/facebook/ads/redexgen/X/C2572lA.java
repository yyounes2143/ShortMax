...
public final class C2572lA extends HI {
    ...
    static {
        A01();
        A05 = new int[]{AVMDLDataLoader.KeyIsIsMaxTlsVersion, 11025, 22050, 44100};
    }

    public C2572lA(H1 h12) {
        super(h12);
    }
    ...
    public final boolean A0B(C4J c4j) throws C2568l6 {
        if (!this.A02) {
            ...
            if (this.A00 == 2) {
                ...
                throw new C2568l6(A00(0, 28, 125) + this.A00);
            }
            this.A02 = true;
        } else {
            c4j.A0g(1);
