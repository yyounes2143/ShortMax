...
public final class UP {
    ...
    public UP(SQ sq2, String str, double d10, String str2, Map<String, String> map, UU uu2, UV uv, boolean z10) {
        this.A05 = str;
        this.A00 = d10;
        this.A04 = str2;
        this.A02 = uu2;
        ...
        String A01 = AbstractC1754Uc.A01(str);
        if (!TextUtils.isEmpty(A01) && (z10 || uv == UV.A0C)) {
            hashMap.put(A00(6, 21, 46), A01);
        }
        if (A0B()) {
            Map<String, String> extraData = sq2.A04().A6o();
            hashMap.put(A00(0, 6, 111), AbstractC1818Wr.A01(extraData));
        }
