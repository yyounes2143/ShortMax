...
public abstract class XY {
    ...
    public static Bitmap A01(XX xx) {
        byte[] decode = Base64.decode(xx.A01(AbstractC1812Wl.A02), 0);
    ...
    public static Drawable A03(C2111dL c2111dL, XX xx) {
        return new BitmapDrawable(c2111dL.getResources(), A01(xx));
    }
}
