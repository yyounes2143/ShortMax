...
public final class R0 implements AudienceNetworkActivityApi, Repairable {
    ...
    public EnumC1779Vb A07;
    public InterfaceC1841Xo A08;
    public AbstractC1856Yd A09;
    public C2087cw A0A;
    public String A0B;
    public String A0C;
    public boolean A0D;
    ...
    public static void A02() {
        A0L = new byte[]{3, 56, 55, 52, 58, 51, 118, 34, 57, 118, 63, 56, 48, 51, 36, 118, 32, 63, 51, 33, 2, 47, 38, 51, 118, 48, 36, 57, 59, 118, 63, 56, 34, 51, 56, 34, 118, 57, 36, 118, 37, 55, 32, 51, 50, 31, 56, 37, 34, 55, 56, 53, 51, 5, 34, 55, 34, 51, 42, 37, 20, 42, 40, 63, 34, 61, 34, 63, 50, 122, 120, 117, 117, 124, 107, 77, 96, 105, 124, 121, 118, 115, ByteCompanionObject.MAX_VALUE, 116, 110, 78, 117, 113, ByteCompanionObject.MAX_VALUE, 116, 116, 120, 122, 57, 113, 118, 116, 114, 117, 120, 120, 124, 57, 118, 115, 100, 57, 126, 121, 99, 114, 101, 100, 99, 126, 99, 126, 118, 123, 57, 115, 126, 100, 103, 123, 118, 110, 114, 115, 110, 99, 108, 102, 113, 97, 99, 114, 103, 62, 37, 60, 60, 49, 40, 59, 44, 44, 55, 58, 59, 26, 43, 51, 46, 45, 39, 45, 46, 49, 44, 42, 44, 63, 55, 42, 7, 5, 18, 19, 18, 17, 30, 25, 18, 19, 56, 5, 30, 18, 25, 3, 22, 3, 30, 24, 25, 60, 18, 14, 79, 87, 85, 76, 125, 90, 72, 89, 78, 111, 89, 95, 83, 82, 88, 79, 122, 97, 81, 97, 124, 103, 107, 96, 122, 111, 122, 103, 97, 96, 112, 107, 108, 116, 112, 96, 76, 97, 14, 17, 29, 15, 44, 1, 8, 29};
    }
    ...
    public R0(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        this.A0I = new C1678Rc(this.A0J, this.A0E);
    ...
    private void A03(Intent intent, Bundle bundle) {
        String A01 = A01(VideoRef.VALUE_VIDEO_REF_POPULARITY_LEVEL, 8, 90);
        ...
        if (bundle != null) {
            ...
            this.A07 = (EnumC1779Vb) A03.getSerializable(A01);
            return;
        }
        this.A01 = intent.getIntExtra(A013, -1);
        this.A0B = intent.getStringExtra(A012);
        this.A07 = (EnumC1779Vb) intent.getSerializableExtra(A01);
    ...
    public final void A0D(String str, N9 n92) {
        ...
        AbstractC1856Yd abstractC1856Yd = this.A09;
        if (A0M[6].charAt(30) != 'X') {
            throw new RuntimeException();
        }
        A0M[0] = "nOOhjPgmgj4ymGbfbhDfGuv2YA";
        if (abstractC1856Yd == null) {
            this.A09 = AbstractC1857Ye.A02(this.A0J, this.A0J.A0A(), str, n92, this.A08, new C2270fw(this));
    ...
    public final void A0E(String str, C1730Td c1730Td) {
        this.A0G.A08(str, c1730Td, this.A0B);
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        if (this.A00 != configuration.orientation) {
            ...
            C1752Ua.A02(UZ.A0K, hashMap, this.A08 == null ? A01(0, 0, 15) : this.A08.getCurrentClientToken(), this.A0J.A0A());
    ...
    public final void onCreate(Bundle bundle) {
        ...
        C2111dL A04 = WB.A04(this.A05);
        if (A04 != null) {
            C2111dL startAdContext = this.A0J;
            startAdContext.A0M(A04);
        }
        A03(this.A05, bundle);
        C2111dL startAdContext2 = this.A0J;
        ...
        C2111dL startAdContext3 = this.A0J;
        US A0A = startAdContext3.A0A();
        C2111dL startAdContext4 = this.A0J;
        this.A08 = new R5(this, intent, A0A, startAdContext4).A0N(this.A07, this.A06);
        if (this.A08 == null) {
            C2111dL startAdContext5 = this.A0J;
            startAdContext5.A08().AAy(A01(58, 11, 105), AbstractC1722Sv.A0A, new C1723Sw(A01(0, 58, 116)));
            A09();
            finish(7);
            return;
        }
    ...
    public final void onPause() {
        ...
        if (this.A08 != null) {
            this.A08.AEV(false);
            if (!this.A0E.isFinishing()) {
                C1752Ua.A02(UZ.A0E, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
                this.A0D = true;
            }
        }
    }
    ...
    public final void onResume() {
        ...
        if (this.A08 != null) {
            ...
            interfaceC1841Xo.AF0(false);
            if (this.A0D) {
                C1752Ua.A02(UZ.A0F, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
            }
        }
    }
    ...
    public final void onSaveInstanceState(Bundle bundle) {
        ...
        bundle2.putSerializable(A01(VideoRef.VALUE_VIDEO_REF_POPULARITY_LEVEL, 8, 90), this.A07);
    ...
    public final void onStart() {
        ...
        if (this.A01 != -1) {
            AbstractC1835Xi.A02(this.A0E, this.A01, this.A0J);
        }
    }
