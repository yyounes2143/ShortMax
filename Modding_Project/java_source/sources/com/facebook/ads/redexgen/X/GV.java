...
public abstract class GV {
    ...
    static {
        ...
        A03 = new int[]{-1, 8000, 16000, RedeemCodeVip.REDEMPTION_MEMBER_CANNOT_CLAIM, -1, -1, 11025, 22050, 44100, -1, -1, 12000, 24000, 48000, -1, -1};
        A04 = new int[]{64, 112, 128, 192, 224, 256, MediaPlayer.MEDIA_PLAYER_OPTION_RENDER_STALL_500, FileUtils.S_IRWXU, 512, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_FRAME_DTS_CHECK, ViewUtils.EDGE_TO_EDGE_FLAGS, 896, 1024, 1152, TTVideoEngineInterface.PLAYER_OPTION_ENABLE_BOX_DEMUXER, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    }
    ...
    public static C2796or A03(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        int i10;
        C4I A042 = A04(bArr);
        A042.A09(60);
