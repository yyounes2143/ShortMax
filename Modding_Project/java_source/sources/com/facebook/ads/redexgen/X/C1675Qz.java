...
public final class C1675Qz implements AdViewApi {
    ...
    public C1675Qz(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        this.A00 = -1L;
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            ...
            NT nt2 = new NT(str, WV.A05(this.A0B), AdPlacementType.BANNER, WV.A04(adSize), 1, new C2343hB());
            nt2.A06(this.A05);
            nt2.A07(this.A06);
            this.A03 = new AnonymousClass72(this.A0A, nt2);
            this.A03.A0S(new C2264fq(this));
            return;
        }
        throw new IllegalArgumentException(A01(100, 6, 115));
    }

    public C1675Qz(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws V2 {
    ...
    public final void A0B(RelativeLayout relativeLayout, View view) {
        ...
        if (this.A06 != null && (A01 = AbstractC2086cv.A01(this.A0A, this.A06)) != null) {
    ...
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        ...
        A03(((C1758Ug) adViewLoadConfig).A00());
    }
