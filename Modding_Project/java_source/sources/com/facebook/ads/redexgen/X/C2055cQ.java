...
public final class C2055cQ extends RelativeLayout {
    public KE A00;
    ...
    public static final int A0F = (int) (AbstractC1812Wl.A02 * 16.0f);
    public static final int A0D = (int) (AbstractC1812Wl.A02 * 20.0f);
    public static final int A0E = (int) (AbstractC1812Wl.A02 * 13.0f);
    public static final int A08 = (int) (AbstractC1812Wl.A02 * 72.0f);
    public static final int A0C = (int) (AbstractC1812Wl.A02 * 8.0f);
    public static final int A0A = (int) (AbstractC1812Wl.A02 * 24.0f);
    public static final int A09 = (int) (AbstractC1812Wl.A02 * 16.0f);

    public C2055cQ(C2111dL c2111dL, N9 n92, C1570Mw c1570Mw, KE ke2, String str, View.OnClickListener onClickListener) {
        super(c2111dL);
        this.A04 = c2111dL;
        this.A03 = n92;
        this.A02 = c1570Mw;
        ...
        this.A06 = new C1931aQ(this.A04, C1572My.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC1932aR.A00(this.A04, this, this.A03.A01());
