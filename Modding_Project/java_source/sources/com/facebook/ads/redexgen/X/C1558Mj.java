...
public final class C1558Mj extends BroadcastReceiver {
    ...
    public C1558Mj(AnonymousClass64 anonymousClass64, Context context) {
        ...
        if (str3.length() == action4.length()) {
            ...
            if (str4.equals(action6)) {
                ...
                if (serializableExtra instanceof DL) {
                    ...
                    this.A01.A0h(EnumC2127db.A04, 1);
                    return;
                    ...
                    return;
                } else if (serializableExtra instanceof C10743d) {
                    if (this.A01.getListener() != null) {
