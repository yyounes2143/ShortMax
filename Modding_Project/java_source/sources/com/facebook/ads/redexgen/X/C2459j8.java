...
public class C2459j8 implements LH {
    ...
    public C2459j8(C2457j6 c2457j6) {
        this(c2457j6, UUID.randomUUID().toString());
    }

    public C2459j8(C2457j6 c2457j6, String str) {
    ...
    public final void AAw(int code, String message) {
        if (AbstractC1788Vl.A02(this) || code < 11000 || code > 11099) {
            return;
        }
        try {
            A02(code, message);
    ...
    @Override // com.facebook.ads.redexgen.X.LH
    public final void AHC(RemoteException e10) {
        if (AbstractC1788Vl.A02(this)) {
            return;
        }
        try {
    ...
    public final void AK6(int code, String message) {
        if (AbstractC1788Vl.A02(this) || code < 12000 || code > 12099) {
            return;
        }
        try {
            A02(code, message);
