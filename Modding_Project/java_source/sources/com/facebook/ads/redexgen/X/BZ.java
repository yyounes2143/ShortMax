...
public abstract class BZ implements InterfaceC2462jB<Character> {
    ...
    public static C09960b A02(final char match) {
        return new AbstractC10361p(match) { // from class: com.facebook.ads.redexgen.X.0b
