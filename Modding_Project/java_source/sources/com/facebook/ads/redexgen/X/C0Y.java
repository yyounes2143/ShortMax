...
public final class C0Y<K, V> extends AbstractC10291i<K, V>.SortedAsMap implements NavigableMap<K, Collection<V>> {
    ...
    private final Map.Entry<K, Collection<V>> A01(Iterator<Map.Entry<K, Collection<V>>> entryIterator) {
        if (entryIterator.hasNext()) {
            ...
            return AbstractC2744nz.A01(next.getKey(), this.A00.A0G(A0D));
        }
        return null;
    }
    ...
    public C0Y(final AbstractC10291i this$0, NavigableMap<K, Collection<V>> submap) {
        super(this$0, submap);
        this.A00 = this$0;
    }
