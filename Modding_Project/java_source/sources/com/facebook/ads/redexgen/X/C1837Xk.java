...
public final class C1837Xk extends LinearLayout {
    ...
    static {
        A03();
        A08 = (int) (AbstractC1812Wl.A02 * 50.0f);
        A05 = (int) (AbstractC1812Wl.A02 * 10.0f);
        A06 = (int) (AbstractC1812Wl.A02 * 20.0f);
        A09 = (int) (AbstractC1812Wl.A02 * 4.0f);
        A07 = (int) (AbstractC1812Wl.A02 * 12.0f);
    }

    public C1837Xk(C2111dL c2111dL, int i10) {
        super(c2111dL);
        this.A03 = c2111dL;
        this.A02 = O3.A00(c2111dL.A02());
        setOrientation(0);
    ...
    public void setAdDetails(N9 n92, String str, C1752Ua c1752Ua, InterfaceC1840Xn interfaceC1840Xn) {
        setOnClickListener(new View$OnClickListenerC1836Xj(this, c1752Ua, interfaceC1840Xn, str, n92));
    }
