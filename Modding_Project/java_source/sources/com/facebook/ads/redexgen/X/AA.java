...
public final class AA implements InterfaceC2848px {
    ...
    public final InterfaceC2853q2 A03;
    ...
    private final void A02(List<Rect> list) {
        ...
        Iterator<InterfaceC2854q3> it = this.A03.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public AA(View view, InterfaceC2853q2 interfaceC2853q2) {
        this.A00 = new WeakReference<>(view);
        this.A03 = interfaceC2853q2;
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC2848px
