...
public final class ID {
    ...
    */
    private long A00(com.facebook.ads.redexgen.X.InterfaceC2585lN r6) throws java.io.IOException {
        /*
            r5 = this;
    ...
    public final boolean A01(InterfaceC2585lN interfaceC2585lN) throws IOException {
        long A8G = interfaceC2585lN.A8G();
        long j10 = RealWebSocket.DEFAULT_MINIMUM_DEFLATE_SIZE;
        if (A8G != -1 && A8G <= RealWebSocket.DEFAULT_MINIMUM_DEFLATE_SIZE) {
            j10 = A8G;
        }
        int i10 = (int) j10;
        boolean z10 = false;
        interfaceC2585lN.AG9(this.A01.A0l(), 0, 4);
        ...
        while (A0Q != 440786851) {
            ...
            interfaceC2585lN.AG9(this.A01.A0l(), 0, 1);
            long j11 = A0Q << 8;
            if (A02[5].charAt(9) == 'Z') {
            ...
            strArr[2] = "OXY";
            A0Q = (j11 & (-256)) | (this.A01.A0l()[0] & AdConfig.NETWORK_LOAD_LIMIT_DISABLED);
        }
        long A00 = A00(interfaceC2585lN);
        int i12 = this.A00;
        String[] strArr2 = A02;
        if (strArr2[7].length() != strArr2[2].length()) {
            ...
            if (A00 != Long.MIN_VALUE) {
                ...
                while (this.A00 < j12 + A00) {
                    if (A00(interfaceC2585lN) == Long.MIN_VALUE) {
                        return z10;
                    }
                    long A002 = A00(interfaceC2585lN);
                    String[] strArr4 = A02;
                    ...
                    if (A002 > SieveCacheKt.NodeLinkMask) {
                        return false;
                    }
                    if (A002 != 0) {
                        int i13 = (int) A002;
                        interfaceC2585lN.A3z(i13);
                        this.A00 += i13;
                    }
                    z10 = false;
                }
