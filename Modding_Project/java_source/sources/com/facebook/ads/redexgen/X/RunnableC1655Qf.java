...
public class RunnableC1655Qf implements Runnable {
    ...
    public int A02;
    public int A03;
    public final /* synthetic */ C11556g A06;
    public Interpolator A00 = C11556g.A1A;
    ...
    public RunnableC1655Qf(C11556g c11556g) {
        this.A06 = c11556g;
        this.A01 = new OverScroller(c11556g.getContext(), C11556g.A1A);
    }
    ...
    private int A01(int i10, int i11, int i12, int i13) {
        ...
        C11556g c11556g = this.A06;
        int width = duration != 0 ? c11556g.getWidth() : c11556g.getHeight();
    ...
    public final void run() {
        ...
        this.A06.A1K();
        OverScroller overScroller = this.A01;
        AbstractC1651Qb abstractC1651Qb = this.A06.A06.A02;
        if (overScroller.computeScrollOffset()) {
            ...
            if (this.A06.A04 != null) {
                ...
                if (vresult != 0) {
                    QO qo2 = this.A06.A06;
                    QW qw = this.A06.A0r;
                    C11556g c11556g2 = this.A06;
                    if (A08[4].charAt(19) != '9') {
                        A08[4] = "aF9lT9JucYAVgVWisB0rNkK4be7J2iGb";
                        i10 = qo2.A1f(vresult, qw, c11556g2.A0s);
                        i12 = vresult - i10;
                    } else {
                        i10 = qo2.A1f(vresult, qw, c11556g2.A0s);
                        i12 = vresult - i10;
                ...
                if (velX != 0) {
                    ...
                    if (A08[4].charAt(19) != 57) {
                        ...
                        i11 = qo3.A1g(velX, qw2, this.A06.A0s);
                        i13 = velX - i11;
                    } else {
                        i11 = qo3.A1g(velX, qw2, this.A06.A0s);
                        i13 = velX - i11;
                ...
                this.A06.A1N();
                this.A06.A1p(false);
                if (abstractC1651Qb != null && !abstractC1651Qb.A0E() && abstractC1651Qb.A0F()) {
                    int x10 = this.A06.A0s.A03();
                    if (x10 == 0) {
                        abstractC1651Qb.A09();
                    } else if (abstractC1651Qb.A07() >= x10) {
                        abstractC1651Qb.A0A(x10 - 1);
                        abstractC1651Qb.A04(vresult - i12, velX - i13);
                    } else {
                        int y10 = vresult - i12;
                        if (A08[4].charAt(19) != 57) {
                            String[] strArr4 = A08;
                            ...
                            abstractC1651Qb.A04(y10, velX - i13);
                        } else {
                            abstractC1651Qb.A04(y10, velX - i13);
                        }
                    }
            ...
            if (i10 != 0 || i11 != 0) {
                C11556g c11556g4 = this.A06;
                if (A08[6].length() != 25) {
                    A08[3] = "MhQkdHLAPY6K0mrvY0I8ZqPtgRA1J8Gx";
                    c11556g4.A1d(i10, i11);
                } else {
        ...
        if (abstractC1651Qb != null) {
            if (abstractC1651Qb.A0E()) {
                abstractC1651Qb.A04(0, 0);
            }
            if (!this.A05) {
                abstractC1651Qb.A09();
            }
