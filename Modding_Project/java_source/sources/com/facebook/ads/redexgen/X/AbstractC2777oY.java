...
public abstract class AbstractC2777oY {
    public static <K, V> Map<K, V> A00(int expectedSize) {
        return C2618lv.A0B(expectedSize);
    }
    ...
    public static <T> T[] A02(Object[] source, int from, int to2, T[] arrayOfType) {
        return (T[]) Arrays.copyOfRange(source, from, to2, arrayOfType.getClass());
    }
}
