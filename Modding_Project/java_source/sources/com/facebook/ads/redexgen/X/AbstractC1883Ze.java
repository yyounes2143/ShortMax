...
public abstract class AbstractC1883Ze extends WebView {
    ...
    static {
        A0C();
        A02 = AbstractC1883Ze.class.getSimpleName();
    }

    public AbstractC1883Ze(Activity activity, C2111dL c2111dL) {
        super(activity);
        A0E(c2111dL);
    }

    public AbstractC1883Ze(C2111dL c2111dL) {
        super(c2111dL);
        A0E(c2111dL);
    }
    ...
    public static void A0D(int i10) {
        ...
        if (context != null) {
            context.A08().AAy(A0B(56, 8, 37), i10, new C1723Sw(A0B(35, 10, 3)));
        }
    }
