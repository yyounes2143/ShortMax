...
public class C2614lr<K, V> extends AbstractSet<Map.Entry<K, V>> {
    ...
    public C2614lr(final C2618lv this$0) {
        this.A00 = this$0;
    }
    ...
    public final boolean remove(@CheckForNull Object o10) {
        ...
        if (o10 instanceof Map.Entry) {
            ...
            A0V = this.A00.A0V();
            A0W = this.A00.A0W();
            int A06 = AbstractC2621ly.A06(key, value, A00, A0C, A0T, A0V, A0W);
            if (A06 == -1) {
                return false;
            }
