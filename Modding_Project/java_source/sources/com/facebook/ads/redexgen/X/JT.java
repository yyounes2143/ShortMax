...
public final class JT {
    ...
    public void A00(C4J c4j, int i10) {
        ...
        int i11 = i10 - 4;
        if ((c4j.A0I() & 128) != 0) {
            if (i11 < 7 || (totalLength = c4j.A0K()) < 4) {
                return;
            }
            this.A01 = c4j.A0M();
            this.A00 = c4j.A0M();
    ...
    public void A02(C4J c4j, int i10) {
        ...
        for (int index = 0; index < i11; index++) {
            ...
            this.A08[A0I] = entryCount2 | (AbstractC10974a.A07(i12, 0, 255) << 16) | (AbstractC10974a.A07(g10, 0, 255) << 8) | AbstractC10974a.A07((int) (a10 + ((A0I3 - 128) * 1.772d)), 0, 255);
        }
        this.A06 = true;
    }

    public final C2747o2 A06() {
        int A0I;
