...
public final class C7L<NativeViewabilityLogger> implements InterfaceC2431id {
    ...
    public US A05;
    public V4 A06;
    public InterfaceC1886Zh A08;
    public C1505Ki A09;
    public C5G A0A;
    public AbstractC2183eW A0B;
    public C2184eX A0C;
    public String A0E;
    ...
    public void A0C(int i10, TF tf2) {
        C2427iZ c2427iZ = new C2427iZ(this);
        this.A0A = new C5G(this.A04, this.A05, c2427iZ, this.A03, A08(0, 31, 79), 2, this.A07);
        this.A0B = new C2422iU(this);
        this.A0C = new C2184eX(this.A0A, tf2.A04(), tf2.A09(), true, new WeakReference(this.A0B), this.A04);
    ...
    private void A0F(TF tf2, JSONObject jSONObject, V4 v42) {
        this.A0G = false;
        final C2408iG A00 = C2408iG.A00(this.A04, jSONObject);
        this.A0E = A00.A7G();
        ...
        this.A08 = new AbstractC1516Kt() { // from class: com.facebook.ads.redexgen.X.7M
            ...
            public final void ACj(String str, Map<String, String> map) {
                ...
                MH adAction = MI.A00(c6m2, us2, A7G, A002, map, A21);
                ME me2 = ME.A09;
                if (adAction != null) {
                    try {
                        c6m3 = C7L.this.A04;
            ...
            public final void ADW() {
                ...
                c2406iE = C7L.this.A02;
                A0F.A4I(c2406iE != null);
                c2406iE2 = C7L.this.A02;
                if (c2406iE2 != null) {
                    c2406iE3 = C7L.this.A02;
                    c2406iE3.A03();
                }
            }
        ...
        this.A09 = new C1505Ki(this.A04, new WeakReference(this.A08), tf2.A04(), A7G());
        this.A09.A0L(tf2.A07(), tf2.A08());
        MS impressionHelper = new C2421iT(this);
        this.A02 = new C2406iE(this.A04, this.A05, this.A09, this.A09.getViewabilityChecker(), impressionHelper, v42);
        this.A02.A0A(A00);
        this.A09.loadDataWithBaseURL(AbstractC1889Zk.A01(AdInternalSettings.getUrlPrefix()), A00.A04(), A08(31, 9, 19), A08(40, 5, 12), null);
        this.A0F = true;
        A0A();
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x005d, code lost:
        if (com.facebook.ads.redexgen.X.C1681Rf.A0A(r10.A03.A1C()) == false) goto L20;
     */
    ...
    */
    private void A0G(com.facebook.ads.redexgen.X.V4 r11, com.facebook.ads.redexgen.X.TF r12) {
        ...
        L53:
            ...
            boolean r0 = com.facebook.ads.redexgen.X.C1681Rf.A0A(r0)
            if (r0 == 0) goto L7c
            r0 = 1
        L60:
            if (r0 != 0) goto L7e
