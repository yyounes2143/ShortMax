...
public final class ZH extends LinearLayout {
    ...
    static {
        ...
        A0F = (int) (AbstractC1812Wl.A02 * 16.0f);
        A0I = WQ.A00(A06(90, 23, 118));
        A0J = new ZB();
    }

    public ZH(C2111dL c2111dL, WebView webView, boolean z10) {
        super(c2111dL);
        this.A07 = getResources().getDisplayMetrics().density;
        this.A0A = new LR(this);
        this.A08 = webView;
        this.A09 = c2111dL;
        this.A0B = U8.A06(c2111dL);
        this.A0C = z10;
        A08();
        A0C(false);
    }
    ...
    private void A08() {
        ...
        if (this.A0B && !U7.A2o(this.A09)) {
            ...
            LinearLayout.LayoutParams titleViewsParams = new LinearLayout.LayoutParams(i10, i10);
