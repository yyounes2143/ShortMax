...
public abstract class AbstractC2764oJ {
     ...
     */
    public static boolean A01(@CheckForNull InterfaceC2759oE<?, ?> multimap, Object object) {
        if (object == multimap) {
            return true;
        }
        if (object instanceof InterfaceC2759oE) {
            return multimap.A49().equals(((InterfaceC2759oE) object).A49());
        }
        return false;
    }
    ...
    public static <K, V> InterfaceC1247Ah<K, V> A00(final Map<K, Collection<V>> map, final InterfaceC2472jM<? extends List<V>> factory) {
        return new C0Z<K, V>(map, factory) { // from class: com.facebook.ads.redexgen.X.0H
            public static final long serialVersionUID = 0;
            public transient InterfaceC2472jM<? extends List<V>> A00;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jM != com.google.common.base.Supplier<? extends java.util.List<V>> */
            {
                this.A00 = (InterfaceC2472jM) AbstractC2461jA.A04(factory);
            }
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.0H != com.google.common.collect.Multimaps$CustomListMultimap<K, V> */
            @Override // com.facebook.ads.redexgen.X.AbstractC10291i
            /* renamed from: A0M */
            ...
            private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
                ...
                this.A00 = (InterfaceC2472jM) Objects.requireNonNull(stream.readObject());
