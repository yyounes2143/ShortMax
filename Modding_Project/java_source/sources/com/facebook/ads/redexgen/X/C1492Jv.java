...
public final class C1492Jv {
    ...
    public static void A0A(C4J c4j, C1496Jz c1496Jz, StringBuilder sb2) {
        A09(c4j);
        String A032 = A03(c4j, sb2);
        String A01 = A01(0, 0, 111);
        if (A01.equals(A032)) {
        ...
        if (property.length() != 9) {
            ...
            if (property7.equals(A032)) {
                ...
                String property9 = A01(VideoRef.VALUE_VIDEO_REF_PALLAS_VID_LABELS, 5, 113);
    ...
    private void A0B(C1496Jz c1496Jz, String str) {
        ...
        if (indexOf != -1) {
            ...
            if (matcher.matches()) {
                c1496Jz.A0N((String) C3M.A01(matcher.group(1)));
            }
            str = str.substring(0, indexOf);
        }
        String[] A1O = AbstractC10974a.A1O(str, A01(47, 2, 9));
        String str2 = A1O[0];
        int indexOf2 = str2.indexOf(35);
        if (indexOf2 != -1) {
            c1496Jz.A0M(str2.substring(0, indexOf2));
            int voiceStartIndex = indexOf2 + 1;
            c1496Jz.A0L(str2.substring(voiceStartIndex));
        } else {
            c1496Jz.A0M(str2);
        }
        ...
        if (voiceStartIndex2 > 1) {
            ...
            c1496Jz.A0O((String[]) AbstractC10974a.A1J(A1O, 1, voiceStartIndex3));
        }
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public static void A0C(String str, C1496Jz c1496Jz) {
        char c10;
        Matcher matcher = A04.matcher(AbstractC2426iY.A01(str));
        if (!matcher.matches()) {
        ...
        c1496Jz.A0A(Float.parseFloat((String) C3M.A01(matcher.group(1))));
    }
    ...
    public final List<C1496Jz> A0F(C4J c4j) {
        String selector;
        ...
        while (true) {
            ...
            C1496Jz c1496Jz = new C1496Jz();
            A0B(c1496Jz, selector2);
            String str = null;
            boolean z10 = false;
            while (true) {
                ...
                if (!z10) {
                    this.A00.A0f(A092);
                    A0A(this.A00, c1496Jz, this.A01);
                }
            }
            if (selector.equals(str)) {
                arrayList.add(c1496Jz);
            }
        }
    }
}
