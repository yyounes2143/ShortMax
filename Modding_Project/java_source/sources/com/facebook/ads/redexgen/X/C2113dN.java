...
public final class C2113dN extends LinearLayout {
    public static final int A00 = (int) (AbstractC1812Wl.A02 * 32.0f);
    public static final int A01 = (int) (AbstractC1812Wl.A02 * 8.0f);

    public C2113dN(C2111dL c2111dL, NativeAd nativeAd, C1769Ur c1769Ur, C1925aK c1925aK, AdOptionsView adOptionsView) {
        super(c2111dL);
        setOrientation(0);
        ...
        addView(c1925aK, iconViewParams);
        TextView textView = new TextView(c2111dL);
        c1769Ur.A08(textView);
        textView.setMaxLines(1);
        textView.setText(nativeAd.getAdvertiserName());
        TextView sponsoredTextView = new TextView(c2111dL);
        c1769Ur.A06(sponsoredTextView);
