...
public final class C2506ju implements KJ {
    ...
    public C2506ju(boolean z10) {
        this(z10, null);
    }

    public C2506ju(boolean z10, String str) {
    ...
    private void A02() throws C10532i {
        this.A0H.A08(0);
        if (!this.A0G) {
            ...
            C2796or A14 = A0b.A0m(audioObjectType3).A12(Collections.singletonList(A07)).A10(this.A0J).A14();
    ...
    private void A0B(C4J c4j) {
        ...
        while (A09 < A0A) {
            int endOffset = A09 + 1;
            int i10 = A0l[A09] & AdConfig.NETWORK_LOAD_LIMIT_DISABLED;
            ...
            switch (this.A04 | i10) {
                ...
                case 511:
                    this.A04 = 512;
                    break;
                case MediaPlayer.MEDIA_PLAYER_OPTION_RTM_DNS_TIME /* 836 */:
                    this.A04 = 1024;
                    break;
                case MediaPlayer.MEDIA_PLAYER_OPTION_THREADNAME_TWO_CHAR_PAD /* 1075 */:
                    A08();
                    c4j.A0f(endOffset);
                    return;
                default:
    ...
    private boolean A0G(C4J c4j, int i10) {
        c4j.A0f(i10 + 1);
    ...
    private boolean A0H(C4J c4j, byte[] bArr, int i10) {
        int min = Math.min(c4j.A07(), i10 - this.A00);
        int bytesToRead = this.A00;
    ...
    public final void A52(C4J c4j) throws C10532i {
        A01();
        while (c4j.A07() > 0) {
            switch (this.A06) {
                case 0:
    ...
    public final void A5U(GY gy, C1501Ke c1501Ke) {
        c1501Ke.A05();
        this.A0D = c1501Ke.A04();
        this.A0C = gy.AJh(c1501Ke.A03(), 1);
        this.A0A = this.A0C;
        if (this.A0K) {
            c1501Ke.A05();
            this.A0B = gy.AJh(c1501Ke.A03(), 5);
            this.A0B.A6W(new C2D().A0y(c1501Ke.A04()).A11(A00(60, 15, 103)).A14());
            return;
        }
        this.A0B = new C2586lO();
    }
