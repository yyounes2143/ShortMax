...
public final class C1465Iu {
    ...
    public int A01;
    public boolean A02;
    public final C1466Iv A04 = new C1466Iv();
    public final C4J A03 = new C4J(new byte[OggPageHeader.MAX_PAGE_PAYLOAD], 0);
    public int A00 = -1;
    ...
    */
    private int A00(int r5) {
        ...
        L1f:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1465Iu.A00(int):int");
    }
    ...
    public final void A04() {
        ...
        this.A03.A0j(Arrays.copyOf(this.A03.A0l(), Math.max((int) OggPageHeader.MAX_PAGE_PAYLOAD, this.A03.A0A())), this.A03.A0A());
    }

    public final boolean A05(InterfaceC2585lN interfaceC2585lN) throws IOException {
        C3M.A08(interfaceC2585lN != null);
        if (this.A02) {
            this.A02 = false;
            this.A03.A0d(0);
        }
        while (!this.A02) {
            ...
            if (A05[2].length() == 22) {
                ...
                if (i10 < 0) {
                    if (!this.A04.A03(interfaceC2585lN) || !this.A04.A05(interfaceC2585lN, true)) {
                        return false;
                    }
                    int bytesToSkip = 0;
                    ...
                    if (!GZ.A02(interfaceC2585lN, i11)) {
                        return false;
                    }
                ...
                if (strArr4[4].charAt(26) != strArr4[5].charAt(26)) {
                    ...
                    if (A00 > 0) {
                        ...
                        if (!GZ.A03(interfaceC2585lN, this.A03.A0l(), this.A03.A0A(), A00)) {
                            return false;
                        }
