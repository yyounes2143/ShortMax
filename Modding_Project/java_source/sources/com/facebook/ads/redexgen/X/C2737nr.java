...
public final class C2737nr implements C3T {
    @Override // com.facebook.ads.redexgen.X.C3T
    public final C2735np A5H(Looper looper, Handler.Callback callback) {
        return new C2735np(new Handler(looper, callback));
    }
