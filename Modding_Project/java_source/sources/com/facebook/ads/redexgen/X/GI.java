...
public abstract class GI {
    ...
    public static GH A04(C4I c4i) {
        ...
        if (A01[5].length() != 0) {
            ...
            return new GH(A043, 2, i12, i11, i13);
        }
        throw new RuntimeException();
    }
    ...
    static {
        A06();
        A02 = new int[]{2002, 2000, 1920, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SUBTITLE_SENSE_BUFFERING, 1600, 1001, 1000, 960, 800, 800, 480, 400, 400, 2048};
    }
    ...
    public static C2796or A03(C4J c4j, String str, String str2, DrmInitData drmInitData) {
        c4j.A0g(1);
