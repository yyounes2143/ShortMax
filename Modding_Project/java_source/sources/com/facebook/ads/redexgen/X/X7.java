...
public abstract class X7 {
    ...
    public static void A07() {
        A00 = new byte[]{13, 121, 86, 14, 68, 81, 121, 86, 14, 126, 68, 8, 95, 11, 120, 14, 12, 126, 100, 8, ByteCompanionObject.MAX_VALUE, 120, 11, 15, 125, 75, 76, 76, 91, 80, 74, 30, 77, 74, 95, 93, 85, 30, 74, 76, 95, 93, 91, 77, 65, 67, 0, 72, 79, 77, 75, 76, 65, 65, 69, 0, 79, 74, 93};
    }
    ...
    public static String A03(Context context, Throwable th2) {
        ...
        return A06(th2, A0M, maxStacktraceLines, U7.A1c(context));
    }
    ...
    public static String A06(Throwable th2, int i10, int i11, boolean z10) {
        ...
        try {
            ...
            if (strArr[4].length() != strArr[6].length()) {
                ...
                if (i11 >= 0) {
                    x52 = new C1619Ov(x52, i11);
                }
                if (i10 >= 0) {
                    x52 = new C1618Ou(x52, i10, i10);
                }
                if (z10) {
                    x52 = new C1620Ow(x52);
                }
                C1622Oy c1622Oy = new C1622Oy(c1621Ox, 1, x52);
                th2.printStackTrace(new PrintWriter(new X6(c1622Oy)));
                c1622Oy.flush();
                return c1621Ox.toString();
            }
