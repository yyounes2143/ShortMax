...
public final class VU {
    ...
    public VU(C2111dL c2111dL) {
        this(c2111dL, O3.A00(c2111dL.A02()));
    }

    public VU(C2111dL c2111dL, O2 o22) {
        this.A01 = -1L;
        this.A00 = -1L;
        this.A05 = c2111dL;
        this.A06 = VV.A00();
        this.A07 = VZ.A01(c2111dL);
        this.A04 = o22;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public C1628Pe A03(long j10, VR vr2) {
        return new C1628Pe(this, vr2, j10);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0A() {
        if (this.A05 == null || !C2208ev.A0A(this.A05)) {
            return;
        }
        C1723Sw c1723Sw = new C1723Sw(A06(8, 5, 102));
        c1723Sw.A05(1);
        this.A05.A08().AAy(A06(86, 7, 32), AbstractC1722Sv.A1x, c1723Sw);
    }
    ...
    private void A0C(int i10, String str) {
        ...
        VF.A04(A063, String.format(Locale.US, A06(53, 26, 82), Integer.valueOf(i10), str));
    }
    ...
    public void A0N(String str, long j10, VR vr2) {
        ...
        try {
            VX A07 = this.A06.A07(this.A05, str, j10);
            TE A00 = A07.A00();
            if (A00 != null) {
                ...
                VQ.A05(A00.A05().A0B(), vr2);
                C1830Xd.A01(this.A05, A0B, A00);
                C1723Sw c1723Sw = new C1723Sw(A06(30, 7, 0) + C1813Wm.A02());
                c1723Sw.A06(1);
                c1723Sw.A0A(false);
                this.A05.A08().ABZ(A06(79, 7, 63), AbstractC1722Sv.A1W, c1723Sw);
            }
            switch (A07.A01()) {
                case A02:
                    PW pw = (PW) A07;
            ...
            C2111dL c2111dL = this.A05;
            if (A09[0].length() == 29) {
                throw new RuntimeException();
            }
            A09[0] = "STn1t4NLUPoQ";
            c2111dL.A0F().A3O(XG.A01(this.A01), adErrorType2.getErrorCode(), message, adErrorType2.isPublicError());
    ...
    public void A0O(String str, long j10, VR vr2) {
        A0B.execute(new C1629Pf(this, str, j10, vr2));
    }

    private boolean A0P(VR vr2) {
        String adPlacementType = vr2.A06().toString();
        ...
        if (A0A2 >= storedAdsCount || A0A2 > A092) {
            ...
            if (A0B2 != null) {
                ...
                if (obj != null && A0B2.first != null) {
                    A0O(A0B2.second.toString(), 0L, vr2);
                    return true;
                }
            }
        }
    ...
    public final void A0Q(VR vr2) {
        ...
        if (VQ.A08(vr2)) {
            XU.A06.execute(new C1631Ph(this));
            String A02 = VQ.A02(vr2);
            if (A02 != null) {
                this.A05.A0F().AJv();
                A0O(A02, 0L, vr2);
                return;
        ...
        A0B.execute(new C1630Pg(this, vr2));
    }
