...
public class BE<V> extends AbstractC10291i<K, V>.WrappedCollection implements List<V> {
    ...
    public final boolean addAll(int index, Collection<? extends V> c10) {
        ...
        if (addAll) {
            AbstractC10291i.A02(this.A00, A02().size() - size);
            if (size == 0) {
                A03();
            }
        }
    ...
    public BE(@ParametricNullness final AbstractC10291i this$0, @CheckForNull Object key, List delegate, C2529kH ancestor) {
