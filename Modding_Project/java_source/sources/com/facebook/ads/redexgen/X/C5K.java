...
public final class C5K extends FrameLayout implements InterfaceC1841Xo, I3 {
    ...
    public final US A08;
    public final C1752Ua A09;
    public final XC A0A;
    public final XH A0B;
    public final InterfaceC1840Xn A0C;
    public final YY A0D;
    public final C2014bl A0E;
    public final C2022bt A0F;
    public final AbstractC2183eW A0G;
    public final C2184eX A0H;
    ...
    public C5K(C2111dL c2111dL, US us2, InterfaceC1840Xn interfaceC1840Xn, AbstractC2392hy abstractC2392hy, YY yy, int i10) {
        super(c2111dL);
        this.A01 = new C1453Ii(this);
        this.A0G = new C1452Ih(this);
        this.A03 = true;
        this.A07 = c2111dL;
        this.A08 = us2;
        ...
        this.A0D = yy;
        C2022bt A02 = AbstractC2023bu.A02(abstractC2392hy.A17());
        if (A02 == null) {
            this.A0F = new C2022bt(this.A07, abstractC2392hy, us2, i10);
            this.A04 = false;
        } else {
            this.A0F = A02;
            this.A04 = true;
        ...
        this.A0F.A0c(new C1448Id(this));
        XP.A0E(1003, this.A0F.A0O());
        if (this.A06.A1P()) {
            this.A0E = new C2014bl(this.A07, this.A08, this.A06, new SF(this.A07), this.A09, this.A0C, this.A0D, new C1446Ib(this));
            this.A0E.A0N();
            this.A0F.A0O().setOnTouchListener(new View$OnTouchListenerC2010bh(this));
            addView(this.A0E, new FrameLayout.LayoutParams(-1, -1));
        } else {
            this.A0E = null;
        }
        ViewGroup mediaView = getMediaView();
        this.A0H = new C2184eX(mediaView, 1, new WeakReference(this.A0G), this.A07);
        ...
        if (U7.A1u(c2111dL)) {
            c2111dL.A0B().AK4(mediaView, abstractC2392hy.A25(), false, false, true);
        }
        try {
            JSONObject jSONObject = new JSONObject();
            boolean A2C = abstractC2392hy.A2C();
            ...
            } else if (WR.A05(abstractC2392hy.A0u())) {
                jSONObject.put(A0B4, true);
                jSONObject.put(A0B3, 2);
            ...
            this.A0F.A0M().A04(AbstractC1722Sv.A15, A0B(0, 26, 113));
        }
    }

    private void A0C() {
        C2062cX A0F = new C2060cV(this.A07, this.A06.A20().A0I(), this.A06.A23()).A0A(this.A06.A1z().A01()).A0F();
    ...
    private void A0F(String str) {
        ...
        C1910a5 c1910a5 = new C1910a5(this.A07, this.A0D.A7E(), this.A0H, this.A0B, this.A08, this.A06.A21(), this.A0C);
        HashMap hashMap = new HashMap();
        hashMap.put(A0B(86, 12, 108), A0B(98, 9, 19));
        c1910a5.A05(this.A06.A25(), str, hashMap);
    }
    ...
    public final void A9c() {
        ...
        C2108dI serverSideRewardHandler = new C2108dI(this.A07, this.A0D, this.A06.A1A(), this.A0C);
        serverSideRewardHandler.A05();
    }

    @Override // com.facebook.ads.redexgen.X.I3
    public final void AAd() {
        new Handler(Looper.getMainLooper()).post(new C1445Ia(this));
    }
    ...
    public final void onDestroy() {
        ...
        this.A0A.A03();
        this.A08.AAt(this.A06.A25(), new C1894Zp().A02(this.A0B).A03(this.A0H).A05());
        this.A01 = null;
        this.A02 = null;
        this.A00 = null;
        AbstractC2023bu.A04(this.A06.A17());
        C2022bt.A0B().decrementAndGet();
    }
    ...
    public void setRtfActionsJavascriptListener(InterfaceC2029c0 interfaceC2029c0) {
        this.A02 = interfaceC2029c0;
    }
}
