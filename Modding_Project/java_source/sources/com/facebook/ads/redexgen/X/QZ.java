...
public class QZ {
    ...
    public final void A05(C11556g c11556g) {
        if (this.A04 >= 0) {
            int i10 = this.A04;
            this.A04 = -1;
            c11556g.A1U(i10);
            ...
            if (interpolator == null) {
                if (this.A01 == Integer.MIN_VALUE) {
                    c11556g.A08.A0A(this.A02, this.A03);
                } else {
                    RunnableC1655Qf runnableC1655Qf = c11556g.A08;
                    int i11 = this.A02;
                    int i12 = this.A03;
                    if (A08[1].length() != 25) {
                        runnableC1655Qf.A0B(i11, i12, this.A01);
                    } else {
                        String[] strArr2 = A08;
                ...
                c11556g.A08.A0C(this.A02, this.A03, this.A01, this.A05);
            }
            this.A00++;
            if (this.A00 > 10) {
