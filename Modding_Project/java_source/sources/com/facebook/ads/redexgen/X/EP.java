...
public final class EP extends FrameLayout implements InterfaceC2112dM {
    public TextView A00;
    public TextView A01;
    public TextView A02;
    public TextView A03;
    ...
    public static final int A0E = (int) (AbstractC1812Wl.A02 * 6.0f);
    public static final int A0D = (int) (AbstractC1812Wl.A02 * 8.0f);
    public static final int A0C = (int) (AbstractC1812Wl.A02 * 12.0f);
    public static final int A0A = (int) (AbstractC1812Wl.A02 * 350.0f);
    public static final int A09 = (int) (AbstractC1812Wl.A02 * 250.0f);
    public static final int A0B = (int) (AbstractC1812Wl.A02 * 175.0f);

    public EP(C2111dL c2111dL, NativeAd nativeAd, C1769Ur c1769Ur, EnumC1770Us enumC1770Us, C1925aK c1925aK, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c2111dL);
        this.A07 = new ArrayList<>();
        this.A05 = nativeAd;
        this.A04 = mediaView;
        this.A06 = new C2113dN(c2111dL, this.A05, c1769Ur, c1925aK, adOptionsView);
        this.A06.setPadding(A0C, A0C, A0C, A0E);
        addView(this.A06, new FrameLayout.LayoutParams(-1, -2));
        if (enumC1770Us == EnumC1770Us.A09 || enumC1770Us == EnumC1770Us.A0B) {
            A07(c1769Ur);
        }
        addView(this.A04, new FrameLayout.LayoutParams(-1, -2));
        if (enumC1770Us != EnumC1770Us.A0B || this.A05.getAdCreativeType() != NativeAd.AdCreativeType.CAROUSEL) {
            A06(c1769Ur);
            A04(c1769Ur);
            A05(c1769Ur);
        }
        this.A07.add(c1925aK);
    ...
    */
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        C2113dN c2113dN = this.A06;
        int top = this.A06.getMeasuredHeight();
        c2113dN.layout(i10, i11, i12, top + i11);
    ...
    */
    public final void onMeasure(int r7, int r8) {
        ...
        L5e:
            ...
            com.facebook.ads.redexgen.X.fh r0 = (com.facebook.ads.redexgen.X.C2255fh) r0
            boolean r0 = r0.A0N()
            if (r0 == 0) goto L6e
            r3 = r4
            goto L22
