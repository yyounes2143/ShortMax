...
public final class AnonymousClass17 extends AbstractC12259l {
    ...
    public static void A02() {
        byte[] bArr = {99, 108, 105, 96, 86, 119, 102, 87, 96, 100, 97, 74, 117, 96, 107, 111, 96, 101, 108, 90, 123, 106, 91, 108, 104, 109, 91, 72, 79, 47, 36, 35, 56, 113, 57, 48, 34, 113, 32, 36, 52, 35, 40, 113, 48, 63, 53, 126, 62, 35, 113, 55, 35, 48, 54, 60, 52, 63, 37, 125, 113, 38, 57, 56, 50, 57, 113, 48, 35, 52, 113, 63, 62, 37, 113, 34, 36, 33, 33, 62, 35, 37, 52, 53, ByteCompanionObject.MAX_VALUE, 113, 21, 56, 53, 113, 40, 62, 36, 113, 50, 48, 61, 61, 113, 4, 35, 56, ByteCompanionObject.MAX_VALUE, 33, 48, 35, 34, 52, 121, 120, 113, 62, 63, 113, 48, 113, 34, 37, 35, 56, 63, 54, 113, 50, 62, 63, 37, 48, 56, 63, 56, 63, 54, 113, 118, 110, 118, 113, 62, 35, 113, 118, 114, 118, 110, 113, 4, 34, 52, 113, 4, 35, 56, ByteCompanionObject.MAX_VALUE, 55, 35, 62, 60, 23, 56, 61, 52, 121, 63, 52, 38, 113, 23, 56, 61, 52, 121, 33, 48, 37, 57, 120, 120, 113, 37, 62, 113, 48, 39, 62, 56, 53, 113, 37, 57, 56, 34, ByteCompanionObject.MAX_VALUE, 113, 33, 48, 37, 57, 108, 116, 34, 125, 32, 36, 52, 35, 40, 108, 116, 34, 125, 55, 35, 48, 54, 60, 52, 63, 37, 108, 116, 34};
        String[] strArr = A05;
    ...
    public final long AFy(AnonymousClass56 anonymousClass56) throws C2725nf {
        C4S.A02(A01(0, 15, 71));
        ...
        try {
            try {
                ...
                throw new C2725nf(null, null, 2008);
            } catch (IOException e10) {
                throw new C2725nf(e10, 2000);
            }
        } catch (Throwable th2) {
            C4S.A00();
            throw th2;
    ...
    */
    public static java.io.RandomAccessFile A00(android.net.Uri r6) throws com.facebook.ads.redexgen.X.C2725nf {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void close() throws com.facebook.ads.redexgen.X.C2725nf {
        /*
            r6 = this;
            r4 = 0
            r6.A01 = r4
    ...
    @MetaExoPlayerCustomization("FB tracing added in D4783963 for calls to TraceUtil.beginSection and TraceUtil.endSection")
    public final int read(byte[] bArr, int i10, int i11) throws C2725nf {
        if (i11 == 0) {
            return 0;
        }
        try {
            ...
            try {
                ...
                int read = ((RandomAccessFile) AbstractC10974a.A0f(this.A02)).read(bArr, i10, (int) Math.min(this.A00, i11));
                if (read > 0) {
                    this.A00 -= read;
                    A0F(read);
                }
