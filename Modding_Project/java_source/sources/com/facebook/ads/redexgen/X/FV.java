...
public final class FV {
    ...
    public static FT A01(Context context) {
        C2593lW c2593lW = null;
        if (context == null) {
            return null;
        }
        Context applicationContext = context.getApplicationContext();
        if (AbstractC10974a.A02 >= 17) {
            c2593lW = C2593lW.A01(applicationContext);
        }
        if (c2593lW == null) {
            return C2594lX.A00(applicationContext);
        }
        return c2593lW;
    }

    private void A03() {
        if (AbstractC10974a.A02 < 30 || this.A0C == null || this.A04 == Integer.MIN_VALUE || this.A03 == 0.0f) {
            return;
        }
        this.A03 = 0.0f;
    ...
    */
    ...
    private void A09(boolean z10) {
        if (AbstractC10974a.A02 < 30 || this.A0C == null || this.A04 == Integer.MIN_VALUE) {
            return;
        }
        float f10 = 0.0f;
