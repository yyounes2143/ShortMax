...
public abstract class TO {
    ...
    public static String A01(C2085cu c2085cu) {
        return AbstractC1781Ve.A00(c2085cu).getString(A00(0, 14, 37), null);
    }

    public static Map<String, String> A02(C2085cu c2085cu) {
        String sdkCache = AbstractC1781Ve.A00(c2085cu).getString(A00(14, 22, 76), null);
        if (sdkCache == null) {
            return null;
        }
        try {
            ...
            if (!hashSet.isEmpty()) {
                ...
                A06(c2085cu, jSONObject);
            }
            return hashMap;
        } catch (JSONException e10) {
            c2085cu.A08().AAy(A00(36, 5, 38), AbstractC1722Sv.A2U, new C1723Sw(e10));
            return null;
        }
    }

    public static void A04(C2085cu c2085cu, String str) {
        AbstractC1781Ve.A00(c2085cu).edit().putString(A00(0, 14, 37), str).apply();
    }

    public static void A05(C2085cu c2085cu, String str) {
        if (str == null) {
            return;
        }
        String sdkCache = AbstractC1781Ve.A00(c2085cu).getString(A00(14, 22, 76), null);
        try {
            ...
            c2085cu.A08().AAy(A00(36, 5, 38), AbstractC1722Sv.A2V, new C1723Sw(e10));
        }
    }

    public static void A06(C2085cu c2085cu, JSONObject jSONObject) {
        AbstractC1781Ve.A00(c2085cu).edit().putString(A00(14, 22, 76), jSONObject.toString()).apply();
    }
}
