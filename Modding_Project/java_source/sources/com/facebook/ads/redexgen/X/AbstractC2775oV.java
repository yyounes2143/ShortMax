...
public abstract class AbstractC2775oV<T> implements Comparator<T> {
    @Override // java.util.Comparator
    public abstract int compare(@ParametricNullness T left, @ParametricNullness T right);

    public static <C extends Comparable> AbstractC2775oV<C> A03() {
        return AQ.A02;
    }

    public static <T> AbstractC2775oV<T> A04(Comparator<T> comparator) {
        if (comparator instanceof AbstractC2775oV) {
            return (AbstractC2775oV) comparator;
        }
    ...
    public final <F> AbstractC2775oV<F> A05(InterfaceC2441ip<F, ? extends T> function) {
        return new BA(function, this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.oV != com.google.common.collect.Ordering<T> */
    public <S extends T> AbstractC2775oV<S> A06() {
        return new AJ(this);
    }
}
