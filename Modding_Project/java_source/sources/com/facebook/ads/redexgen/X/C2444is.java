...
public final class C2444is implements M8 {
    ...
    public static final C2444is A03 = new C2444is(Collections.emptyMap());
    public int A00;
    ...
    public C2444is(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static Map<String, byte[]> A00(Map<String, byte[]> otherMetadata, M9 m92) {
    ...
    */
    public static void A01(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C2444is.A01(java.util.HashMap, java.util.List):void");
    }
    ...
    public static byte[] A04(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(AbstractC2428ia.A06);
        }
    ...
    public final C2444is A05(M9 m92) {
        Map<String, byte[]> A00 = A00(this.A01, m92);
        Map<String, byte[]> mutatedMetadata = this.A01;
        if (A03(mutatedMetadata, A00)) {
            return this;
        }
        return new C2444is(A00);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return A03(this.A01, ((C2444is) obj).A01);
    }
