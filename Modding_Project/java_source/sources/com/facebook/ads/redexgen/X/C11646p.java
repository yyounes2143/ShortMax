...
public final class C11646p extends AbstractC2345hD {
    ...
    public C11646p(C2319gm c2319gm, String str) {
        super(c2319gm.A0B, str, A00(c2319gm));
        this.A01 = c2319gm;
    }

    public static C2318gl A00(C2319gm c2319gm) {
        return new C2318gl(c2319gm);
    }
    ...
    public final void A09() {
        this.A00 = new C2329gw(this.A01, this, A04());
    ...
    public final C2319gm A0E() {
        return this.A01;
    }

    public final void A0F(com.facebook.ads.Ad ad2, String str, AdExperienceType adExperienceType, boolean z10) {
        if (super.A00.A6M()) {
            return;
        }
        this.A01.A02(ad2);
    ...
    public final void A0G(RewardData rewardData) {
        ...
        if (super.A01.A01) {
            super.A01.A0F(2003, AbstractC1594Nu.A00(new Bundle(), rewardData));
    ...
    public final boolean A0J(com.facebook.ads.Ad ad2, RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        int A00 = ((C1677Rb) rewardedVideoShowAdConfig).A00();
        long A01 = ((C1677Rb) rewardedVideoShowAdConfig).A01();
        if (super.A00.A6N()) {
            return false;
        }
        this.A01.A02(ad2);
