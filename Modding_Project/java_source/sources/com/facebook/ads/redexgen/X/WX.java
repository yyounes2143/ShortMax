...
public abstract class WX {
    ...
    public static void A03() {
        A00 = new byte[]{39, 47, 107, 112, 122, 119, 115, 104, ByteCompanionObject.MIN_VALUE, 108, 107, 39, 109, 118, 121, 39, 123, 108, 122, 123, 39, 104, 107, 122, 39, 118, 117, 115, ByteCompanionObject.MIN_VALUE, 48, -78, -66, -68, 125, -75, -80, -78, -76, -79, -66, -66, -70, 125, -70, -80, -61, -80, -67, -80, -87, -75, -77, 116, -84, -89, -87, -85, -88, -75, -75, -79, 116, -67, -89, -79, -81, -64, -89, -71, -82, -81};
    }
    ...
    public static void A05(C2085cu c2085cu, InterfaceC1822Wv interfaceC1822Wv, String str) {
        if (str == null || A03.contains(str)) {
            return;
        }
        boolean isPackageInstalled = A08(c2085cu.getPackageManager(), str);
        if (isPackageInstalled) {
            interfaceC1822Wv.AEQ(str);
            return;
        }
        A03.add(str);
        A02.removeCallbacksAndMessages(null);
        A02.postDelayed(new WW(new int[]{0}, str, c2085cu, interfaceC1822Wv), 1000L);
    }
    ...
    */
    public static void A06(com.facebook.ads.redexgen.X.C2085cu r6, java.lang.String r7) {
        /*
        ...
        L5b:
            return
        L5c:
            com.facebook.ads.redexgen.X.Nk r1 = com.facebook.ads.redexgen.X.AbstractC1585Nl.A00(r6)
            r0 = 5
            r1.A0A(r7, r2, r0)
            goto L5b
        L65:
    ...
    public static void A07(C2085cu c2085cu, String str, InterfaceC1822Wv interfaceC1822Wv) {
        boolean isWithinFB = c2085cu.getPackageName().equals(A01(30, 19, 75)) || c2085cu.getPackageName().equals(A01(49, 22, 66));
        if (isWithinFB) {
            A05(c2085cu, interfaceC1822Wv, str);
        } else {
            AbstractC1585Nl.A00(c2085cu).A0A(str, interfaceC1822Wv, 4);
        }
    }
