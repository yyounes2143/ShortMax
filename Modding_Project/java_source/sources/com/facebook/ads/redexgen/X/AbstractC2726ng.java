...
public abstract class AbstractC2726ng {
    ...
    public static <E> ArrayList<E> A05(Iterator<? extends E> elements) {
        ...
        AbstractC2705nL.A0B(list, elements);
        return list;
    }

    public static boolean A06(@CheckForNull List<?> thisList, Object other) {
        if (other == AbstractC2461jA.A04(thisList)) {
            return true;
        }
        if (other instanceof List) {
            ...
            if (A00[7].charAt(4) != 'F') {
                ...
                if (z10 && (list instanceof RandomAccess)) {
                    for (int i10 = 0; i10 < size; i10++) {
                        if (!BX.A01(thisList.get(i10), list.get(i10))) {
                            return false;
                        }
                    }
                    return true;
                }
                return AbstractC2705nL.A0G(thisList.iterator(), list.iterator());
            }
            throw new RuntimeException();
        }
        return false;
