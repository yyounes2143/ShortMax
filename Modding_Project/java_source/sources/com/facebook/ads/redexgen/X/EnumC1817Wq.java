...
public enum EnumC1817Wq {
    ...
    EnumC1817Wq(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC1817Wq A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1817Wq[] values;
        for (EnumC1817Wq enumC1817Wq : values()) {
            if (enumC1817Wq.A01 == nativeComponentTag) {
                return enumC1817Wq;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1817Wq internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC1817Wq enumC1817Wq) {
        if (view != null && enumC1817Wq != null) {
            view.setTag(A02, enumC1817Wq);
        }
    }
