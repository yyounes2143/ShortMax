...
public final class RS implements NativeBannerAdApi {
    ...
    private void A02(ImageView imageView, NativeAdBaseApi nativeAdBaseApi) {
        ...
        if (adIcon != null) {
            ...
            if (strArr[2].charAt(21) == strArr[6].charAt(21)) {
                ...
                C2111dL A03 = RB.A03(context);
                if (A0N != null) {
                    Drawable A05 = C1652Qc.A05(A03, A0N, A0L.A1g(), A0L.A1D());
                    C1652Qc.A0f(A05, imageView);
                    imageView.post(new C2246fY(this, A0L, A05));
                    return;
                }
                RP loadImageTask = new RP(A03, c2247fZ, A0L.A1g(), null);
    ...
    public final void registerViewForInteraction(View view, ImageView imageView, List<View> list) {
        ...
        if (list != null) {
            ...
            strArr[5] = "ll9cTRtW3a";
            strArr[7] = "WGLVGgKdvO";
            c1652Qc.A1N(view, imageView, list);
            return;
        }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, List<View> clickableViews) {
        if (mediaView != null) {
            ((C2255fh) mediaView.getMediaViewApi()).A0M(this.A00, true);
        }
