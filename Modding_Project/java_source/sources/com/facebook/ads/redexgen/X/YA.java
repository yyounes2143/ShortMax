...
public final class YA extends RelativeLayout {
    ...
    public static final int A08 = (int) (AbstractC1812Wl.A02 * 60.0f);
    public static final int A07 = (int) (AbstractC1812Wl.A02 * 8.0f);
    public static final int A09 = (int) (AbstractC1812Wl.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC1812Wl.A02 * 24.0f);
    public static final int A06 = (int) (AbstractC1812Wl.A02 * 12.0f);

    public YA(C2111dL c2111dL, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c2111dL);
        this.A05 = new TextView(c2111dL);
        this.A02 = new Button(c2111dL);
        this.A01 = new Button(c2111dL);
