...
public final class C8H extends Exception {
    ...
    public static void A01() {
        A03 = new byte[]{60, ByteCompanionObject.MAX_VALUE, 119, 45, 58, 60, 48, 41, 58, 45, 62, 61, 51, 58, 118, 123, 126, 114, 60, 39, 63, 29, 52, 19, 39, 54, 59, 61, 6, 32, 51, 49, 57, 19, 62, 62, 61, 49, 51, 38, 55, 54, 111, 42, 38, 86, 98, 115, 126, 120, 67, 101, 118, 116, 124, 55, 126, 121, 126, 99, 55, 113, 118, 126, 123, 114, 115, 55, 44, 0, 1, 9, 6, 8, 71};
    }
    ...
    */
    public C8H(int r6, int r7, int r8, int r9, com.facebook.ads.redexgen.X.C2796or r10, boolean r11, java.lang.Exception r12, int r13) {
        /*
            r5 = this;
