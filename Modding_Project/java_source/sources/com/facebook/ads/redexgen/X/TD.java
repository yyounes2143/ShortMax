...
public final class TD extends R8 implements DefaultMediaViewVideoRendererApi {
    ...
    public C2111dL A01;
    public InterfaceC1762Uk A02;
    public AnonymousClass64 A04;
    public C10602p A05;
    public C2Z A06;
    public AbstractC2183eW A07;
    public C2184eX A08;
    public boolean A09;
    public boolean A0A;
    public boolean A0B;
    public final InterfaceC2123dX A0C = new UW(this);
    public final AtomicBoolean A0D = new AtomicBoolean(false);
    public final AtomicBoolean A0E = new AtomicBoolean(false);
    public EnumC1772Uu A03 = EnumC1772Uu.A03;
    ...
    private C1742Tq A02() {
        return new C1742Tq(this);
    }

    private C2184eX A05() {
        return new C2184eX(this.A00, 50, true, new WeakReference(this.A07), this.A01);
    }
    ...
    private void A09() {
        if (this.A04 != null) {
            ...
            ((C2124dY) anonymousClass64.getVideoView()).setViewImplInflationListener(this.A0C);
        }
    }

    private void A0A() {
        if (this.A04 != null) {
            this.A04.getVideoView().setOnTouchListener(new View$OnTouchListenerC1761Uj(this));
        }
    }

    private void A0B() {
        if (this.A04 != null) {
            ((C2124dY) this.A04.getVideoView()).setViewImplInflationListener(null);
        }
    }
    ...
    private void A0C() {
        ...
        if (this.A04 != null) {
            EnumC2181eU state = this.A04.getState();
            String[] strArr = A0G;
            if (strArr[7].length() != strArr[1].length()) {
                throw new RuntimeException();
            }
            A0G[4] = "z79LrkWpr7afRwAllWq14kp6jWBswbkV";
            if (state == EnumC2181eU.A05) {
                this.A0B = true;
            }
        }
        this.A08.A0V();
    ...
    public void A0D() {
        this.A03 = EnumC1772Uu.A03;
        A0B();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0I(C1652Qc c1652Qc, InterfaceC1762Uk interfaceC1762Uk) {
        String str;
        this.A0A = false;
        this.A0B = false;
        this.A02 = interfaceC1762Uk;
        A09();
        C10602p c10602p = this.A05;
        if (c1652Qc != null && c1652Qc.getAdCoverImage() != null) {
        ...
        c10602p.setImage(str, new C1747Tv(this));
        this.A03 = c1652Qc.A19();
        this.A06.setPlayAccessibilityLabel(c1652Qc.A1F());
        this.A06.setPauseAccessibilityLabel(c1652Qc.A1E());
        this.A08.A0U();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0J(EnumC2127db enumC2127db) {
        if (this.A04 != null) {
            this.A04.A0h(enumC2127db, 24);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0K() {
        if (this.A04 == null || this.A04.getState() == EnumC2181eU.A06) {
            return false;
        }
        return this.A03 == EnumC1772Uu.A05 || this.A03 == EnumC1772Uu.A03;
    }
    ...
    public final void initialize(Context context, MediaViewVideoRenderer mediaViewVideoRenderer, MediaViewVideoRendererApi mediaViewVideoRendererApi, int i10) {
        ...
        this.A05 = new C10602p(this.A01);
        this.A07 = A02();
        this.A08 = A05();
        float density = AbstractC1812Wl.A02;
    ...
    public final void onPrepared() {
        ...
        this.A00.setOnTouchListener(new View$OnTouchListenerC1760Ui(this, A0s));
        if (!A0s) {
            A0A();
        }
    }
