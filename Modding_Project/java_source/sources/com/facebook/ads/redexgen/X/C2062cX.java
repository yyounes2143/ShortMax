...
public final class C2062cX extends LinearLayout {
    public LinearLayout A00;
    public String A01;
    public boolean A02;
    public final int A03;
    public final C2111dL A04;
    public final C1925aK A05;
    public final C1931aQ A06;
    ...
    public static final int A0B = (int) (AbstractC1812Wl.A02 * 32.0f);
    public static final int A0C = (int) (AbstractC1812Wl.A02 * 16.0f);
    public static final int A09 = (int) (AbstractC1812Wl.A02 * 4.0f);
    public static final int A08 = (int) (AbstractC1812Wl.A02 * 72.0f);

    public C2062cX(C2060cV c2060cV) {
        super(C2060cV.A04(c2060cV));
        this.A02 = false;
        this.A01 = "";
        this.A04 = C2060cV.A04(c2060cV);
        this.A05 = new C1925aK(this.A04);
        this.A06 = new C1931aQ(this.A04, C2060cV.A02(c2060cV), true, false, true);
        this.A03 = C2060cV.A00(c2060cV);
        this.A02 = C2060cV.A08(c2060cV);
        this.A01 = C2060cV.A05(c2060cV);
        A03(c2060cV);
    }

    public /* synthetic */ C2062cX(C2060cV c2060cV, C1385Fr c1385Fr) {
        this(c2060cV);
    }
    ...
    private void A02(C2060cV c2060cV) {
        if (!TextUtils.isEmpty(C2060cV.A06(c2060cV))) {
            ...
            textView.setText(C2060cV.A06(c2060cV));
            LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-2, -2);
            ImageView imageView = new ImageView(getContext());
            new KZ(imageView, this.A04).A04().A07(C2060cV.A07(c2060cV));
            int i13 = A0A;
            int marginTop2 = A0A;
            ...
            if (this.A02) {
                C1919aE c1919aE = new C1919aE(getContext(), 0, -1, XX.PLAYABLE_ICON);
                c1919aE.setLayoutParams(new LinearLayout.LayoutParams(A0B, A0B));
                this.A00.addView(c1919aE);
            } else {
    ...
    private void A03(C2060cV c2060cV) {
        XP.A0K(this.A05, 0);
        this.A05.setRadius(50);
        if (this.A02) {
            this.A05.setRadius(A09);
        } else if (C2060cV.A01(c2060cV).A00() == EnumC1568Mu.A05) {
            this.A05.setFullCircleCorners(true);
        } else {
            C1925aK c1925aK = this.A05;
            int i10 = A09;
            String[] strArr = A07;
            ...
            c1925aK.setRadius(i10);
        }
        new KZ(this.A05, this.A04).A04().A07(C2060cV.A03(c2060cV).A01());
        this.A06.A04(C2060cV.A01(c2060cV).A0F(), C2060cV.A03(c2060cV).A03(), null, false, true);
        if (!this.A02) {
    ...
    public final void A04(InterfaceC2061cW interfaceC2061cW) {
        A00();
        postDelayed(new C1385Fr(this, interfaceC2061cW), this.A03);
    }
}
