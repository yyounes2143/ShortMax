...
public final class C1804Wb implements TX {
    ...
    public final String A05(TV tv) {
        ...
        try {
            try {
                ...
                Map A062 = A06();
                if (TextUtils.isEmpty(AbstractC1693Rr.A00().A03())) {
                    AbstractC1693Rr.A07(this.A01);
                }
                A062.put(A01(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_BUFFER_THRESHOLD_CONTROL, 4, 114), AbstractC1693Rr.A00().A03());
                A062.put(A01(587, 10, 2), AbstractC1728Tb.A06(new T6(this.A01), this.A01, false));
                if (U7.A1w(this.A01)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:61:0x0393, code lost:
        r3.put(A01(com.ss.ttm.player.MediaPlayer.MEDIA_PLAYER_OPTION_GET_CUR_UI_FPS, 13, 25), java.lang.String.valueOf(r11.A01.A04().A9e()));
        r3.put(A01(244, 13, 98), java.lang.String.valueOf(com.facebook.ads.redexgen.X.C1716Sp.A0H(r11.A01)));
        r5 = new java.lang.StringBuilder();
        r7 = com.facebook.ads.redexgen.X.C1804Wb.A06;
        r6 = 0;
     */
    /* JADX WARN: Code restructure failed: missing block: B:62:0x03cd, code lost:
        r8 = r7.length;
        r9 = true;
        r2 = com.facebook.ads.redexgen.X.C1804Wb.A05;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:88:0x04af, code lost:
        r3.put(A01(com.ss.ttvideoengine.TTVideoEngineInterface.PLAYER_OPTION_ENABLE_OPEN_TIMEOUT, 18, 2), java.lang.String.valueOf(r6.versionCode));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:90:0x04ce, code lost:
        if (com.facebook.ads.redexgen.X.C1804Wb.A05[4].length() == 3) goto L83;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:98:0x04f8, code lost:
        r3.put(A01(com.ss.ttm.player.MediaPlayer.MEDIA_PLAYER_OPTION_CHANNELS, 17, 45), com.facebook.ads.redexgen.X.AbstractC1818Wr.A01(r4));
     */
    ...
    */
    public final java.util.Map<java.lang.String, java.lang.String> A7q(com.facebook.ads.redexgen.X.TL r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1804Wb.A7q(com.facebook.ads.redexgen.X.TL):java.util.Map");
    }
    ...
    public C1804Wb(SQ sq2, boolean z10, S5 s52) {
        this.A01 = sq2;
        this.A00 = s52;
        TT.A08(sq2, z10, null);
    }
    ...
    public static synchronized PackageInfo A00(SQ sq2) {
        ...
        synchronized (C1804Wb.class) {
            if (!A03) {
                A02 = AbstractC1823Ww.A00(sq2);
                A03 = true;
            }
            packageInfo = A02;
        }
    ...
    private void A03(TL tl2, Map<String, String> map) {
        ...
        if (tl2 != null && tl2.AAX()) {
            ...
            if (tl2.A7F() != null) {
                map.put(A01(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_MAX_RETRANSMISSIONS, 21, 37), tl2.A7F());
            }
        }
        if (UA.A09(this.A01)) {
            SQ sq2 = this.A01;
            ...
            String A032 = TN.A03(sq2.A02());
            if (A032 != null) {
                String remoteRenderingSdkVersion = A01(MediaPlayer.MEDIA_PLAYER_OPTION_CMAF_VIDEO_FIRSTSEG_CONNECT_TIME, 22, 0);
                map.put(remoteRenderingSdkVersion, A032);
            }
            String A022 = TN.A02(this.A01.A02());
            if (A032 != null) {
                String remoteRenderingSdkVersion2 = A01(TTVideoEngineInterface.PLAYER_OPTION_HIJACK_RETRY, 9, 105);
