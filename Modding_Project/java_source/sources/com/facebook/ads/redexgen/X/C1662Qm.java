...
public class C1662Qm {
    ...
    public static OZ<C1662Qm> A03 = new C2307ga(20);

    public static C1662Qm A00() {
        C1662Qm A33 = A03.A33();
        if (A04[5].charAt(2) != 'q') {
            A04[5] = "RnCaU2E938mENSzRzPrAuXo67ZnkzA8g";
            C1662Qm record = A33;
            return record == null ? new C1662Qm() : record;
        }
    ...
    public static void A02(C1662Qm c1662Qm) {
        c1662Qm.A00 = 0;
        c1662Qm.A02 = null;
        c1662Qm.A01 = null;
        A03.AGv(c1662Qm);
