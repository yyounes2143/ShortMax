...
public abstract class XP {
    ...
    public static void A0C() {
        A00 = new byte[]{120, 118, -127, -127, 122, -121, 105, -114, -123, 122, -35, -26, -29, -35, -27, -39, -19, -23, -17, -20, -35, -33, -124, -121, -118, -110, -125, -112, -125, -126, 125, -127, -118, -121, -127, -119, 125, -126, -125, -118, ByteCompanionObject.MAX_VALUE, -105, 125, -117, -111, -40, -35, -29, -44, -31, -30, -29, -40, -29, -40, -48, -37, -39, -29, -49, -45, -47, -45, -49, -42, -39, -36, -28, -43, -30, -49, -45, -36, -39, -45, -37, -29, -49, -33, -34, -49, -45, -28, -47, -125, -115, 121, 125, -116, ByteCompanionObject.MAX_VALUE, 123, -114, -125, -112, ByteCompanionObject.MAX_VALUE, 121, 123, -115, 121, 125, -114, 123, 121, -112, 76, -90, -103, -85, -107, -90, -104, -103, -104, -109, -86, -99, -104, -103, -93, -50, -53, -66, -53, -48, -53, -119, -55, -63, -64, -59, -47, -55, -11, -29, -16, -11, -81, -11, -25, -12, -21, -24, -81, -17, -25, -26, -21, -9, -17, -36, -43, -48, -40, -36, -52, -80, -53, -66, -68, -82, -69, -84, -75, -78, -84, -76};
    }
     ...
     */
    public static boolean A0e(C2111dL c2111dL, ME me2, Map<String, String> map) {
        String str = map.get(A0B(84, 21, 11));
        boolean z10 = str != null && str.equals(Boolean.TRUE.toString());
        if (z10 && (A0d(c2111dL, me2) || A0b(me2, map))) {
            return true;
        }
    ...
    public static int A01(int i10) {
        return (int) TypedValue.applyDimension(2, i10, AbstractC1812Wl.A04);
    }

    public static int A02(int i10) {
        if (A0a(i10)) {
            return OP.A05(i10, -1, 0.4f);
        }
        return OP.A05(i10, ViewCompat.MEASURED_STATE_MASK, 0.2f);
    }
    ...
    */
    ...
    public static void A0D(int i10, View view) {
        ...
        scaleAnimation.setAnimationListener(new C1616Os(view, scaleAnimation2));
    ...
    public static void A0Y(Map<String, String> map, AbstractC2392hy abstractC2392hy) {
        char c10;
        if (abstractC2392hy == null) {
            return;
        }
        String A0v = abstractC2392hy.A0v();
        switch (A0v.hashCode()) {
            case -1364000502:
        ...
        map.put(A0B(149, 8, 88), abstractC2392hy.A0q());
        map.put(A0B(84, 21, 11), String.valueOf(abstractC2392hy.A1W()));
        map.put(A0B(57, 27, 97), String.valueOf(abstractC2392hy.A1R()));
        map.put(A0B(22, 23, 15), String.valueOf(abstractC2392hy.A0n()));
    }
    ...
    public static boolean A0d(C2111dL c2111dL, ME me2) {
        return me2 == ME.A08 && U7.A2o(c2111dL);
    }
}
