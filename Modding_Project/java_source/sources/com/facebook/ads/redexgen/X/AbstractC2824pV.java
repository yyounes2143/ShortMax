...
public abstract class AbstractC2824pV<F, T> implements Iterator<T> {
    ...
    public AbstractC2824pV(Iterator<? extends F> backingIterator) {
        this.A00 = (Iterator) AbstractC2461jA.A04(backingIterator);
    }
