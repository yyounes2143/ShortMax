...
public final class C11265d extends AbstractC1493Jw {
    ...
    public C2111dL A03;
    public C1806Wd A04;
    public AbstractC1839Xm A05;
    public AbstractC1839Xm A06;
    public AbstractC1945ae A07;
    public C2095d4 A08;
    public C2101dA A09;
    public CU A0A;
    public boolean A0B;
    ...
    public final InterfaceC1922aH A0G;
    public final C1923aI A0H;
    ...
    static {
        ...
        A0b = (int) (AbstractC1812Wl.A02 * 12.0f);
        A0N = (int) (AbstractC1812Wl.A02 * 8.0f);
        A0O = (int) (AbstractC1812Wl.A02 * 10.0f);
        A0W = (int) (AbstractC1812Wl.A02 * 20.0f);
        A0X = (int) (AbstractC1812Wl.A02 * 13.0f);
        A0R = (int) (AbstractC1812Wl.A02 * 48.0f);
        A0a = (int) (AbstractC1812Wl.A02 * 14.0f);
        A0Y = (int) (AbstractC1812Wl.A02 * 12.0f);
        A0P = (int) (AbstractC1812Wl.A02 * 8.0f);
        A0Z = OP.A02(-1, 77);
        A0V = (int) (AbstractC1812Wl.A02 * 16.0f);
        A0c = (int) (AbstractC1812Wl.A02 * 12.0f);
        A0S = (int) (AbstractC1812Wl.A02 * 12.0f);
        A0T = (int) (AbstractC1812Wl.A02 * 16.0f);
        A0U = (int) (AbstractC1812Wl.A02 * 48.0f);
    }

    public C11265d(C1949ai c1949ai) {
        super(c1949ai, false);
        this.A0D = new Handler(Looper.getMainLooper());
        this.A0E = new Handler(Looper.getMainLooper());
        this.A0C = false;
        this.A0B = false;
        this.A03 = c1949ai.A06();
        this.A06 = c1949ai.A0C();
        this.A05 = c1949ai.A0B();
        this.A0I = c1949ai;
        ...
        A09();
        this.A0F = c1949ai.A0D();
        AbstractC1932aR.A00(c1949ai.A06(), this, getAdInfo().A0H().A08());
        this.A0J = A01(c1949ai);
        XP.A0I(this.A0J);
        getAdDetailsView().bringToFront();
        if (!A03()) {
            this.A0K = A02(c1949ai);
        } else {
            this.A0K = null;
        }
        ...
        A1R();
        this.A08 = new C2095d4(this.A03, c1949ai.A07(), getAdDataBundle());
        this.A0G = new C1489Js(this);
        this.A0H = new C1923aI(c1949ai, getAdDataBundle(), this.A0J, this.A0K, getAdDetailsView(), this.A0F, this.A0G);
        C1807Wg A02 = super.A09.A02(getAdDataBundle());
        this.A03.A0H().A00(A02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A09);
        if (A02.A00) {
            this.A0J.getVideoImplView().setOnClickListener(new View$OnClickListenerC1952al(this));
        } else if (U7.A1K(getAdContextWrapper())) {
            AbstractC1897Zs.A00(this.A0J.getVideoImplView(), U7.A1L(getAdContextWrapper()), new View$OnClickListenerC1953am(this));
        }
        if (c1949ai.A05().A1f()) {
            if (this.A0I.A05().A1i()) {
                this.A07 = new JR(c1949ai);
            } else {
                this.A07 = new JS(c1949ai);
            }
            View view = this.A07;
    ...
    private E1 A01(C1949ai c1949ai) {
        RelativeLayout.LayoutParams layoutParams;
        E1 e12 = (E1) c1949ai.A02();
        int A1O = A1O(c1949ai.A0C());
        this.A02 = (ImageView) c1949ai.A03();
        if (!A03()) {
            ImageView imageView = this.A02;
            int i10 = AbstractC1493Jw.A0M;
            int i11 = AbstractC1493Jw.A0M;
            int toolbarHeight = AbstractC1493Jw.A0M;
            imageView.setPadding(i10, i11, toolbarHeight, AbstractC1493Jw.A0M);
            int toolbarHeight2 = AbstractC1493Jw.A0N;
            layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC1493Jw.A0N);
            int toolbarHeight3 = AbstractC1493Jw.A0L;
            layoutParams.setMargins(0, A1O, toolbarHeight3, 0);
            layoutParams.addRule(11);
        } else {
            int toolbarHeight4 = AbstractC1945ae.A0J;
            layoutParams = new RelativeLayout.LayoutParams(toolbarHeight4, AbstractC1945ae.A0J);
            int i12 = A0T;
            int i13 = A0U;
        ...
        if (getAdDataBundle().A1l() && e12 != null) {
            View videoView = e12.getVideoView();
            int paddingLeft = e12.getVideoView().getPaddingLeft();
            int paddingTop = e12.getVideoView().getPaddingTop();
            int paddingRight = e12.getVideoView().getPaddingRight();
            int toolbarHeight6 = e12.getVideoView().getPaddingBottom();
    ...
    private C1312Cw A02(C1949ai c1949ai) {
        C1312Cw A0F = c1949ai.A0F();
        A0F.A08(-1, AbstractC1493Jw.A0E, false);
        A0F.setPadding(AbstractC1493Jw.A0Q, AbstractC1493Jw.A0Q, AbstractC1493Jw.A0Q, AbstractC1493Jw.A0Q);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC1493Jw.A0P);
    ...
    private void A05() {
        addView(new C1961au(this.A0I.A06(), getAdDataBundle(), this.A0I.A08(), this.A0E, this.A0I.A0D()).A09(getCtaButton()));
    }

    private void A06() {
        XP.A0Z(this.A02, getCtaButton(), getAdDetailsView(), this.A01, this.A0H, this.A0I.A0C());
        for (InterfaceC2128dc interfaceC2128dc : this.A0J.getPlugins()) {
            if (interfaceC2128dc instanceof C2R) {
                this.A0J.A0j(interfaceC2128dc);
                return;
            }
        }
    }
    ...
    private void A0A() {
        new C1752Ua(getAdDataBundle().A25(), getAdEventManager()).A04(UZ.A0z, null);
        if (!getAdInfo().A0V()) {
            return;
        }
        super.A0A.set(true);
        ...
        XP.A0J(this.A06);
        Pair<EnumC2094d3, View> A03 = this.A08.A03(getCtaButton());
        this.A00 = (View) A03.second;
        A0E((EnumC2094d3) A03.first);
        if (getAdInfo().A0K().A00() >= 0) {
            ...
            this.A04 = new C1806Wd((int) getAdInfo().A0K().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C1487Jq(this));
            this.A04.A07();
        }
    }
    ...
    private void A0D(RelativeLayout relativeLayout) {
        ...
        XP.A0K(c1925aK, 0);
        XP.A0I(c1925aK);
        new KZ(c1925aK, this.A03).A05(A0R, A0R).A07(getAdDataBundle().A23().A01());
        ...
        C1927aM c1927aM = new C1927aM(c2111dL, i10, 5, A0Z, -1);
        ...
        linearLayout.addView(c1927aM, ratingCountParams);
        ...
        iconParams.addRule(1, c1925aK.getId());
        ...
        relativeLayout.addView(c1925aK, layoutParams);
        if (TextUtils.isEmpty(getAdDataBundle().A20().A0I().A0B())) {
            linearLayout.setVisibility(8);
            return;
        }
        linearLayout.setVisibility(0);
        c1927aM.setRating(Float.parseFloat(getAdDataBundle().A20().A0I().A0B()));
        ...
        if (!getAdDataBundle().A1j()) {
            ...
            formattingRatingCount = AbstractC1821Wu.A01(Integer.parseInt(getAdDataBundle().A20().A0I().A08()));
        }
    ...
    private void A0E(EnumC2094d3 enumC2094d3) {
        if (!getAdDataBundle().A20().A0K().A02().isEmpty()) {
            if (getAdDataBundle().A20().A0K().A03()) {
                this.A09 = new C2101dA(this.A03, getAdDataBundle(), this.A0F, getCtaButton(), this.A0E, this.A0I.A08());
    ...
    private void A0F(EnumC2094d3 enumC2094d3) {
        this.A0J.A0k(false);
        this.A0J.setVisibility(8);
        if (this.A06 instanceof C1591Nr) {
            AbstractC1839Xm abstractC1839Xm = this.A05;
        ...
        switch (enumC2094d3) {
            case A03:
                AbstractC1900Zv oldEndCardAdDetailsView = getOldEndCardAdDetailsView();
                if (A0M[4].charAt(31) != 'A') {
                    A0M[2] = "XFfDcp5VJF8GQaNSTNs87nOmJmOzmbPV";
                    if (oldEndCardAdDetailsView == null) {
                        AbstractC1900Zv oldEndCard = getAdDetailsView();
                    ...
                    if (oldEndCardAdDetailsView != null) {
                        ...
                        AbstractC1900Zv oldEndCard2 = getAdDetailsView();
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams.setMargins(AbstractC1493Jw.A0O, AbstractC1493Jw.A0O, AbstractC1493Jw.A0O, AbstractC1493Jw.A0O);
    ...
    public final void A1H(C10743d c10743d) {
        super.A1H(c10743d);
        if (A03()) {
            AbstractC1900Zv adDetailsView = getAdDetailsView();
            if (A0M[0].length() == 5) {
                throw new RuntimeException();
            }
    ...
    public final void A1I(DO r10) {
        ...
        if (A03()) {
            this.A03.A0F().AJw(AbstractC1803Wa.A00((float) this.A0I.A05().A0h()), getResources().getConfiguration().orientation, true, false, MH.A0C(this.A0I.A04()));
        }
    ...
    public final void A1J(C3Q c3q, int i10) {
        ...
        if ((getAdDetailsView() instanceof KL) && !this.A0I.A05().A1i()) {
            ...
            ((KL) getAdDetailsView()).A0o(((remainingVideoTimeInMillis * i10) + currentPosMs) / 1000);
        }
    }
    ...
    public final AbstractC1900Zv A1P(C1949ai c1949ai, C1563Mp c1563Mp, String str) {
        double A0h = c1949ai.A05().A0h();
        if (A03()) {
            if (E1.A0T((float) A0h)) {
                return new C11395q(c1949ai.A06(), getCtaButton(), AbstractC1493Jw.A0I, false, getColors(), str, c1949ai.A07(), c1949ai.A0D(), c1949ai.A0G(), c1949ai.A0A(), c1949ai.A05(), c1949ai.A0F(), c1949ai.A08(), false);
            }
            if (E1.A0V((float) A0h)) {
                return new C11385p(c1949ai.A06(), getCtaButton(), AbstractC1493Jw.A0I, false, getColors(), str, c1949ai.A07(), c1949ai.A0D(), c1949ai.A0G(), c1949ai.A0A(), c1949ai.A05(), c1949ai.A0F(), c1949ai.A08(), false);
            }
            return new C11405r(c1949ai.A06(), getCtaButton(), AbstractC1493Jw.A0I, false, getColors(), str, c1949ai.A07(), c1949ai.A0D(), c1949ai.A0G(), c1949ai.A0A(), c1949ai.A05(), c1949ai.A0F(), c1949ai.A08(), false);
        }
        return new C1495Jy(c1949ai.A06(), getCtaButton(), AbstractC1493Jw.A0J, c1563Mp.A0I().A00() == EnumC1568Mu.A05, getColors(), c1563Mp.A0J().A06(), str, c1949ai.A07(), c1949ai.A0D(), c1949ai.A0G(), c1949ai.A0A(), c1949ai.A05());
    }

    @Override // com.facebook.ads.redexgen.X.AbstractC1493Jw
    public final C1495Jy A1Q(C1949ai c1949ai, C1563Mp c1563Mp, String str) {
        return new C1495Jy(c1949ai.A06(), getCtaButton(), AbstractC1493Jw.A0J, c1563Mp.A0I().A00() == EnumC1568Mu.A05, getColors(), c1563Mp.A0J().A06(), str, c1949ai.A07(), c1949ai.A0D(), c1949ai.A0G(), c1949ai.A0A(), c1949ai.A05());
    }
    ...
    public final void A1Y() {
        new C1752Ua(this.A0I.A05().A25(), getAdEventManager()).A04(UZ.A0h, null);
        if (this.A0I.A0C() != null) {
            AbstractC1839Xm A0C = this.A0I.A0C();
            if (A0M[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
    ...
    public final void A1a(C10793i c10793i) {
        if (this.A07 != null) {
            if (this.A07 instanceof JR) {
                ((JR) this.A07).A1O(c10793i);
            }
            if (this.A07 instanceof JS) {
                ((JS) this.A07).A1O(c10793i);
            }
            this.A07.A1B();
            AbstractC1945ae abstractC1945ae = this.A07;
            String[] strArr = A0M;
            if (strArr[3].charAt(21) == strArr[6].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC1493Jw, com.facebook.ads.redexgen.X.AbstractC1945ae, android.view.View
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A07 != null) {
            ...
            if (abstractC1945ae.getVisibility() == 0) {
                getAdDetailsView().setVisibility(8);
                return;
            }
        }
    ...
    public void setVideoAdViewListener(InterfaceC2069ce interfaceC2069ce) {
        if (this.A07 instanceof JR) {
            ((JR) this.A07).setVideoAdViewListener(interfaceC2069ce);
        }
        if (this.A07 instanceof JS) {
            ((JS) this.A07).setVideoAdViewListener(interfaceC2069ce);
        }
    }
}
