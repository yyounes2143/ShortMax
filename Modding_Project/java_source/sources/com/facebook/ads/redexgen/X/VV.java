...
public final class VV {
    ...
    public static void A05() {
        A01 = new byte[]{118, 115, 72, 101, 114, 103, 120, 101, 99, 126, 121, 112, 72, 116, 120, 121, 113, 126, 112, 77, 72, 77, 92, 88, 73, 94, 24, 29, 10, 100, 107, 90, 115, 100, 105, 108, 97, 100, 113, 108, 106, 107, 90, 112, 112, 108, 97, 44, 46, 44, 39, 42, 105, 98, 107, 99, 100, 85, 122, 107, 120, 107, 103, 121, 39, 43, 32, 33, 122, ByteCompanionObject.MAX_VALUE, 106, ByteCompanionObject.MAX_VALUE, 16, 21, 0, 21, 59, 22, 30, 17, 23, 0, 84, 29, 7, 84, 26, 1, 24, 24, 108, 105, 124, 105, 87, 101, 103, 108, 109, 100, 87, 124, 113, 120, 109, 120, 121, 126, 105, 123, 67, 122, 105, 114, 114, 121, 112, 67, ByteCompanionObject.MAX_VALUE, 115, 114, 122, 117, 123, 26, 27, 24, 23, 16, 23, 10, 23, 17, 16, 24, 15, 15, 18, 15, 75, 72, 76, 89, 88, 95, 72, 114, 78, 66, 67, 75, 68, 74, 82, 88, 85, 71, 92, 107, 87, 91, 90, 82, 93, 83, 46, 45, 37, 29, 33, 55, 48, 48, 39, 44, 54, 29, 36, 55, 44, 44, 39, 46, 89, 81, 71, 71, 85, 83, 81, 121, 101, 104, 106, 108, 100, 108, 103, 125, 122, 115, 100, 107, 95, 99, 97, 99, 104, 101, 41, 47, 60, 62, 54, 56, 47, 46, 87, 90, 83, 70};
    }
    ...
    private PW A01(C2111dL c2111dL, JSONObject data, long j10) throws JSONException {
        ...
        TE te2 = new TE(A002, optString, adReportingConfig, cache, flashConfig, optString2, A06(jSONObject));
        ...
        if (jSONObject.has(A044)) {
            ...
            while (i10 < jSONArray.length()) {
                ...
                AbstractC1754Uc.A06(c2111dL, jSONObject2, j10, str);
                ...
                if (ad2 != null) {
                    te2.A0F(new TC(optString3, optString4, ad2, optJSONArray));
                } else {
                    LH A0F = c2111dL.A0F();
        ...
        if (jSONObject.has(A045)) {
            te2.A0G(jSONObject.getJSONObject(A045));
        }
    ...
    public final VX A07(C2111dL c2111dL, String str, long j10) throws JSONException {
        char c10;
        if (!TextUtils.isEmpty(str)) {
            ...
            switch (c10) {
                case 0:
                    return A01(c2111dL, jSONObject, j10);
                case 1:
