...
public final class C2493jh implements GP {
    ...
    private GN A00(C4J c4j, long scrValue, long scrTimeUs) {
        ...
        while (c4j.A07() >= 4) {
            A00 = C2492jg.A00(c4j.A0l(), c4j.A09());
            if (A00 != 442) {
                c4j.A0g(1);
            } else {
                c4j.A0g(4);
        ...
        if (j10 != -9223372036854775807L) {
            return GN.A05(j10, i11 + scrTimeUs);
        }
        return GN.A03;
    }
    ...
    */
    public static void A01(com.facebook.ads.redexgen.X.C4J r5) {
        ...
        L33:
            byte[] r1 = r5.A0l()
            int r0 = r5.A09()
            int r1 = com.facebook.ads.redexgen.X.C2492jg.A01(r1, r0)
        ...
        L86:
            ...
            goto L57
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C2493jh.A01(com.facebook.ads.redexgen.X.4J):void");
    }

    @Override // com.facebook.ads.redexgen.X.GP
    public final void AFA() {
        this.A00.A0i(AbstractC10974a.A07);
    }

    @Override // com.facebook.ads.redexgen.X.GP
    public final GN AIC(InterfaceC2585lN interfaceC2585lN, long j10) throws IOException {
        long A8f = interfaceC2585lN.A8f();
        int min = (int) Math.min(20000L, interfaceC2585lN.A8G() - A8f);
        this.A00.A0d(min);
        interfaceC2585lN.AG9(this.A00.A0l(), 0, min);
