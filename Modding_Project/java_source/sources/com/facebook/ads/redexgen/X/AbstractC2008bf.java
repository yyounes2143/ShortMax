...
public abstract class AbstractC2008bf {
    public static C5Q A00(final C1949ai c1949ai, int i10, final String str, final FH fh2) {
        if (i10 == 1) {
            return new C5Q(c1949ai, str, fh2) { // from class: com.facebook.ads.redexgen.X.0e
                public static final int A00 = (int) (AbstractC1812Wl.A02 * 20.0f);
                public static final int A01 = (int) (AbstractC1812Wl.A02 * 16.0f);
                ...
                public final void A1V(C2111dL c2111dL) {
                    C1931aQ titleDescContainer = getTitleDescContainer();
        ...
        return new C5Q(c1949ai, str, fh2) { // from class: com.facebook.ads.redexgen.X.0f
            public static final int A00 = (int) (AbstractC1812Wl.A02 * 12.0f);
            ...
            @Override // com.facebook.ads.redexgen.X.C5Q, com.facebook.ads.redexgen.X.AbstractC1945ae
