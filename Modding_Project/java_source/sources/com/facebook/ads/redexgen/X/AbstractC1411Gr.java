...
public abstract class AbstractC1411Gr {
    public static String[] A00 = {"LICRowSKufdYuvwk0u6bsAkyuycb3o", "3c3IkJ7dOAlpkofMi9kyF", "8", "QmWMZEVudINzrA2kZLMiJGq1bO", "Rty4yJjWzs33", "sO", TextureRenderKeys.KEY_IS_X, "tim3YlDUE2i6MxDxj85j1aO5zMSMD9gT"};
    ...
    public static long A03(byte b10, byte b11) {
        int i10;
        int length;
        int frames = b10 & AdConfig.NETWORK_LOAD_LIMIT_DISABLED;
        int toc = frames & 3;
        switch (toc) {
            case 0:
                i10 = 1;
