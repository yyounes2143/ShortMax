...
public abstract class XW {
    ...
    public static Bitmap A00(C2111dL c2111dL, Bitmap bitmap, int i10) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation output = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(c2111dL);
    ...
    public static Bitmap A01(C2111dL c2111dL, Bitmap bitmap, int i10, int i11) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                createBitmap = A00(c2111dL, createBitmap, i10);
                if (i11 != 1) {
                ...
                return new C1614Oq().A02(createBitmap, i10);
            }
        }
        return null;
    }
