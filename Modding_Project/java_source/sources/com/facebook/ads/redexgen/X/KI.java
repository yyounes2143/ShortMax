...
public final class KI extends OE {
    ...
    private void A02() {
        ...
        new KZ(c1925aK, this.A03).A05(A0D, A0D).A07(this.A02.A23().A01());
        ...
        layoutParams2.addRule(3, c1925aK.getId());
        ...
        C1927aM c1927aM = new C1927aM(this.A03, A0B, 5, A0A, -1);
        c1927aM.setGravity(16);
        linearLayout.addView(c1927aM, new LinearLayout.LayoutParams(-2, -1));
        ...
        if (TextUtils.isEmpty(this.A02.A20().A0I().A0B())) {
            ...
            c1927aM.setRating(Float.parseFloat(this.A02.A20().A0I().A0B()));
    ...
    public KI(C2111dL c2111dL, AbstractC2392hy abstractC2392hy, US us2, InterfaceC1840Xn interfaceC1840Xn) {
        super(c2111dL);
        this.A05 = new XH();
        this.A03 = c2111dL;
        ...
        AbstractC1932aR.A00(c2111dL, this.A01, abstractC2392hy.A20().A0H().A08());
    ...
    private void A01() {
        KE ke2 = new KE(this.A03, EnumC2133dh.A04.A03(), this.A02.A1z().A01(), this.A02.A20().A0J().A06(), this.A04, this.A06, null, this.A05, this.A02.A21());
