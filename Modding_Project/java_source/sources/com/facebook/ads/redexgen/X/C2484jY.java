...
public class C2484jY implements KW {
    ...
    public final /* synthetic */ C2483jX A04;
    public final C4I A03 = new C4I(new byte[5]);
    public final SparseArray<InterfaceC1502Kf> A01 = new SparseArray<>();
    ...
    */
    public final void A52(com.facebook.ads.redexgen.X.C4J r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C2484jY.A52(com.facebook.ads.redexgen.X.4J):void");
    }

    public C2484jY(C2483jX c2483jX, int i10) {
        this.A04 = c2483jX;
        this.A00 = i10;
    }

    private C1498Kb A00(C4J c4j, int i10) {
                ...
                if (positionOfNextDescriptor == 127) {
                    ...
                    if (positionOfNextDescriptor == 10) {
                        ...
                        while (c4j.A09() < A09) {
                            ...
                            c4j.A0k(bArr, 0, 4);
                            arrayList.add(new C1497Ka(trim, A0I, bArr));
                        }
        ...
        return new C1498Kb(i11, str, arrayList, Arrays.copyOfRange(c4j.A0l(), descriptorTag, descriptorLength));
    }
