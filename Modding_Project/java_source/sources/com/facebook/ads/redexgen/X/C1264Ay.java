...
public final class C1264Ay {
    ...
    public static final HashMap<C1260Au, List<AR>> A03;
    public static final Pattern A04;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static int A00() throws C1261Av {
        int i10 = A00;
        String[] strArr = A02;
        if (strArr[0].length() != strArr[2].length()) {
            ...
            if (i10 == -1) {
                ...
                if (A0J != null) {
                    ...
                    i11 = Math.max(i11, AbstractC10974a.A02 >= 21 ? 345600 : AdConfig.DEFAULT_PING_V2_EXPIRY_HIGH);
                }
                A00 = i11;
            }
            return A00;
    ...
    */
    ...
    public static /* synthetic */ int A08(AR ar2) {
        String str = ar2.A03;
        String name = A0N(TTVideoEngineInterface.PLAYER_OPTION_HW_ENABLE_DYNAMIC_FRAME_DROPPING, 10, 40);
    ...
    public static /* synthetic */ int A09(AR ar2) {
        return ar2.A03.startsWith(A0N(TTVideoEngineInterface.PLAYER_OPTION_HW_ENABLE_DYNAMIC_FRAME_DROPPING, 10, 40)) ? 1 : 0;
    }

    public static /* synthetic */ int A0A(InterfaceC1263Ax interfaceC1263Ax, Object obj, Object obj2) {
        return interfaceC1263Ax.A8o(obj2) - interfaceC1263Ax.A8o(obj);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> A0B(com.facebook.ads.redexgen.X.C2796or r8) {
        /*
            Method dump skipped, instructions count: 322
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1264Ay.A0B(com.facebook.ads.redexgen.X.or):android.util.Pair");
    }
    ...
    public static Pair<Integer, Integer> A0C(String str, String[] strArr) {
        ...
        try {
            ...
            if (A0N(1491, 15, 21).equals(AbstractC10522h.A05(objectTypeIndication))) {
    ...
    public static Pair<Integer, Integer> A0F(String str, String[] strArr) {
        int length = strArr.length;
        String A0N = A0N(MediaPlayer.MEDIA_PLAYER_OPTION_SOCKET_ERR_CODE, 37, 4);
        String A0N2 = A0N(615, 14, 80);
        if (length < 3) {
            AnonymousClass44.A07(A0N2, A0N + str);
            return null;
    ...
    */
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> A0G(java.lang.String r8, java.lang.String[] r9, com.facebook.ads.androidx.media3.common.ColorInfo r10) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1264Ay.A0G(java.lang.String, java.lang.String[], com.facebook.ads.androidx.media3.common.ColorInfo):android.util.Pair");
    }

    public static Pair<Integer, Integer> A0H(String str, String[] strArr, ColorInfo colorInfo) {
        int i10;
        int length = strArr.length;
        String A0N = A0N(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_MAX_CRYPTO_RETRANSMISSION_TIME_MS, 38, 48);
        String A0N2 = A0N(615, 14, 80);
        if (length < 4) {
            AnonymousClass44.A07(A0N2, A0N + str);
            return null;
        ...
        if (A02[7].length() != 25) {
            ...
            if (A0N(77, 1, 121).equals(group)) {
                ...
                AnonymousClass44.A07(A0N2, A0N(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_OPTIMIZE_HWDEC2SWDEC, 29, 106) + group);
                return null;
            }
            String[] strArr3 = A02;
            if (strArr3[6].charAt(8) == strArr3[5].charAt(8)) {
    ...
    public static AR A0I() throws C1261Av {
        return A0J(A0N(1506, 9, 92), false, false);
    }

    public static AR A0J(String str, boolean z10, boolean z11) throws C1261Av {
        List<AR> A0R = A0R(str, z10, z11);
        if (A0R.isEmpty()) {
            return null;
        }
        return A0R.get(0);
    ...
    */
    public static java.lang.Integer A0K(java.lang.String r11) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1264Ay.A0K(java.lang.String):java.lang.Integer");
    }
    ...
    */
    public static java.lang.Integer A0M(java.lang.String r12) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1264Ay.A0M(java.lang.String):java.lang.Integer");
    }
    ...
    public static String A0O(MediaCodecInfo mediaCodecInfo, String str, String str2) {
        ...
        if (str2.equals(A0N(1765, 18, 26))) {
            ...
            if (strArr[1].length() == strArr[3].length()) {
                ...
                strArr2[2] = "Am34";
                if (A0N(750, 21, 62).equals(str) || A0N(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_HWDROPFRAME_WHENAVOUTSYNCING, 34, 59).equals(str)) {
                    return A0N(1783, 13, 48);
                }
                return null;
            }
        } else if (str2.equals(A0N(1435, 10, 108)) && A0N(MediaPlayer.MEDIA_PLAYER_OPTION_COLOR_TRC, 20, 92).equals(str)) {
            ...
            if (strArr3[1].length() == strArr3[3].length()) {
                ...
                strArr4[2] = "oGjK";
                if (str2.equals(A0N(1469, 10, 50)) && A0N(MediaPlayer.MEDIA_PLAYER_OPTION_LIVE_ABR_SWITCH_FIND_STREAM_INFO_COST, 20, 50).equals(str)) {
    ...
    public static String A0P(C2796or c2796or) {
        Pair<Integer, Integer> codecProfileAndLevel;
        if (A0N(1455, 14, 98).equals(c2796or.A0W)) {
            ...
            if (A0N(1765, 18, 26).equals(c2796or.A0W) && (codecProfileAndLevel = A0B(c2796or)) != null) {
    ...
    public static synchronized List<AR> A0R(String str, boolean z10, boolean z11) throws C1261Av {
        InterfaceC1262Aw c2668mk;
        synchronized (C1264Ay.class) {
            C1260Au c1260Au = new C1260Au(str, z10, z11);
            List<AR> list = A03.get(c1260Au);
            if (list != null) {
                return list;
            }
            if (AbstractC10974a.A02 >= 21) {
                c2668mk = new C2666mi(z10, z11);
            } else {
                c2668mk = new C2668mk();
            }
            ArrayList<AR> A0Q = A0Q(c1260Au, c2668mk);
            if (z10 && A0Q.isEmpty() && 21 <= AbstractC10974a.A02 && AbstractC10974a.A02 <= 23) {
                A0Q = A0Q(c1260Au, new C2668mk());
                if (!A0Q.isEmpty()) {
                    AnonymousClass44.A07(A0N(615, 14, 80), A0N(564, 51, 61) + str + A0N(34, 12, 86) + A0Q.get(0).A03);
                }
            }
            A0T(str, A0Q);
            AbstractC1252Am A05 = AbstractC1252Am.A05(A0Q);
            A03.put(c1260Au, A05);
            return A05;
        }
    }
    ...
    */
    public static void A0T(java.lang.String r13, java.util.List<com.facebook.ads.redexgen.X.AR> r14) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1264Ay.A0T(java.lang.String, java.util.List):void");
    }
    ...
    public static <T> void A0U(List<T> list, final InterfaceC1263Ax<T> interfaceC1263Ax) {
        Collections.sort(list, new Comparator() { // from class: com.facebook.ads.redexgen.X.As
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return C1264Ay.A0A(InterfaceC1263Ax.this, obj, obj2);
            }
        });
    }

    public static boolean A0V(MediaCodecInfo mediaCodecInfo) {
        return AbstractC10974a.A02 >= 29 && A0W(mediaCodecInfo);
    }
    ...
    public static boolean A0Z(MediaCodecInfo mediaCodecInfo) {
        ...
        String A012 = AbstractC2426iY.A01(mediaCodecInfo.getName());
    ...
    public static boolean A0c(MediaCodecInfo mediaCodecInfo, String str) {
        if (AbstractC10974a.A02 >= 29) {
            ...
            throw new RuntimeException();
        } else if (AbstractC10522h.A0C(str)) {
            return true;
        } else {
            String A012 = AbstractC2426iY.A01(mediaCodecInfo.getName());
            String codecName = A0N(TTVideoEngineInterface.PLAYER_OPTION_BUFFER_PROCESS_COVERT_ORDER, 4, 110);
            if (A012.startsWith(codecName)) {
                return false;
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:107:0x0324, code lost:
        if (A0N(com.ss.ttm.player.MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_CHECK_UNBIND_AUDIOPROCESSOR, 6, 58).equals(r4) == false) goto L107;
     */
    /* JADX WARN: Code restructure failed: missing block: B:109:0x0335, code lost:
        if (A0N(1104, 5, 115).equals(com.facebook.ads.redexgen.X.AbstractC10974a.A03) == false) goto L112;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00c5, code lost:
        if (com.facebook.ads.redexgen.X.AbstractC10974a.A03.startsWith(A0N(com.ss.ttm.player.MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_TRAN_CONNECT_TIME, 2, 87)) != false) goto L32;
     */
    /* JADX WARN: Code restructure failed: missing block: B:63:0x01c7, code lost:
        if (A0N(1109, 6, 39).equals(com.facebook.ads.redexgen.X.AbstractC10974a.A03) != false) goto L65;
     */
    /* JADX WARN: Code restructure failed: missing block: B:78:0x0239, code lost:
        if (A0N(117, 5, 63).equals(com.facebook.ads.redexgen.X.AbstractC10974a.A03) != false) goto L80;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean A0d(android.media.MediaCodecInfo r8, java.lang.String r9, boolean r10, java.lang.String r11) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1264Ay.A0d(android.media.MediaCodecInfo, java.lang.String, boolean, java.lang.String):boolean");
    }
}
