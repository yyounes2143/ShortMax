...
public abstract class KL extends AbstractC1900Zv {
    ...
    public final AbstractC2392hy A07;
    public final N9 A08;
    public final O2 A09;
    public final C1752Ua A0A;
    ...
    public final C1570Mw A0R;
    public final C1572My A0S;
    public final C2111dL A0T;
    public final C1312Cw A0U;
    ...
    public static void A0Y() {
        A0Z = new byte[]{58, 18, 4, 2, 18, 60, 108, 103, 106, 121, 125, 96, 97, 80, 122, ByteCompanionObject.MAX_VALUE, 29, 28, 10, 26, 11, 16, 9, 13, 16, 22, 23, 126, 116, 120, 121, 30, 2, 15, 13, 11, 49, 6, 1, 2, 10, 11, 28, 49, 26, 11, 22, 26, 96, 98, ByteCompanionObject.MAX_VALUE, 119, 98, 117, 99, 99, 79, 114, 113, 98, 99, 116, 102, 112, 99, 117, 116, 117, 78, 103, 120, 117, 116, 126, 98, ByteCompanionObject.MAX_VALUE, 98, 122, 115, 107, 109, 126, 113, 108, 115, 126, 107, 118, 112, 113, 70};
    }
    ...
    static {
        A0Y();
        A0i = (int) (AbstractC1812Wl.A02 * 44.0f);
        A0b = (int) (AbstractC1812Wl.A02 * 52.0f);
        A0s = (int) (AbstractC1812Wl.A02 * 4.0f);
        A0u = (int) (AbstractC1812Wl.A02 * 8.0f);
        A0j = (int) (AbstractC1812Wl.A02 * 12.0f);
        A0k = (int) (AbstractC1812Wl.A02 * 14.0f);
        A0l = (int) (AbstractC1812Wl.A02 * 16.0f);
        A0m = (int) (AbstractC1812Wl.A02 * 18.0f);
        A0n = (int) (AbstractC1812Wl.A02 * 20.0f);
        A0o = (int) (AbstractC1812Wl.A02 * 24.0f);
        A0p = (int) (AbstractC1812Wl.A02 * 26.0f);
        A0q = (int) (AbstractC1812Wl.A02 * 28.0f);
        A0r = (int) (AbstractC1812Wl.A02 * 32.0f);
        A0t = (int) (AbstractC1812Wl.A02 * 40.0f);
        A0f = (int) (AbstractC1812Wl.A02 * 48.0f);
        A0g = (int) (AbstractC1812Wl.A02 * 100.0f);
        A0h = (int) (AbstractC1812Wl.A02 * 112.0f);
    ...
    public KL(C2111dL c2111dL, KE ke2, int i10, boolean z10, C1572My c1572My, boolean z11, String str, US us2, InterfaceC1840Xn interfaceC1840Xn, C2184eX c2184eX, XH xh2, AbstractC2392hy abstractC2392hy, C1312Cw c1312Cw, C1752Ua c1752Ua, boolean z12) {
        super(c2111dL, ke2, i10, c1572My, z11, str, us2, interfaceC1840Xn, c2184eX, xh2, abstractC2392hy.A21(), abstractC2392hy.A1c(), abstractC2392hy.A0x());
        this.A0W = new AtomicBoolean(true);
        this.A0V = new RunnableC1901Zw(this);
        this.A0D = new RunnableC1902Zx(this);
        this.A0C = new RunnableC1903Zy(this);
        this.A0A = c1752Ua;
        this.A07 = abstractC2392hy;
        this.A09 = O3.A00(c2111dL.A02());
        this.A0B = interfaceC1840Xn;
        this.A0E = abstractC2392hy.A25();
        this.A08 = abstractC2392hy.A23();
        this.A0S = c1572My;
        this.A0R = abstractC2392hy.A20().A0I();
        this.A0T = c2111dL;
        this.A0X = z10;
        this.A0Y = z12;
        ...
        if (!this.A0Y) {
            ...
            this.A0I.setOnClickListener(AbstractC1936aV.A03(super.A08, A0R(6, 10, 11)));
        }
        ...
        this.A0K = A0J();
        XP.A0I(this.A0K);
        this.A0K.setOnClickListener(new View$OnClickListenerC1904Zz(this));
        A0p(8);
        ...
        if (this.A07.A0v().equals(A0R(60, 14, 21)) && !abstractC2392hy.A1Z() && this.A06 > 0) {
            this.A04 = A0O();
            XP.A0I(this.A04);
        }
    ...
    private C1312Cw A0Q(C1312Cw c1312Cw) {
        if (c1312Cw == null) {
            c1312Cw = new C1312Cw(this.A0T, -1);
            c1312Cw.setVisibility(8);
        }
        c1312Cw.A08(A0e, A0d, true);
        c1312Cw.setPadding(0, 0, 0, 0);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, A0v);
        c1312Cw.setLayoutParams(progressBarLayoutParams);
        return c1312Cw;
    }
    ...
    public final void A0g() {
        super.A09.setOnClickListener(AbstractC1936aV.A03(super.A08, A0R(27, 4, 19)));
        this.A0Q.setOnClickListener(AbstractC1936aV.A03(super.A08, A0R(74, 5, 18)));
        this.A0P.setOnClickListener(AbstractC1936aV.A03(super.A08, A0R(16, 11, 125)));
        this.A0U.setOnClickListener(AbstractC1936aV.A03(super.A08, A0R(48, 12, 20)));
        if (this.A04 != null) {
            this.A04.setOnClickListener(AbstractC1936aV.A03(super.A08, A0R(31, 17, 106)));
        }
    }
    ...
    public C1312Cw getProgressBarAnimation() {
        return this.A0U;
    }
    ...
    public void setPlaceHolderTextForRewardsConversion(String str) {
        if (this.A04 != null) {
            ...
            textView.setOnClickListener(AbstractC1936aV.A03(super.A08, A0R(31, 17, 106)));
        }
    }
}
