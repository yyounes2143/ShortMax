...
public final class Z4 extends ImageView {
    ...
    public Z4(C2111dL c2111dL, final Handler handler, Z6 z62, final int i10, final View.OnClickListener onClickListener) {
        super(c2111dL);
        ...
        setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.Z2
            ...
            public final void onClick(View view) {
                Z4.this.A02(onClickListener, handler, i10, view);
            }
        });
    }
