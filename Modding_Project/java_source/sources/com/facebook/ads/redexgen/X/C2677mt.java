...
public final class C2677mt implements AnonymousClass38 {
    public long A03;
    public long A04;
    public C8w A09;
    public boolean A0D;
    ...
    public final long A00(long j10) {
        if (this.A04 >= RealWebSocket.DEFAULT_MINIMUM_DEFLATE_SIZE) {
            ...
            if (this.A06.A03 == this.A05.A03) {
                long processedInputBytes = AbstractC10974a.A0U(j10, A0I, this.A04);
            ...
            return AbstractC10974a.A0U(j10, j11, j12 * processedInputBytes3);
        }
