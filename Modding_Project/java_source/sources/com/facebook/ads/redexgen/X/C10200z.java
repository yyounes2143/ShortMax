...
public final class C10200z extends C9Z implements Handler.Callback {
    ...
    public long A04;
    public C2796or A05;
    public InterfaceC2535kN A06;
    public C11847j A07;
    public AbstractC11837i A08;
    public AbstractC11837i A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    public final Handler A0D;
    public final C6N A0E;
    public final InterfaceC1329Dn A0F;
    public final InterfaceC1332Dq A0G;
    ...
    public static void A09() {
        A0H = new byte[]{89, ByteCompanionObject.MAX_VALUE, 104, 126, 99, 126, 102, 111, 42, 110, 111, 105, 101, 110, 99, 100, 109, 42, 108, 107, 99, 102, 111, 110, 36, 42, 121, 126, 120, 111, 107, 103, 76, 101, 120, 103, 107, 126, 55, 57, 8, 21, 25, 63, 8, 3, 9, 8, 31, 8, 31};
    }
    ...
    public C10200z(InterfaceC1332Dq interfaceC1332Dq, Looper looper, InterfaceC1329Dn interfaceC1329Dn) {
        super(3);
        this.A0G = (InterfaceC1332Dq) C3M.A01(interfaceC1332Dq);
        this.A0D = looper == null ? null : AbstractC10974a.A0c(looper, this);
        this.A0F = interfaceC1329Dn;
        this.A0E = new C6N();
    ...
    private void A04() {
        A0B(new C2745o0(C2393i1.A01(), A02(this.A03)));
    }

    private void A05() {
        this.A0C = true;
        this.A06 = this.A0F.A5C((C2796or) C3M.A01(this.A05));
    }
    ...
    private void A07() {
        A06();
        ((InterfaceC2535kN) C3M.A01(this.A06)).AGr();
        this.A06 = null;
        this.A00 = 0;
    }
    ...
    private void A0A(C2745o0 c2745o0) {
        this.A0G.ACw(c2745o0.A01);
        this.A0G.ACv(c2745o0);
    }

    private void A0B(C2745o0 c2745o0) {
        if (this.A0D != null) {
            this.A0D.obtainMessage(0, c2745o0).sendToTarget();
        } else {
            A0A(c2745o0);
        }
    }
    ...
    private void A0C(C1331Dp c1331Dp) {
        if (this.A0D != null) {
            this.A0D.obtainMessage(1, c1331Dp).sendToTarget();
        }
    }

    private void A0D(C2534kM c2534kM) {
        AnonymousClass44.A08(A03(39, 12, 23), A03(0, 39, 112) + this.A05, c2534kM);
        A0C(new C1331Dp(this.A05, c2534kM));
        A04();
        A08();
    }
    ...
    public final void A1a(long j10, boolean z10) {
        ...
        A06();
        ((InterfaceC2535kN) C3M.A01(this.A06)).flush();
    }

    @Override // com.facebook.ads.redexgen.X.C9Z
    public final void A1c(C2796or[] c2796orArr, long j10, long j11) {
        this.A04 = j11;
        this.A05 = c2796orArr[0];
        if (this.A06 != null) {
            this.A00 = 1;
        } else {
            A05();
    ...
    */
    public final void AHn(long r10, long r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C10200z.AHn(long, long):void");
    }

    @Override // com.facebook.ads.redexgen.X.C7D
    public final int AJb(C2796or c2796or) {
        if (this.A0F.AJc(c2796or)) {
            return AnonymousClass76.A00(4);
        }
        if (AbstractC10522h.A0E(c2796or.A0W)) {
