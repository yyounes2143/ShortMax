...
public final class RH implements MediaViewVideoRendererApi {
    ...
    public final DP A0C = new DP() { // from class: com.facebook.ads.redexgen.X.6d
        ...
        public final void A03(DQ dq2) {
            MediaViewVideoRenderer mediaViewVideoRenderer;
            if (RH.this.A08 != null) {
                C1652Qc.A0L(RH.this.A08.getInternalNativeAd()).A1f(true, true);
            }
            mediaViewVideoRenderer = RH.this.A00;
    ...
    public final DV A0A = new DV() { // from class: com.facebook.ads.redexgen.X.6T
        ...
        public final void A03(DW dw) {
            MediaViewVideoRenderer mediaViewVideoRenderer;
            if (RH.this.A08 != null) {
                C1652Qc.A0L(RH.this.A08.getInternalNativeAd()).A1f(false, true);
            }
            mediaViewVideoRenderer = RH.this.A00;
    ...
    public final void A03() {
        ...
        if (this.A08 != null) {
            C1652Qc.A0L(this.A08.getInternalNativeAd()).A1f(false, false);
        }
        this.A08 = null;
        if (this.A04 != null) {
            InterfaceC1764Um interfaceC1764Um = this.A04;
            if (A0H[6].length() != 3) {
                throw new RuntimeException();
            }
            A0H[6] = "qaG";
            interfaceC1764Um.AJn();
        }
    }

    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C2111dL A12 = ((C1652Qc) nativeAd.getInternalNativeAd()).A12();
        C2111dL adObjectContext = this.A03;
        adObjectContext.A0L(A12);
        RK rk2 = (RK) nativeAd.getNativeAdApi();
        this.A05.setClientToken(C1652Qc.A0L(nativeAd.getInternalNativeAd()).A1C());
        this.A05.setVideoMPD(rk2.A01());
        this.A05.setVideoURI(rk2.A02());
        C2415iN A0z = C1652Qc.A0L(nativeAd.getInternalNativeAd()).A0z();
        if (A0z != null) {
    ...
    public final void A06(InterfaceC1764Um interfaceC1764Um) {
        this.A04 = interfaceC1764Um;
    }
    ...
    public final void engageSeek() {
        ...
        this.A06 = true;
        this.A07 = EnumC2181eU.A0A.equals(this.A05.getState());
    ...
    public final boolean shouldAutoplay() {
        if (this.A05 == null || this.A05.getState() == EnumC2181eU.A06) {
            return false;
        }
