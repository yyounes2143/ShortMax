...
public abstract class AbstractC1593Nt {
    ...
    public static Bundle A01(SQ sq2) {
        ...
        if (adTypeString != null) {
            bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_HTTP_REQ_FINSIH_TIME, 20, 120), adTypeString);
        }
        ...
        bundle.putBoolean(A06(54, 13, 2), C1813Wm.A05(sq2));
        return bundle;
    }

    public static Bundle A02(String str, C2328gv c2328gv) {
        Bundle bundle = new Bundle();
        A08(bundle, c2328gv.A05());
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_CMAF_MPD_PACKET_RECV_TIME, 17, 16), c2328gv.A0A());
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RANGE_TIME, 13, 76), str);
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_GET_CACHE_TIMESTAMP, 19, 18), c2328gv.A07());
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_LAST_VIDEO_DECODE_TIME, 19, 0), c2328gv.A08());
        bundle.putString(A06(404, 22, 98), c2328gv.A09());
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DEMUXER_STALL_500, 19, 96), AbstractC1589Np.A01(c2328gv.A0B()));
        RewardData A03 = c2328gv.A03();
        if (A03 != null) {
            AbstractC1594Nu.A00(bundle, A03);
        }
        C2111dL A05 = c2328gv.A05();
        if (A01[7].charAt(1) != 'G') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
    ...
    public static Bundle A03(String str, C2319gm c2319gm) {
        Bundle bundle = new Bundle();
        A08(bundle, c2319gm.A0B);
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_CMAF_MPD_PACKET_RECV_TIME, 17, 16), c2319gm.A0D);
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RANGE_TIME, 13, 76), str);
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_GET_CACHE_TIMESTAMP, 19, 18), c2319gm.A05);
        bundle.putString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_LAST_VIDEO_DECODE_TIME, 19, 0), c2319gm.A06);
        bundle.putString(A06(404, 22, 98), c2319gm.A07);
        AdExperienceType adExperienceType = c2319gm.A02;
        if (adExperienceType != null) {
            bundle.putString(A06(VideoRef.VALUE_VIDEO_REF_PALLAS_VID_LABELS, 22, 24), AbstractC1588No.A02(adExperienceType));
        }
        bundle.putBoolean(A06(90, 33, 27), c2319gm.A08);
        RewardData rewardData = c2319gm.A03;
        if (rewardData != null) {
            AbstractC1594Nu.A00(bundle, rewardData);
        }
        bundle.putBundle(A06(123, 19, 81), A01(c2319gm.A0B));
        return bundle;
    }

    public static C2328gv A04(C2111dL c2111dL, Bundle bundle, String str) {
        String string = bundle.getString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_CMAF_MPD_PACKET_RECV_TIME, 17, 16));
        String placement = A06(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_GET_CACHE_TIMESTAMP, 19, 18);
        String string2 = bundle.getString(placement);
        String placement2 = A06(MediaPlayer.MEDIA_PLAYER_OPTION_LAST_VIDEO_DECODE_TIME, 19, 0);
        ...
        C2328gv c2328gv = new C2328gv(c2111dL, null, string, new C2323gq(str, string4, bundle2));
        c2328gv.A0I(string3);
        c2328gv.A0H(string2);
        c2328gv.A0J(sdkVersion);
        String placement6 = A06(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DEMUXER_STALL_500, 19, 96);
        c2328gv.A0K(AbstractC1589Np.A02(bundle.getString(placement6)));
        RewardData A012 = AbstractC1594Nu.A01(bundle);
        if (A012 != null) {
            c2328gv.A0F(A012);
        }
        return c2328gv;
    ...
    public static C2319gm A05(C2111dL c2111dL, Bundle bundle, String str) {
        String string = bundle.getString(A06(MediaPlayer.MEDIA_PLAYER_OPTION_CMAF_MPD_PACKET_RECV_TIME, 17, 16));
        String rvPlacement = A06(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_GET_CACHE_TIMESTAMP, 19, 18);
        String string2 = bundle.getString(rvPlacement);
        String rvPlacement2 = A06(90, 33, 27);
        boolean z10 = bundle.getBoolean(rvPlacement2);
        String rvPlacement3 = A06(MediaPlayer.MEDIA_PLAYER_OPTION_LAST_VIDEO_DECODE_TIME, 19, 0);
        ...
        String rvPlacement5 = A06(VideoRef.VALUE_VIDEO_REF_PALLAS_VID_LABELS, 22, 24);
        ...
        C2319gm c2319gm = new C2319gm(c2111dL, string, null, new C2323gq(str, string4, bundle2));
        c2319gm.A06 = adExperienceType;
        c2319gm.A05 = string2;
        c2319gm.A08 = z10;
        c2319gm.A02 = AbstractC1588No.A00(string3);
        c2319gm.A07 = mediationData;
        RewardData A012 = AbstractC1594Nu.A01(bundle);
        if (A012 != null) {
            c2319gm.A03 = A012;
        }
    ...
    public static void A08(Bundle bundle, SQ sq2) {
        ...
        boolean z10 = false;
        boolean isForcedFunnelLogging = sq2 instanceof C2111dL;
        if (isForcedFunnelLogging) {
            z10 = ((C2111dL) sq2).A0F().AAK();
        }
        boolean isForcedFunnelLogging2 = C1716Sp.A0I(sq2);
        bundle.putBoolean(A06(33, 21, 55), isForcedFunnelLogging2 || z10);
        bundle.putString(A06(330, 14, 30), sq2.getPackageName());
        boolean isForcedFunnelLogging3 = UA.A0G(sq2);
