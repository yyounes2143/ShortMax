...
public class C2529kH<V> extends AbstractCollection<V> {
    ...
    @CheckForNull
    public final C2529kH A01;
    @ParametricNullness
    public final K A02;
    @CheckForNull
    public final Collection<V> A03;
    public final /* synthetic */ AbstractC10291i A04;
    ...
    public final boolean addAll(Collection<? extends V> collection) {
        ...
        if (addAll) {
            AbstractC10291i.A02(this.A04, this.A00.size() - size);
            if (size == 0) {
                A03();
            }
        }
    ...
    public C2529kH(@ParametricNullness final AbstractC10291i this$0, @CheckForNull Object key, Collection delegate, C2529kH ancestor) {
        this.A04 = this$0;
        this.A02 = key;
        this.A00 = delegate;
        this.A01 = ancestor;
    ...
    public final void clear() {
        ...
        this.A00.clear();
        AbstractC10291i.A03(this.A04, size);
        A05();
    }
    ...
    public final boolean retainAll(Collection<?> c10) {
        AbstractC2461jA.A04(c10);
        int size = size();
        boolean retainAll = this.A00.retainAll(c10);
        if (retainAll) {
            int size2 = this.A00.size();
            AbstractC10291i abstractC10291i = this.A04;
            int i10 = size2 - size;
            String[] strArr = A05;
            String str = strArr[0];
            ...
            AbstractC10291i.A02(abstractC10291i, i10);
            A05();
        }
        return retainAll;
    }
