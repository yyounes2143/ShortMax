...
public final class C2328gv implements SN {
    public long A00;
    ...
    public C2328gv(C2111dL c2111dL, InterstitialAd interstitialAd, String str) {
        this(c2111dL, interstitialAd, str, new C2343hB());
    }

    public C2328gv(C2111dL c2111dL, InterstitialAd interstitialAd, String str, TL tl2) {
        this.A0A = c2111dL;
        this.A0B = str;
