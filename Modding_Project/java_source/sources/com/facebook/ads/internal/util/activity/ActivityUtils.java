...
import com.facebook.ads.redexgen.X.AbstractC1722Sv;
import com.facebook.ads.redexgen.X.C1723Sw;
import com.facebook.ads.redexgen.X.C2085cu;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
     ...
     */
    public static synchronized void A04(C2085cu c2085cu, Class<? extends Activity> cls) {
        synchronized (ActivityUtils.class) {
            A02 = c2085cu;
            A01 = c2085cu.getApplicationContext();
                ...
                if (aNActivityLifecycleCallbacksListener != null) {
                    ...
                    synchronized (activityStateMap) {
                        try {
                            ...
                            c2085cu.A08().AAy(A01(208, 8, 61), AbstractC1722Sv.A02, new C1723Sw(A01(72, 80, 65)));
                        }
                    }
                    ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c2085cu);
                }
                ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
            } else {
                c2085cu.A08().AAy(A01(216, 3, 3), AbstractC1722Sv.A0d, new C1723Sw(A01(42, 30, 126)));
            }
        }
    }
    ...
    */
    public static synchronized android.app.Activity A00() {
        ...
        L41:
            ...
            int r1 = com.facebook.ads.redexgen.X.AbstractC1722Sv.A03     // Catch: java.lang.Throwable -> La0
    ...
    public static void A03(C2111dL c2111dL) {
        if (!U7.A1k(c2111dL) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        WC wc2 = new WC(c2111dL);
        synchronized (A07) {
            A07.add(wc2);
        }
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (num == null || num.intValue() != 3) {
            C1723Sw c1723Sw = new C1723Sw(A01(172, 31, 79), A01(152, 20, 101) + num + A01(0, 12, 105) + activity);
            c1723Sw.A05(0);
            A02.A08().AAy(A01(208, 8, 61), AbstractC1722Sv.A03, c1723Sw);
        }
        A08.put(activity, 4);
