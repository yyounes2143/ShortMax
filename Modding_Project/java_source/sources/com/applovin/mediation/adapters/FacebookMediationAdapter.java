...
public class FacebookMediationAdapter extends MediationAdapterBase implements MaxInterstitialAdapter, MaxRewardedAdapter, MaxAdViewAdapter, MaxSignalProvider {
    ...
    private class AdViewListener implements AdListener {
        ...
        public void onAdClicked(Ad ad2) {
            ...
            facebookMediationAdapter.log(this.adFormat.getLabel() + " ad clicked: " + ad2.getPlacementId());
        ...
        public void onAdLoaded(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log(this.adFormat.getLabel() + " ad loaded: " + ad2.getPlacementId());
        ...
        public void onError(Ad ad2, AdError adError) {
            ...
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log(this.adFormat.getLabel() + " ad (" + ad2.getPlacementId() + ") failed to load with error (" + maxError);
        ...
        public void onLoggingImpression(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log(this.adFormat.getLabel() + " ad displayed: " + ad2.getPlacementId());
    ...
    private class MaxNativeAdListener implements NativeAdListener {
        ...
        public void onAdClicked(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native clicked: " + ad2.getPlacementId());
        ...
        public void onAdLoaded(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native ad loaded: " + ad2.getPlacementId());
        ...
        public void onError(Ad ad2, AdError adError) {
            MaxAdapterError maxError = FacebookMediationAdapter.toMaxError(adError);
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native ad (" + ad2.getPlacementId() + ") failed to load with error (" + maxError);
        ...
        public void onLoggingImpression(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native shown: " + ad2.getPlacementId());
        ...
        public void onMediaDownloaded(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native ad successfully downloaded media: " + ad2.getPlacementId());
        }
    }
    ...
    private class NativeAdViewListener implements NativeAdListener {
        ...
        NativeAdViewListener(Bundle bundle, MaxAdFormat maxAdFormat, @Nullable Activity activity, MaxAdViewAdapterListener maxAdViewAdapterListener) {
            this.serverParameters = bundle;
        ...
        public void onAdClicked(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native " + this.adFormat.getLabel() + " clicked: " + ad2.getPlacementId());
            this.listener.onAdViewAdClicked();
        }
        ...
        public void onAdLoaded(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native " + this.adFormat.getLabel() + " ad loaded: " + ad2.getPlacementId());
        ...
        public void onError(Ad ad2, AdError adError) {
            MaxAdapterError maxError = FacebookMediationAdapter.toMaxError(adError);
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native " + this.adFormat.getLabel() + " ad (" + ad2.getPlacementId() + ") failed to load with error: " + maxError);
            this.listener.onAdViewAdLoadFailed(maxError);
        }
        ...
        public void onLoggingImpression(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native " + this.adFormat.getLabel() + " shown: " + ad2.getPlacementId());
            this.listener.onAdViewAdDisplayed();
        }
        ...
        public void onMediaDownloaded(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Native " + this.adFormat.getLabel() + " successfully downloaded media: " + ad2.getPlacementId());
        }
    }
    ...
    private class RewardedAdListener implements RewardedVideoAdExtendedListener {
        ...
        public void onAdClicked(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Rewarded ad clicked: " + ad2.getPlacementId());
        ...
        public void onAdLoaded(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Rewarded ad loaded: " + ad2.getPlacementId());
        ...
        public void onError(Ad ad2, AdError adError) {
            MaxAdapterError maxError = FacebookMediationAdapter.toMaxError(adError);
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Rewarded ad (" + ad2.getPlacementId() + ") failed to load with error (" + maxError);
        ...
        public void onLoggingImpression(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Rewarded ad logging impression: " + ad2.getPlacementId());
    ...
    private class InterstitialAdListener implements InterstitialAdExtendedListener {
        ...
        public void onAdClicked(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Interstitial ad clicked: " + ad2.getPlacementId());
        ...
        public void onAdLoaded(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Interstitial ad loaded: " + ad2.getPlacementId());
        ...
        public void onError(Ad ad2, AdError adError) {
            MaxAdapterError maxError = FacebookMediationAdapter.toMaxError(adError);
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Interstitial ad (" + ad2.getPlacementId() + ") failed to load with error: " + maxError);
        ...
        public void onInterstitialDismissed(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Interstitial ad hidden: " + ad2.getPlacementId());
            if (FacebookMediationAdapter.this.onInterstitialAdHiddenCalled.compareAndSet(false, true)) {
                this.listener.onInterstitialAdHidden();
            }
        }
        ...
        public void onInterstitialDisplayed(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Interstitial ad displayed: " + ad2.getPlacementId());
        }

        @Override // com.facebook.ads.AdListener
        public void onLoggingImpression(Ad ad2) {
            FacebookMediationAdapter facebookMediationAdapter = FacebookMediationAdapter.this;
            facebookMediationAdapter.log("Interstitial ad logging impression: " + ad2.getPlacementId());
