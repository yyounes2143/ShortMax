...
public final class Path implements Comparable<Path> {
    ...
    public final Path getRoot() {
        int access$rootLength = com.applovin.shadow.okio.internal.Path.access$rootLength(this);
    ...
    public final boolean isAbsolute() {
        if (com.applovin.shadow.okio.internal.Path.access$rootLength(this) != -1) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isRoot() {
        if (com.applovin.shadow.okio.internal.Path.access$rootLength(this) == getBytes$okio().size()) {
            return true;
        }
        return false;
    }
    ...
    public final ByteString nameBytes() {
        int access$getIndexOfLastSlash = com.applovin.shadow.okio.internal.Path.access$getIndexOfLastSlash(this);
    ...
    public final Path parent() {
        Path path;
        if (Intrinsics.areEqual(getBytes$okio(), com.applovin.shadow.okio.internal.Path.access$getDOT$p()) || Intrinsics.areEqual(getBytes$okio(), com.applovin.shadow.okio.internal.Path.access$getSLASH$p()) || Intrinsics.areEqual(getBytes$okio(), com.applovin.shadow.okio.internal.Path.access$getBACKSLASH$p()) || com.applovin.shadow.okio.internal.Path.access$lastSegmentIsDotDot(this)) {
            return null;
        }
        int access$getIndexOfLastSlash = com.applovin.shadow.okio.internal.Path.access$getIndexOfLastSlash(this);
        if (access$getIndexOfLastSlash == 2 && volumeLetter() != null) {
        ...
        } else if (access$getIndexOfLastSlash == 1 && getBytes$okio().startsWith(com.applovin.shadow.okio.internal.Path.access$getBACKSLASH$p())) {
            return null;
        } else {
            if (access$getIndexOfLastSlash == -1 && volumeLetter() != null) {
                ...
                return new Path(com.applovin.shadow.okio.internal.Path.access$getDOT$p());
            } else {
    ...
    public final Path relativeTo(@NotNull Path other) {
        ...
        if (Intrinsics.areEqual(getRoot(), other.getRoot())) {
            ...
            if (segmentsBytes2.subList(i10, segmentsBytes2.size()).indexOf(com.applovin.shadow.okio.internal.Path.access$getDOT_DOT$p()) == -1) {
                Buffer buffer = new Buffer();
                ByteString access$getSlash = com.applovin.shadow.okio.internal.Path.access$getSlash(other);
                if (access$getSlash == null && (access$getSlash = com.applovin.shadow.okio.internal.Path.access$getSlash(this)) == null) {
                    access$getSlash = com.applovin.shadow.okio.internal.Path.access$toSlash(DIRECTORY_SEPARATOR);
                }
                int size = segmentsBytes2.size();
                for (int i11 = i10; i11 < size; i11++) {
                    buffer.write(com.applovin.shadow.okio.internal.Path.access$getDOT_DOT$p());
    ...
    public final Character volumeLetter() {
        if (ByteString.indexOf$default(getBytes$okio(), com.applovin.shadow.okio.internal.Path.access$getSLASH$p(), 0, 2, (Object) null) != -1 || getBytes$okio().size() < 2 || getBytes$okio().getByte(1) != 58) {
            return null;
        }
