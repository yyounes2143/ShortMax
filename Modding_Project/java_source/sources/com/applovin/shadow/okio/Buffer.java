...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m4603deprecated_getByte(long j10) {
        return getByte(j10);
    }

    @ms.c
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m4604deprecated_size() {
        return this.size;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00df, code lost:
        throw new java.lang.NumberFormatException(r1 + " but was 0x" + com.applovin.shadow.okio.SegmentedByteString.toHexString(getByte(0)));
     */
    ...
    */
    ...
    public Buffer writeDecimalLong(long j10) {
        ...
        while (j10 != 0) {
            long j11 = 10;
            i12--;
            bArr[i12] = com.applovin.shadow.okio.internal.Buffer.getHEX_DIGIT_BYTES()[(int) (j10 % j11)];
            j10 /= j11;
        }
        if (z10) {
            bArr[i12 - 1] = 45;
    ...
    public int read(@NotNull byte[] sink, int i10, int i11) {
        ...
        byte[] bArr = segment.data;
        int i12 = segment.pos;
        kotlin.collections.n.h(bArr, sink, i10, i12, i12 + min);
        segment.pos += min;
    ...
    public Buffer write(@NotNull byte[] source, int i10, int i11) {
        ...
        while (i10 < i12) {
            ...
            int i13 = i10 + min;
            kotlin.collections.n.h(source, writableSegment$okio.data, writableSegment$okio.limit, i10, i13);
            writableSegment$okio.limit += min;
            i10 = i13;
        }
                ...
                if (segment != null) {
                    if (size() - j11 < j11) {
                        ...
                        while (j12 < size2) {
                            ...
                            while (i10 < min) {
                                if (bArr[i10] == b10 && com.applovin.shadow.okio.internal.Buffer.rangeEquals(segment, i10 + 1, internalArray$okio, 1, size)) {
                                    return (i10 - segment.pos) + j12;
                                }
                                i10++;
                            }
                        ...
                        while (j12 < size4) {
                            ...
                            i10 = (int) ((segment.pos + j11) - j12);
                            while (i10 < min2) {
                                if (bArr2[i10] == b11 && com.applovin.shadow.okio.internal.Buffer.rangeEquals(segment, i10 + 1, internalArray$okio2, 1, size3)) {
                                    return (i10 - segment.pos) + j12;
                                }
                                i10++;
                            }
