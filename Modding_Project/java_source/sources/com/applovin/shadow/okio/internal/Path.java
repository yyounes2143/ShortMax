...
public final class Path {
    ...
    public static final boolean commonEquals(@NotNull com.applovin.shadow.okio.Path path, @Nullable Object obj) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        if ((obj instanceof com.applovin.shadow.okio.Path) && Intrinsics.areEqual(((com.applovin.shadow.okio.Path) obj).getBytes$okio(), path.getBytes$okio())) {
            return true;
        }
        return false;
    }
            ...
            if (indexOfLastSlash == 2 && path.volumeLetter() != null) {
                ...
                if (indexOfLastSlash == -1 && path.volumeLetter() != null) {
                    ...
                    if (indexOfLastSlash == 0) {
                        return new com.applovin.shadow.okio.Path(ByteString.substring$default(path.getBytes$okio(), 0, 1, 1, null));
                    }
                    return new com.applovin.shadow.okio.Path(ByteString.substring$default(path.getBytes$okio(), 0, indexOfLastSlash, 1, null));
                }
            }
        }
        return null;
    ...
    public static final com.applovin.shadow.okio.Path commonRoot(@NotNull com.applovin.shadow.okio.Path path) {
        ...
        return new com.applovin.shadow.okio.Path(path.getBytes$okio().substring(0, rootLength));
    }
    ...
    @NotNull
    public static final com.applovin.shadow.okio.Path toPath(@NotNull Buffer buffer, boolean z10) {
