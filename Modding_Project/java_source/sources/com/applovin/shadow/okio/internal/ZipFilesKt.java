...
public final class ZipFilesKt {
    ...
    private static final Map<Path, ZipEntry> buildIndex(List<ZipEntry> list) {
        ...
        for (ZipEntry zipEntry : CollectionsKt.U0(list, new Comparator() { // from class: com.applovin.shadow.okio.internal.ZipFilesKt$buildIndex$$inlined$sortedBy$1
        ...
        if (bufferedSource.readIntLe() == CENTRAL_FILE_HEADER_SIGNATURE) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                if (!StringsKt.a0(readUtf8, (char) 0, false, 2, null)) {
                    ...
                    readExtra(bufferedSource, readShortLe3, new Function2<Integer, Long, Unit>() { // from class: com.applovin.shadow.okio.internal.ZipFilesKt$readEntry$1
    ...
    private static final FileMetadata readOrSkipLocalHeader(final BufferedSource bufferedSource, FileMetadata fileMetadata) {
        ...
        if (bufferedSource.readIntLe() == LOCAL_FILE_HEADER_SIGNATURE) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                readExtra(bufferedSource, readShortLe3, new Function2<Integer, Long, Unit>() { // from class: com.applovin.shadow.okio.internal.ZipFilesKt$readOrSkipLocalHeader$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(2);
