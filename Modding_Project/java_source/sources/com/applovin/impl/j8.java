...
public class j8 extends r4 {
    ...
    private final com.applovin.impl.sdk.o f8207a;

    /* renamed from: b  reason: collision with root package name */
    private WeakReference f8208b;
    ...
    private void a(WebView webView, String str) {
        if (com.applovin.impl.sdk.o.a()) {
            com.applovin.impl.sdk.o oVar = this.f8207a;
        ...
        if ("applovin".equalsIgnoreCase(scheme) && AppLovinMediationAdapter.APPLOVIN_SDK_ERROR_DOMAIN.equalsIgnoreCase(host) && aVar != null) {
            if ("/track_click".equals(path)) {
                ...
                if (com.applovin.impl.sdk.o.a()) {
                    com.applovin.impl.sdk.o oVar2 = this.f8207a;
                    oVar2.k("WebViewButtonClient", "Unknown URL: " + str);
                }
                if (com.applovin.impl.sdk.o.a()) {
                    com.applovin.impl.sdk.o oVar3 = this.f8207a;
