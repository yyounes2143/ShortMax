...
public class ArrayService extends IAppHubDirectDownloadServiceCallback.Stub {
    ...
    public ArrayService(final k kVar) {
        ...
        this.minVersionCodeWithGenericEventsSupport = ((Integer) kVar.a(v4.f10217c0)).intValue();
    ...
    public void collectAppHubData() {
        ...
        if (TextUtils.isEmpty(this.randomUserToken) && ((Boolean) this.sdk.a(v4.f10200a0)).booleanValue()) {
    ...
    public void maybeSendAdEvent(v2 v2Var, String str) {
        ...
        if (!((Boolean) this.sdk.a(v4.f10208b0)).booleanValue() || (iAppHubService = this.appHubService) == null || !t3.b(v2Var)) {
            return;
        }
        if (o.a()) {
            o oVar = this.logger;
            oVar.a(TAG, "Sending ad event: " + str + " for ad: " + v2Var);
        }
        Bundle bundle = new Bundle();
        ...
        try {
            ...
            if (o.a()) {
                o oVar2 = this.logger;
                oVar2.a(TAG, "Failed to send ad event: " + str, th2);
            }
    ...
    public void onError(String str, String str2) {
        ...
        this.sdk.E().d(c2.f7673v0, healthEventExtraParameters);
        DirectDownloadState directDownloadState = this.currentDownloadState;
        if (directDownloadState == null) {
            return;
        }
