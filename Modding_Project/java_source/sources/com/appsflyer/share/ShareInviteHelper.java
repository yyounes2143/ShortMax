...
public class ShareInviteHelper {
    public static LinkGenerator generateInviteUrl(Context context) {
        ...
        AFa1ySDK aFa1ySDK = (AFa1ySDK) appsFlyerLib;
        LinkGenerator addParameter = new LinkGenerator("af_app_invites").setBaseURL(string, string2, context.getPackageName()).setReferrerUID(appsFlyerUID).setReferrerCustomerId(AFa1ySDK.getMediationNetwork()).addParameter("af_siteid", context.getPackageName());
