...
public class AppsFlyerProperties {
    ...
    public String getReferrer(AFc1qSDK aFc1qSDK) {
        ...
        return aFc1qSDK.getMonetizationNetwork(Constants.REFERRER, (String) null);
    }
            ...
            if (monetizationNetwork != null) {
                ...
                try {
                    ...
                    for (int i10 = 0; i10 < 5; i10++) {
                        this.getMediationNetwork.remove(strArr[i10]);
                    }
    ...
    public synchronized void set(String str, int i10) {
        this.getMediationNetwork.put(str, Integer.toString(i10));
    }
