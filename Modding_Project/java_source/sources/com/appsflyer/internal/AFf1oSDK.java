...
public final class AFf1oSDK extends AFf1sSDK {
    ...
    */
    ...
    public static /* synthetic */ Object getCurrencyIso4217Code(Object[] objArr, int i10, int i11, int i12) {
        int i13 = (i10 * TTVideoEngineInterface.PLAYER_OPTION_UPDATE_TIMESTAMP_MODE) + (i11 * (-493));
        int i14 = ~i11;
        int i15 = i13 + ((i10 | i14) * (-988));
        int i16 = ~i10;
        int i17 = ~i12;
        return (i15 + (((i11 | i16) | i17) * TTVideoEngineInterface.PLAYER_OPTION_ENABLE_ABR)) + (((~(i10 | i11)) | ((~(i17 | i11)) | (~(i14 | i16)))) * TTVideoEngineInterface.PLAYER_OPTION_ENABLE_ABR) != 1 ? getMonetizationNetwork(objArr) : getMediationNetwork(objArr);
    }
        ...
        if (context != null) {
            if (!revenue.getCurrencyIso4217Code()) {
                try {
                    ...
                    aFh1mSDK.getMonetizationNetwork(TTVideoEngineInterface.PLAY_API_KEY_APPNAME, aFf1oSDK.s_(context.getPackageManager()));
                ...
                aFh1mSDK.getMonetizationNetwork(CommonConstant.KEY_UID, AFb1kSDK.getCurrencyIso4217Code(aFf1oSDK.hashCode.getMediationNetwork));
