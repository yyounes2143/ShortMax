...
public final class AFc1bSDK implements AFd1zSDK {
    ...
    private AFj1cSDK f10922d;

    /* renamed from: e  reason: collision with root package name */
    private AFb1aSDK f10923e;
    ...
    private synchronized AFj1cSDK getPurchaseToken() {
        try {
            if (this.f10922d == null) {
                this.f10922d = new AFj1cSDK(AFAdRevenueData());
            }
        } catch (Throwable th2) {
            throw th2;
        }
        ...
        if (this.equals == null) {
            ...
            if (context != null) {
                if (this.f10924i == null) {
                    this.f10924i = new AFi1iSDK();
                }
                AFi1kSDK aFi1kSDK = this.f10924i;
                ...
                if (this.f10926w == null) {
                    ...
                    if (context3 != null) {
                        this.f10926w = new AFi1pSDK(context3);
                    } else {
                        throw new IllegalStateException("Context must be set via setContext method before calling this dependency.");
                    }
                }
                AFi1pSDK aFi1pSDK = this.f10926w;
    ...
    public final AFi1pSDK d() {
        if (this.f10926w == null) {
            Context context = this.getCurrencyIso4217Code.getMonetizationNetwork;
            if (context != null) {
                this.f10926w = new AFi1pSDK(context);
            } else {
                throw new IllegalStateException("Context must be set via setContext method before calling this dependency.");
            }
        }
    ...
    public final synchronized AFa1cSDK e() {
        try {
            if (this.f10925v == null) {
                this.f10925v = new AFb1zSDK(AFInAppEventParameterName());
            }
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    public final AFb1aSDK v() {
        if (this.f10923e == null) {
            ...
            this.f10923e = new AFb1bSDK(level, i10, this.afInfoLog);
        }
        return this.f10923e;
    }
