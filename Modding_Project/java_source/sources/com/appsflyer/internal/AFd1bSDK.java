...
public class AFd1bSDK {
    ...
    public AFd1bSDK(@NonNull String str, @Nullable byte[] bArr, @NonNull String str2, @NonNull Map<String, String> map, boolean z10) {
    ...
    private AFd1bSDK(@NonNull String str, @Nullable byte[] bArr, @NonNull String str2, @NonNull Map<String, String> map, boolean z10, byte b10) {
