...
public final class AFe1dSDK extends AFe1fSDK<String> {
    ...
    protected final AFd1hSDK<String> AFAdRevenueData(@NonNull String str) {
        String obj;
                    ...
                    if (context != null) {
                        try {
                            if (aFk1vSDK.getCurrencyIso4217Code != null) {
                                context.startActivity(new Intent(CommonConstant.ACTION.HWID_SCHEME_URL, Uri.parse(aFk1vSDK.getCurrencyIso4217Code)).setFlags(268435456));
                                return;
                            }
                            return;
                        } catch (Exception e10) {
