...
public final class AFf1qSDK extends AFe1mSDK<AFf1pSDK> {
    ...
    */
    ...
    private void getCurrencyIso4217Code(String str, long j10, AFi1ySDK aFi1ySDK, @Nullable String str2, @Nullable AFe1wSDK<AFi1vSDK> aFe1wSDK) {
        AFi1vSDK aFi1vSDK;
        String str3;
        if (aFe1wSDK != null) {
        ...
        getMonetizationNetwork(str, j10, aFe1wSDK, aFi1vSDK, aFi1ySDK, str3, null);
    }
    ...
    private void getMonetizationNetwork(String str, long j10, @Nullable AFe1wSDK<?> aFe1wSDK, AFi1vSDK aFi1vSDK, AFi1ySDK aFi1ySDK, @Nullable String str2, @Nullable Throwable th2) {
        long j11;
        int i10;
        Throwable th3;
        long j12;
        ...
        if (th2 instanceof HttpException) {
            th3 = th2.getCause();
            j12 = ((HttpException) th2).getMetrics().getMediationNetwork;
        } else {
            th3 = th2;
            j12 = j11;
        }
        this.areAllFieldsValid = new AFi1wSDK(aFi1vSDK != null ? aFi1vSDK.AFAdRevenueData : null, str, j12, System.currentTimeMillis() - j10, i11, aFi1ySDK, str2, th3);
    }
}
