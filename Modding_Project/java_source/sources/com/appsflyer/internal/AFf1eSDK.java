...
public final class AFf1eSDK {
        ...
        while (true) {
            ...
            if (i11 < cArr2.length) {
                ...
                for (int i13 = 0; i13 < 16; i13++) {
                    ...
                    cArr4[1] = c12;
                    cArr4[0] = (char) (c11 - (((c12 >>> 5) + ((char) (areAllFieldsValid ^ (-1199070254561146252L)))) ^ ((c12 + i12) ^ ((c12 << 4) + ((char) (component4 ^ (-1199070254561146252L)))))));
                    i12 -= 40503;
                }
    ...
    public static /* synthetic */ Object getCurrencyIso4217Code(Object[] objArr, int i10, int i11, int i12) {
        ...
        if (i15 == 1) {
            ...
            sb2.append(AFb1kSDK.getCurrencyIso4217Code(((AFc1oSDK) objArr[1]).getMediationNetwork));
            ...
            int i16 = hashCode;
            equals = (i16 + 117) % 128;
            long j10 = ((AFf1eSDK) objArr[0]).getRevenue;
            equals = (i16 + 51) % 128;
    ...
    /* JADX WARN: Removed duplicated region for block: B:74:0x0083 A[Catch: Exception -> 0x0062, InvocationTargetException -> 0x0064, TRY_LEAVE, TryCatch #2 {InvocationTargetException -> 0x0064, Exception -> 0x0062, blocks: (B:63:0x0045, B:74:0x0083, B:70:0x0066), top: B:98:0x0043 }] */
    ...
    */
    public final java.lang.String getMonetizationNetwork(com.appsflyer.internal.AFc1qSDK r10) {
        /*
