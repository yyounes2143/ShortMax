...
public class AFi1aSDK extends AFi1cSDK {
    ...
    public final class AnonymousClass3 implements InstallReferrerStateListener {
        ...
        public final void onInstallReferrerSetupFinished(final int i10) {
            ...
            executorService.execute(new Runnable() { // from class: com.appsflyer.internal.y
                @Override // java.lang.Runnable
                public final void run() {
                    AFi1aSDK.AnonymousClass3.this.lambda$onInstallReferrerSetupFinished$0(installReferrerClient, context, i10);
                }
            });
        }
    }
    ...
    protected final void getMonetizationNetwork(InstallReferrerClient installReferrerClient, Context context, int i10) {
        this.getMonetizationNetwork.put(Module.ResponseKey.Code, String.valueOf(i10));
        Pair<Long, String> mediationNetwork = AFj1kSDK.getMediationNetwork(context, "com.android.vending");
        this.getMediationNetwork.put("api_ver", mediationNetwork.e());
        this.getMediationNetwork.put("api_ver_name", mediationNetwork.f());
        if (i10 == -1) {
            ...
            try {
                ...
                if (installReferrerClient.isReady()) {
                    ...
                    if (installReferrer2 != null) {
                        ...
                        this.getMediationNetwork.put(Constants.REFERRER, installReferrer2);
                    }
                ...
                this.getMonetizationNetwork.put(NotificationCompat.CATEGORY_ERROR, th2.getMessage());
