...
public final class AFj1sSDK {
    ...
    public /* synthetic */ void areAllFieldsValid(final Runnable runnable) {
        AFj1ySDK aFj1ySDK = new AFj1ySDK(this.getCurrencyIso4217Code.AFAdRevenueData(), this.getCurrencyIso4217Code.getMonetizationNetwork(), AFj1zSDK.INSTAGRAM, runnable, new Runnable() { // from class: com.appsflyer.internal.k0
    ...
    public /* synthetic */ void getMediationNetwork(Context context, Runnable runnable, AFd1zSDK aFd1zSDK) {
        ...
        for (AFj1tSDK aFj1tSDK : arrayList) {
            aFj1tSDK.getMonetizationNetwork(aFd1zSDK.AFInAppEventParameterName().getMonetizationNetwork);
        }
    }
    ...
    public final AFi1aSDK getCurrencyIso4217Code(final Runnable runnable) {
        return new AFi1aSDK(new Runnable() { // from class: com.appsflyer.internal.i0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void getRevenue(final Context context, final Runnable runnable, final AFd1zSDK aFd1zSDK) {
        if (aFd1zSDK.AFAdRevenueData().getMediationNetwork.getRevenue("appsFlyerCount", 0) > 0) {
            ...
            aFd1zSDK.getMonetizationNetwork().execute(new Runnable() { // from class: com.appsflyer.internal.j0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void AFAdRevenueData(final Runnable runnable) {
        this.getCurrencyIso4217Code.getMonetizationNetwork().execute(new Runnable() { // from class: com.appsflyer.internal.h0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void getRevenue(Runnable runnable) {
        AFj1ySDK aFj1ySDK = new AFj1ySDK(this.getCurrencyIso4217Code.AFAdRevenueData(), this.getCurrencyIso4217Code.getMonetizationNetwork(), AFj1zSDK.FACEBOOK_LITE, runnable, new Runnable() { // from class: com.appsflyer.internal.f0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void getMediationNetwork(final Runnable runnable) {
        this.getRevenue.add(new AFj1ySDK(this.getCurrencyIso4217Code.AFAdRevenueData(), this.getCurrencyIso4217Code.getMonetizationNetwork(), AFj1zSDK.FACEBOOK, runnable, new Runnable() { // from class: com.appsflyer.internal.g0
            @Override // java.lang.Runnable
            public final void run() {
