...
public final class AFj1wSDK extends AFi1cSDK {
    ...
    */
    public /* synthetic */ void getRevenue(android.content.Context r10) {
        /*
    ...
    public final void getMonetizationNetwork(final Context context) {
        ...
        this.AFAdRevenueData.getMonetizationNetwork().execute(new Runnable() { // from class: com.appsflyer.internal.m0
