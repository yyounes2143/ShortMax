...
public final class AFd1lSDK implements AFd1oSDK {
    ...
    public static /* synthetic */ Object AFAdRevenueData(Object[] objArr, int i10, int i11, int i12) {
        ...
        int i16 = i14 | (~i12);
        int i17 = ~(i12 | i13);
        int i18 = (i10 * 503) + (i11 * 503) + (i13 * (-502)) + ((i15 | (~i16) | i17) * (-502)) + (((~(i16 | i11)) | i17) * 502);
        return i18 != 1 ? i18 != 2 ? i18 != 3 ? getMonetizationNetwork(objArr) : getRevenue(objArr) : getMediationNetwork(objArr) : getCurrencyIso4217Code(objArr);
    }
            ...
            try {
                if (i10 % 2 != 0) {
                    ...
                    if (str4 != null) {
                        ...
                        if (i12 % 2 != 0) {
                            if (str4.length() > 0) {
                                this.getMediationNetwork.put(CommonConstant.KEY_UID, str4);
                            }
                        } else {
                            throw null;
                        }
