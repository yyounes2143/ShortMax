...
import yd.d;
/* compiled from: MyListEmptyView.kt */
@Metadata
/* loaded from: classes7.dex */
public final class MyListEmptyView extends BaseConstraintLayout implements la.b {
    @NotNull
    ...
    public static final class b extends d {
        ...
        public void a(View v10) {
            ...
            if (!(this.f47491e instanceof MainActivity)) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MyListEmptyView(@NotNull Context context) {
        super(context);
    ...
    public int getLayoutResource() {
        return R$layout.view_my_list_empty;
    }
    ...
    public void u(@NotNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        Intrinsics.checkNotNullParameter(context, "context");
        this.f47490b = (BaseTextView) findViewById(R$id.title_tv);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MyListEmptyView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
