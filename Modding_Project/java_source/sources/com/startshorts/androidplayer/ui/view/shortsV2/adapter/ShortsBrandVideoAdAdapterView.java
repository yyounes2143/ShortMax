...
public final class ShortsBrandVideoAdAdapterView extends BaseShortsAdapterView {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public ShortsBrandVideoAdAdapterView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShortsBrandVideoAdAdapterView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i10) {
