...
public final class CoinsRecordFragment extends RefreshFragment<WalletRecord, FragmentCoinsRecordBinding> {
    ...
    @NotNull
    private final i F = c.b(new Function0() { // from class: aj.k
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            WalletViewModel e12;
            e12 = CoinsRecordFragment.e1(CoinsRecordFragment.this);
            return e12;
        }
    });
    @NotNull
    private final CoinsRecordFragment$mPropertyObserver$1 G = new CoinsRecordFragment$mPropertyObserver$1(this);
    ...
    public static final WalletViewModel e1(final CoinsRecordFragment coinsRecordFragment) {
        WalletViewModel walletViewModel = (WalletViewModel) new ViewModelProvider(coinsRecordFragment).get(WalletViewModel.class);
        walletViewModel.o().observe(coinsRecordFragment, new b(new Function1() { // from class: aj.l
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit f12;
                f12 = CoinsRecordFragment.f1(CoinsRecordFragment.this, (ApiErrorState) obj);
                return f12;
            }
        }));
        walletViewModel.B().observe(coinsRecordFragment, new b(new Function1() { // from class: aj.m
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit g12;
                g12 = CoinsRecordFragment.g1(CoinsRecordFragment.this, (com.startshorts.androidplayer.viewmodel.wallet.b) obj);
                return g12;
            }
        }));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit f1(CoinsRecordFragment coinsRecordFragment, ApiErrorState apiErrorState) {
        boolean z10 = true;
        if (apiErrorState.getState() != 1) {
            z10 = false;
        }
        coinsRecordFragment.R0(null, z10, apiErrorState.getMsg());
        return Unit.f60915a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit g1(CoinsRecordFragment coinsRecordFragment, com.startshorts.androidplayer.viewmodel.wallet.b bVar) {
        if (bVar instanceof b.c) {
            RefreshFragment.S0(coinsRecordFragment, ((b.c) bVar).a(), false, null, 4, null);
        }
        return Unit.f60915a;
    }
