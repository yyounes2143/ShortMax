...
import com.startshorts.androidplayer.ui.fragment.mylist.ContainerMyCollectionFragment;
...
public final class CollectionListActivity extends PermissionActivity<ActivityMyListDetailBinding> {
    @NotNull

    /* renamed from: p  reason: collision with root package name */
    public static final a f45251p = new a(null);
    ...
    private final void K() {
        getSupportFragmentManager().beginTransaction().replace(R$id.fl_container, new ContainerMyCollectionFragment()).commitAllowingStateLoss();
    }
