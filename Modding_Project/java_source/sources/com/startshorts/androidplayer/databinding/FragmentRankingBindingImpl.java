...
public class FragmentRankingBindingImpl extends FragmentRankingBinding {
    ...
    private static final ViewDataBinding.IncludedLayouts f39603e = null;
    @Nullable

    /* renamed from: f  reason: collision with root package name */
    private static final SparseIntArray f39604f;
    @NonNull

    /* renamed from: c  reason: collision with root package name */
    private final FrameLayout f39605c;

    /* renamed from: d  reason: collision with root package name */
    private long f39606d;

    static {
        SparseIntArray sparseIntArray = new SparseIntArray();
        f39604f = sparseIntArray;
    ...
    public FragmentRankingBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, f39603e, f39604f));
    }
    ...
    private FragmentRankingBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (StateViewGroup) objArr[2], (LoadMoreRecyclerView) objArr[1]);
        this.f39606d = -1L;
        FrameLayout frameLayout = (FrameLayout) objArr[0];
        this.f39605c = frameLayout;
