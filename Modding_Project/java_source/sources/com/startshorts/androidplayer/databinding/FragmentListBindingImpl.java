...
public class FragmentListBindingImpl extends FragmentListBinding {
    ...
    private static final ViewDataBinding.IncludedLayouts f39514e = null;
    @Nullable

    /* renamed from: f  reason: collision with root package name */
    private static final SparseIntArray f39515f;
    @NonNull

    /* renamed from: c  reason: collision with root package name */
    private final ConstraintLayout f39516c;
    ...
    public FragmentListBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, f39514e, f39515f));
    }
    ...
    protected void executeBindings() {
        ...
        if (this.f39513b.getBinding() != null) {
            ViewDataBinding.executeBindingsOn(this.f39513b.getBinding());
        }
    }
    ...
    private FragmentListBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        ...
        this.f39516c = constraintLayout;
        constraintLayout.setTag(null);
        this.f39513b.setContainingBinding(this);
        setRootTag(view);
        invalidateAll();
    }
}
