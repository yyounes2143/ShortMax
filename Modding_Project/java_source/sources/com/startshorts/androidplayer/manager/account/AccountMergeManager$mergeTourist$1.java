...
public final class AccountMergeManager$mergeTourist$1 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {

    /* renamed from: h  reason: collision with root package name */
    int f41556h;

    /* JADX INFO: Access modifiers changed from: package-private */
    public AccountMergeManager$mergeTourist$1(c<? super AccountMergeManager$mergeTourist$1> cVar) {
        super(2, cVar);
    }
    ...
    public final Object invoke(g0 g0Var, c<? super Unit> cVar) {
        return ((AccountMergeManager$mergeTourist$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (Result.j(U0)) {
            mutableLiveData2 = AccountMergeManager.f41551b;
        ...
        if (g10 != null) {
            ...
            if (responseException != null) {
                mutableLiveData = AccountMergeManager.f41551b;
