...
public final class FieldType {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f14070b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f14070b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f14069a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f14069a[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f14068id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i10, int i11, Collection collection, JavaType javaType) {
        ...
        int i13 = a.f14069a[collection.ordinal()];
        boolean z10 = true;
        if (i13 != 1) {
            if (i13 != 2) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i12 = a.f14070b[javaType.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : false;
    }
