...
public enum EventType implements i0.c {
    ...
    private static final i0.d<EventType> internalValueMap = new i0.d<EventType>() { // from class: com.explorestack.protobuf.adcom.EventType.1
    ...
    public static i0.d<EventType> internalGetValueMap() {
