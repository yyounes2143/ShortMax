...
public enum DisplayCreativeType implements i0.c {
    ...
    private static final i0.d<DisplayCreativeType> internalValueMap = new i0.d<DisplayCreativeType>() { // from class: com.explorestack.protobuf.adcom.DisplayCreativeType.a
    ...
    public static final Descriptors.EnumDescriptor getDescriptor() {
        return b.a().getEnumTypes().get(11);
    }

    public static i0.d<DisplayCreativeType> internalGetValueMap() {
