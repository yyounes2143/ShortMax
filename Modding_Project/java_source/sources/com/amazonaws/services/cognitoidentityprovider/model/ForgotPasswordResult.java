...
public class ForgotPasswordResult implements Serializable {
    ...
    private CodeDeliveryDetailsType f5836a;
    ...
    public void d(CodeDeliveryDetailsType codeDeliveryDetailsType) {
        this.f5836a = codeDeliveryDetailsType;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (forgotPasswordResult.b() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (forgotPasswordResult.b() == null || forgotPasswordResult.b().equals(b())) {
            return true;
        }
        return false;
    }
