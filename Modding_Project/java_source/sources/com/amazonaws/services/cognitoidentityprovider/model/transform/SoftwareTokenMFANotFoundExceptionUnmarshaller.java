...
public class SoftwareTokenMFANotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean c(JsonErrorResponseHandler.JsonErrorResponse jsonErrorResponse) throws Exception {
        return jsonErrorResponse.c().equals("SoftwareTokenMFANotFoundException");
    }

    @Override // com.amazonaws.transform.JsonErrorUnmarshaller, com.amazonaws.transform.Unmarshaller
    /* renamed from: d */
    public AmazonServiceException a(JsonErrorResponseHandler.JsonErrorResponse jsonErrorResponse) throws Exception {
        SoftwareTokenMFANotFoundException softwareTokenMFANotFoundException = (SoftwareTokenMFANotFoundException) super.a(jsonErrorResponse);
        softwareTokenMFANotFoundException.h("SoftwareTokenMFANotFoundException");
