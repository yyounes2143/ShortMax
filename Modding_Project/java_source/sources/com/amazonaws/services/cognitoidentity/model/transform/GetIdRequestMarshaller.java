...
public class GetIdRequestMarshaller {
    public Request<GetIdRequest> a(GetIdRequest getIdRequest) {
        if (getIdRequest != null) {
            ...
            defaultRequest.q("X-Amz-Target", "AWSCognitoIdentityService.GetId");
            ...
            try {
                ...
                if (getIdRequest.r() != null) {
                    String r10 = getIdRequest.r();
                    b10.f("AccountId");
                    b10.e(r10);
                }
                if (getIdRequest.s() != null) {
                    String s10 = getIdRequest.s();
                    b10.f("IdentityPoolId");
                    b10.e(s10);
                }
                if (getIdRequest.t() != null) {
                    Map<String, String> t10 = getIdRequest.t();
                    b10.f("Logins");
                    b10.c();
