...
public abstract class HuaweiApiAvailability {
    ...
    public abstract f<Void> checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr);

    public abstract f<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr);
    ...
    public abstract f<Void> getHuaweiServicesReady(Activity activity);
