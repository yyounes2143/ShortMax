...
final class AndroidEmbeddableWebViewAdPlayer$show$3$2$1 extends SuspendLambda implements Function2<g0, c<? super Unit>, Object> {
    int label;
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super Unit> cVar) {
        return ((AndroidEmbeddableWebViewAdPlayer$show$3$2$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
