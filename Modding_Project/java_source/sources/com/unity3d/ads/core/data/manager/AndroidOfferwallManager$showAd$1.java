...
final class AndroidOfferwallManager$showAd$1 extends SuspendLambda implements Function2<c<? super OfferwallEventData>, rs.c<? super Unit>, Object> {
    ...
    public AndroidOfferwallManager$showAd$1(AndroidOfferwallManager androidOfferwallManager, String str, rs.c<? super AndroidOfferwallManager$showAd$1> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull c<? super OfferwallEventData> cVar, @Nullable rs.c<? super Unit> cVar2) {
        return ((AndroidOfferwallManager$showAd$1) create(cVar, cVar2)).invokeSuspend(Unit.f60915a);
    }
}
