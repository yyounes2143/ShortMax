...
final class AndroidOpenMeasurementRepository$impressionOccurred$2 extends SuspendLambda implements Function2<g0, c<? super OMResult>, Object> {
    ...
    public AndroidOpenMeasurementRepository$impressionOccurred$2(AndroidOpenMeasurementRepository androidOpenMeasurementRepository, ByteString byteString, boolean z10, c<? super AndroidOpenMeasurementRepository$impressionOccurred$2> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super OMResult> cVar) {
        return ((AndroidOpenMeasurementRepository$impressionOccurred$2) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
