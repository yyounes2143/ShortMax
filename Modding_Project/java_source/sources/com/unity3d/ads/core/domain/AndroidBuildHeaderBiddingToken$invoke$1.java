...
public final class AndroidBuildHeaderBiddingToken$invoke$1 extends ContinuationImpl {
    ...
    public AndroidBuildHeaderBiddingToken$invoke$1(AndroidBuildHeaderBiddingToken androidBuildHeaderBiddingToken, c<? super AndroidBuildHeaderBiddingToken$invoke$1> cVar) {
        super(cVar);
