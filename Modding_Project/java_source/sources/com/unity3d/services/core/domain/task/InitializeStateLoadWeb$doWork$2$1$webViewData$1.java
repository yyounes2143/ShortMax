...
@Metadata
@d(c = "com.unity3d.services.core.domain.task.InitializeStateLoadWeb$doWork$2$1$webViewData$1", f = "InitializeStateLoadWeb.kt", l = {71}, m = "invokeSuspend")
/* loaded from: classes7.dex */
final class InitializeStateLoadWeb$doWork$2$1$webViewData$1 extends SuspendLambda implements Function2<g0, c<? super String>, Object> {
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super String> cVar) {
        return ((InitializeStateLoadWeb$doWork$2$1$webViewData$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
