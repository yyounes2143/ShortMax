...
public final class InitializeStateReset$doWork$2 extends SuspendLambda implements Function2<g0, c<? super Result<? extends Configuration>>, Object> {
    ...
    public final Object invoke(@NotNull g0 g0Var, @Nullable c<? super Result<? extends Configuration>> cVar) {
        return ((InitializeStateReset$doWork$2) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
