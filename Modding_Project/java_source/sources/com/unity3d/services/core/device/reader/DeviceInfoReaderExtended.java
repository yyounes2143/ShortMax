...
public class DeviceInfoReaderExtended implements IDeviceInfoReader {
    ...
    public Map<String, Object> getDeviceInfoData() {
        ...
        deviceInfoData.put(MediaFormat.KEY_LANGUAGE, Locale.getDefault().toString());
        ...
        deviceInfoData.put(ITTVideoEngineEventSource.KEY_VOLUME, Integer.valueOf(Device.getStreamVolume(1)));
