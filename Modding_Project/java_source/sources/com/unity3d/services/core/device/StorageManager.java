...
public class StorageManager {
    ...
    public static boolean init(Context context) {
        ...
        addStorageLocation(storageType, filesDir + DomExceptionUtils.SEPARATOR + SdkProperties.getLocalStorageFilePrefix() + "public-data.json");
        if (!setupStorage(storageType)) {
            return false;
        }
        StorageType storageType2 = StorageType.PRIVATE;
        addStorageLocation(storageType2, filesDir + DomExceptionUtils.SEPARATOR + SdkProperties.getLocalStorageFilePrefix() + "private-data.json");
