...
@Metadata
@kotlin.coroutines.jvm.internal.d(c = "com.moloco.sdk.publisher.Moloco$createMREC$1", f = "Moloco.kt", l = {MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_SAVED_HOST_TIME}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class Moloco$createMREC$1 extends SuspendLambda implements Function2<g0, rs.c<? super Unit>, Object> {
    ...
    public Moloco$createMREC$1(MediationInfo mediationInfo, String str, String str2, Function2<? super Banner, ? super MolocoAdError.AdCreateError, Unit> function2, rs.c<? super Moloco$createMREC$1> cVar) {
        super(2, cVar);
    ...
    public final rs.c<Unit> create(Object obj, rs.c<?> cVar) {
        return new Moloco$createMREC$1(this.$mediationInfo, this.$adUnitId, this.$watermarkString, this.$callback, cVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            this.label = 1;
            obj = adCreator.l(name, str, a11, str2, this);
            if (obj == f10) {
                return f10;
            }
        }
    ...
    public final Object invoke(gt.g0 g0Var, rs.c<? super Unit> cVar) {
        return ((Moloco$createMREC$1) create(g0Var, cVar)).invokeSuspend(Unit.f60915a);
    }
}
