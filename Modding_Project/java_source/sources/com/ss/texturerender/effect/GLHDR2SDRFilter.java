...
public class GLHDR2SDRFilter extends GLDefaultFilter {
    ...
    public int init(Bundle bundle) {
        ...
        if (bundle != null) {
            this.mHDRType = bundle.getInt(TextureRenderKeys.KEY_IS_HDR_TYPE);
        }
        int i10 = this.mTexType;
        TextureRenderLog.i(i10, LOG_TAG, "init bundle:" + bundle.toString());
        return 0;
    }
    ...
    public void setOption(int i10, int i11) {
        ...
        TextureRenderLog.i(i12, LOG_TAG, "mHDRType:" + i11);
    }
}
