...
public class jFA extends kkU {
    ...
    public com.bytedance.sdk.openadsdk.core.Pfn.so ZYk(Context context) {
        ...
        soVar.setGravity(16);
        soVar.setMaxWidth(cdg.ZYk(context, 153.0f));
        soVar.setSingleLine();
        soVar.setText("Pangle");
    ...
    protected void oJ(Context context) {
        ...
        cfz2.setGravity(16);
        cfz2.setPadding(ZYk4, 0, 0, 0);
        cfz.addView(cfz2);
        si cFZ = cFZ(context);
        this.tB = cFZ;
        int i11 = eZI.yQF;
        cFZ.setId(i11);
        int ZYk5 = cdg.ZYk(context, 40.0f);
        ...
        this.ex = ZYk6;
        ZYk6.setId(eZI.YF);
        LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(cdg.ZYk(context, 130.0f), cdg.ZYk(context, 20.0f));
        layoutParams5.leftMargin = ZYk2;
        layoutParams5.setMarginStart(ZYk2);
        ...
        this.f12856ba = ex;
        ex.setId(eZI.eXp);
        RelativeLayout.LayoutParams layoutParams7 = new RelativeLayout.LayoutParams(cdg.ZYk(context, 80.0f), cdg.ZYk(context, 30.0f));
        layoutParams7.addRule(21);
        layoutParams7.addRule(11);
        layoutParams7.addRule(15);
        layoutParams7.rightMargin = ZYk;
        layoutParams7.setMarginEnd(ZYk);
        this.f12856ba.setLayoutParams(layoutParams7);
        cfz2.addView(this.f12856ba);
        View so2 = so(context);
        RelativeLayout.LayoutParams layoutParams8 = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams8.addRule(2, i10);
        layoutParams8.leftMargin = ZYk3;
    ...
    public com.bytedance.sdk.openadsdk.core.Pfn.so tB(Context context) {
        ...
        tB.setGravity(16);
        tB.setMaxWidth(cdg.ZYk(context, 153.0f));
        tB.setTextColor(-1);
        tB.setTextSize(2, 13.0f);
        return tB;
    }
    ...
    public jFA(Context context, AttributeSet attributeSet, int i10) {
