...
public class ex {
    ...
    private ex(Context context) {
        ...
        this.tB = new oJ.C0194oJ("sp_full_screen_video");
    }
    ...
    public void oJ(String str, cY cYVar) {
        if (com.bytedance.sdk.openadsdk.utils.ZYk.oJ()) {
            com.bytedance.sdk.openadsdk.common.oJ.oJ("sp_full_screen_video_new").oJ(str, cYVar);
    ...
    public void oJ() {
        ...
        File[] listFiles2;
        if (com.bytedance.sdk.openadsdk.utils.ZYk.oJ()) {
            com.bytedance.sdk.openadsdk.common.oJ.oJ("sp_full_screen_video_new").oJ();
            return;
        }
        try {
            boolean cFZ = com.bytedance.sdk.openadsdk.core.jFA.cFZ("sp_full_screen_video");
            if (cFZ) {
                str = "files";
            } else {
                str = "shared_prefs";
            ...
            if (file.exists() && file.isDirectory() && (listFiles2 = file.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.ex.1
        ...
        try {
            ...
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (listFiles = cacheDir.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.ex.2
                @Override // java.io.FileFilter
    ...
    public void oJ(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.oJ oJVar) {
        ...
        if (oJVar == null || oJVar.ba() == null || !oJVar.ba().cMS()) {
            if (com.bytedance.sdk.openadsdk.utils.ZYk.oJ()) {
                com.bytedance.sdk.openadsdk.common.oJ.oJ("sp_full_screen_video_new").oJ(adSlot, oJVar);
            } else if (oJVar == null || adSlot == null || !TextUtils.isEmpty(adSlot.getBidAdm()) || (ba2 = oJVar.ba()) == null || ba2.ocG() == 2) {
            } else {
                try {
                    this.tB.oJ(adSlot, oJVar.PiB().toString(), oJVar.ZYk());
                } catch (Throwable unused) {
                }
            }
        }
    ...
    public static ex oJ(Context context) {
        if (oJ == null) {
    ...
    public String oJ(String str, boolean z10) {
        com.bytedance.sdk.openadsdk.common.oJ oJ2 = com.bytedance.sdk.openadsdk.common.oJ.oJ("sp_full_screen_video_new");
    ...
    public boolean oJ(com.bytedance.sdk.openadsdk.core.model.oJ oJVar) {
        return com.bytedance.sdk.openadsdk.common.oJ.oJ("sp_full_screen_video_new").oJ(oJVar, true);
    }
    ...
    public void oJ(String str) {
        if (com.bytedance.sdk.openadsdk.utils.ZYk.oJ()) {
            com.bytedance.sdk.openadsdk.common.oJ.oJ("sp_full_screen_video_new").tB(str);
        } else {
            this.tB.ba(str);
        }
    }
