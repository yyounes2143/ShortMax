...
public class kkU {
    public static void oJ(String str, int i10, String str2, String str3, String str4) {
        try {
            ...
            if (oJ != null) {
                ...
                if (oJ.Wd() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        oJ.Wd().oJ(str2);
                        oJ.Wd().ZYk("Test the downloaded app");
                    } else {
                        oJ.Wd().oJ((String) null);
                        oJ.Wd().ZYk("");
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        oJ.Wd().tB(str3);
            ...
            arrayList.add(oJ);
            oJVar.oJ(arrayList);
            new WcQ(si.oJ(), oJVar).oJ(true);
        } catch (Exception e10) {
            QSm.tB("PlayableVerityHelper", e10.getMessage());
        }
    }
}
