...
public class so implements com.bytedance.sdk.component.ba.oJ.oJ.Pfn {
    public static final so oJ = new so();
    ...
    public SQLiteDatabase oJ(Context context) {
        if (this.ZYk == null) {
            synchronized (this) {
                try {
                    if (this.ZYk == null) {
                        this.ZYk = com.bytedance.sdk.openadsdk.core.Pfn.oJ(context).oJ().oJ();
                    }
                } catch (Throwable th2) {
                    throw th2;
                }
