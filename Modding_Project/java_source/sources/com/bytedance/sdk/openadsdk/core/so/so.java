...
public class so extends com.bytedance.sdk.openadsdk.core.ZYk.oJ {
    public so(@NonNull Context context, @NonNull com.bytedance.sdk.openadsdk.core.model.cY cYVar, @NonNull String str, int i10) {
    ...
    public com.bytedance.sdk.openadsdk.core.model.BTZ oJ(float f10, float f11, float f12, float f13, SparseArray<tB.oJ> sparseArray, long j10, long j11, View view, View view2, String str, float f14, int i10, float f15, int i11, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.QSm = i17;
        return new BTZ.oJ().ba(f16).Pfn(f17).ex(f18).tB(f19).ZYk(j12).oJ(j13).ZYk(oJ).oJ(iArr).tB(cdg.tB(view)).ex(iArr2).ex(this.HL).Pfn(this.IUZ).ba(this.Ln).ZYk(com.bytedance.sdk.openadsdk.core.jFA.ZYk().oJ() ? i14 : 2).oJ(sparseArray).oJ(str).oJ(f14).tB(i10).ZYk(f15).oJ(i11).oJ(jSONObject).ZYk(jSONObject2).oJ();
    }
