...
public class oJ extends WcQ<Integer, Integer> {
    public oJ(List<com.bytedance.adsdk.ZYk.cFZ.oJ<Integer>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.ZYk.oJ.ZYk.oJ<Integer, Integer> oJ() {
        return new com.bytedance.adsdk.ZYk.oJ.ZYk.ZYk(this.oJ);
    }
