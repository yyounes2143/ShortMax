...
public class ba extends cFZ<Integer> {
    public ba(List<com.bytedance.adsdk.ZYk.cFZ.oJ<Integer>> list) {
        super(list);
    }
    ...
    int tB(com.bytedance.adsdk.ZYk.cFZ.oJ<Integer> oJVar, float f10) {
        if (oJVar.oJ != null && oJVar.ZYk != null) {
            if (this.tB == null) {
                return com.bytedance.adsdk.ZYk.ba.Pfn.oJ(oJVar.so(), oJVar.jFA(), f10);
            }
