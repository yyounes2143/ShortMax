...
public class c {
    public com.mbridge.msdk.video.dynview.c a(Context context, List<CampaignEx> list) {
        ...
        try {
            float g10 = u0.g(com.mbridge.msdk.foundation.controller.c.m().d());
            ...
            if (list.size() <= 0 || list.get(0) == null) {
                ...
                i10 = com.mbridge.msdk.video.dynview.util.a.a(list.get(0));
                i11 = list.get(0).getMof_tplid();
                str = list.get(0).getMof_template_url();
                i12 = list.get(0).getDynamicTempCode();
            }
            if (i11 != 0 && !TextUtils.isEmpty(str)) {
                arrayList = n0.a(y.a(0, i11 + "", str), "template_" + i11 + "_" + i10);
            }
            ...
            return com.mbridge.msdk.video.dynview.c.a().a(context).c(str2).b(1).b(f10).a(g10).a(list).orientation(i10).fileDirs(arrayList).d(i12).a(i11).build();
        } catch (Exception e10) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x0058 A[Catch: Exception -> 0x0027, TryCatch #0 {Exception -> 0x0027, blocks: (B:5:0x0004, B:8:0x0016, B:12:0x002c, B:19:0x003e, B:21:0x0052, B:23:0x0058, B:24:0x0082, B:26:0x009f, B:27:0x00a3), top: B:31:0x0004 }] */
    /* JADX WARN: Removed duplicated region for block: B:26:0x009f A[Catch: Exception -> 0x0027, TryCatch #0 {Exception -> 0x0027, blocks: (B:5:0x0004, B:8:0x0016, B:12:0x002c, B:19:0x003e, B:21:0x0052, B:23:0x0058, B:24:0x0082, B:26:0x009f, B:27:0x00a3), top: B:31:0x0004 }] */
    /*
    ...
    */
    public com.mbridge.msdk.video.dynview.c b(android.view.View r12, com.mbridge.msdk.foundation.entity.CampaignEx r13) {
        ...
        L2c:
            ...
            r8 = -5
            int r7 = com.mbridge.msdk.foundation.tools.u0.a(r6, r7, r8)     // Catch: java.lang.Exception -> L27
            if (r3 == 0) goto L50
        ...
        L52:
            ...
            r4 = 1
            java.lang.String r1 = com.mbridge.msdk.foundation.tools.y.a(r4, r1, r6)     // Catch: java.lang.Exception -> L27
            ...
            java.util.List r1 = com.mbridge.msdk.foundation.tools.n0.a(r1, r4)     // Catch: java.lang.Exception -> L27
        L82:
        ...
        La3:
            ...
            int r12 = com.mbridge.msdk.foundation.tools.l0.F(r12)     // Catch: java.lang.Exception -> L27
        ...
        Lf9:
            ...
            com.mbridge.msdk.foundation.tools.p0.b(r13, r12)
            return r0
        */
    ...
    public com.mbridge.msdk.video.dynview.c a(View view, CampaignEx campaignEx) {
        ...
        try {
            com.mbridge.msdk.videocommon.setting.c a10 = com.mbridge.msdk.videocommon.setting.b.b().a(com.mbridge.msdk.foundation.controller.c.m().b(), campaignEx.getCampaignUnitId(), false);
            int D = a10 != null ? a10.D() : 0;
            ArrayList arrayList = new ArrayList();
            arrayList.add(campaignEx);
            return com.mbridge.msdk.video.dynview.c.a().c("mbridge_reward_layer_floor_bottom").b(3).a(arrayList).a(view.getContext()).a(view).c(D).orientation(l0.F(view.getContext())).build();
        } catch (Exception e10) {
            p0.b("ViewOptionWrapper", e10.getMessage());
            return null;
        }
            ...
            try {
                if (list.size() != 0) {
                    ...
                    if (mof_tplid != 0 && !TextUtils.isEmpty(mof_template_url)) {
                        arrayList = n0.a(y.a(0, mof_tplid + "", mof_template_url), "template_" + mof_tplid + "_" + F);
                    }
                    return com.mbridge.msdk.video.dynview.c.a().c(F == 1 ? "mbridge_order_layout_list_portrait" : "mbridge_order_layout_list_landscape").b(5).a(context).b(f10).a(g10).a(list).orientation(F).fileDirs(arrayList).d(dynamicTempCode).a(mof_tplid).build();
                }
            } catch (Exception e10) {
                p0.b("ViewOptionWrapper", e10.getMessage());
            }
    ...
    public com.mbridge.msdk.video.dynview.c a(Context context, CampaignEx campaignEx, int i10, String str) {
        ...
        try {
            ...
            int F = l0.F(context);
            int a10 = u0.a(campaignEx.getendcard_url(), "n_logo", 1);
            ...
            if (!TextUtils.isEmpty(campaignEx.getendcard_url())) {
                arrayList = n0.a(y.a(2, i10 + "", campaignEx.getendcard_url()), str3);
            }
            return com.mbridge.msdk.video.dynview.c.a().c(str2).b(4).a(context).orientation(l0.F(context)).fileDirs(arrayList).d(campaignEx.getDynamicTempCode()).a(i10).a(str).e(a10).build();
        } catch (Exception e10) {
            p0.b("ViewOptionWrapper", e10.getMessage());
            return null;
        }
