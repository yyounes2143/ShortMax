...
public class d extends b {
    ...
    private com.mbridge.msdk.videocommon.setting.c f30654d;
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x0037 A[Catch: Exception -> 0x005c, TryCatch #0 {Exception -> 0x005c, blocks: (B:2:0x0000, B:4:0x0010, B:6:0x001a, B:8:0x0024, B:10:0x002d, B:12:0x0037, B:14:0x003d, B:16:0x0044, B:18:0x004e, B:19:0x0052, B:20:0x0056), top: B:23:0x0000 }] */
    /* JADX WARN: Removed duplicated region for block: B:14:0x003d A[Catch: Exception -> 0x005c, TryCatch #0 {Exception -> 0x005c, blocks: (B:2:0x0000, B:4:0x0010, B:6:0x001a, B:8:0x0024, B:10:0x002d, B:12:0x0037, B:14:0x003d, B:16:0x0044, B:18:0x004e, B:19:0x0052, B:20:0x0056), top: B:23:0x0000 }] */
    ...
    */
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar) {
        super.a(cVar);
        if (this.f30653c == null || this.f30659i) {
            return;
        }
        this.f30659i = true;
        b();
        this.f30653c.a(cVar);
        this.f30653c.a(2, this.f30656f, this.f30655e);
    }
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar, boolean z10, com.mbridge.msdk.videocommon.entity.c cVar2) {
        ...
        h hVar = this.f30653c;
        if (hVar == null || this.f30661k) {
            return;
        }
        this.f30661k = true;
        hVar.a(7, this.f30656f, this.f30655e);
        this.f30653c.a(cVar, z10, cVar2);
    }
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar, String str) {
        super.a(cVar, str);
        if (this.f30653c == null || this.f30660j) {
            return;
        }
        this.f30660j = true;
        a();
        this.f30653c.a(cVar, str);
        this.f30653c.a(4, this.f30656f, this.f30655e);
    }
