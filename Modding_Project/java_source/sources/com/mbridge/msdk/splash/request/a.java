...
public class a {
    public static com.mbridge.msdk.foundation.same.net.wrapper.e a(Context context, MBridgeIds mBridgeIds, f fVar) {
        ...
        String a10 = com.mbridge.msdk.foundation.same.buffer.b.a(mBridgeIds.getUnitId(), AdmobPreloadConfig.APP_OPEN);
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, "ad_type", MediaPlayer.MEDIA_PLAYER_OPTION_SKIP_BUFFER_LIMIT + "");
