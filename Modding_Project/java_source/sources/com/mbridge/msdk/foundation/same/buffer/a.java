...
public class a {
    ...
    private final LinkedHashMap<String, JSONObject> f27047a;
    ...
    public a(int i10) {
        if (i10 > 0) {
            this.f27048b = i10;
            this.f27047a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final boolean a(String str, JSONObject jSONObject) {
        if (str != null && jSONObject != null) {
            synchronized (this) {
                try {
                    this.f27049c += b(str, jSONObject);
                    JSONObject put = this.f27047a.put(str, jSONObject);
                    if (put != null) {
                        this.f27049c -= b(str, put);
                    }
                } catch (Throwable th2) {
                    throw th2;
                }
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", Integer.valueOf(this.f27048b));
    }
    ...
    public final JSONObject a(String str) {
        ...
        if (str != null) {
            synchronized (this) {
                jSONObject = this.f27047a.get(str);
            }
            return jSONObject;
        }
    ...
    public Collection<String> a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f27047a.keySet());
        }
        return hashSet;
    }
    ...
    */
    private void a(int r4) {
        ...
        L0:
            monitor-enter(r3)
            int r0 = r3.f27049c     // Catch: java.lang.Throwable -> L12
            if (r0 < 0) goto L56
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r3.f27047a     // Catch: java.lang.Throwable -> L12
        ...
        L35:
            ...
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r2 = r3.f27047a     // Catch: java.lang.Throwable -> L52
            ...
            int r1 = r3.f27049c     // Catch: java.lang.Throwable -> L52
            int r1 = r1 - r0
            r3.f27049c = r1     // Catch: java.lang.Throwable -> L52
        L52:
            monitor-exit(r3)     // Catch: java.lang.Throwable -> L12
            goto L0
        L54:
