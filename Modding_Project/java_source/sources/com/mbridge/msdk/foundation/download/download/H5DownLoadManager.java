...
public class H5DownLoadManager {
    ...
    private H5DownLoadManager() {
        ...
        try {
            ...
            g d10 = h.b().d(c.m().b());
            if (d10 != null) {
                this.isUseDownloadModule = d10.b(1);
            }
        } catch (Throwable th2) {
                        ...
                        public void onSuccess(String str2, byte[] bArr, String str3) {
                            try {
                                ...
                                if (h5ResDownloadListerInter5 != null) {
                                    h5ResDownloadListerInter5.onFailed(str3, e10.getMessage());
                                    return;
                                }
                                eVar.a("result", 3);
    ...
    private void downloadZipByDownloadModule(final com.mbridge.msdk.foundation.same.report.metrics.c cVar, String str, final ZipDownloadListener zipDownloadListener) {
        ...
        try {
            ...
            String b10 = com.mbridge.msdk.foundation.same.directory.e.b(com.mbridge.msdk.foundation.same.directory.c.MBRIDGE_700_RES);
            String md5 = SameMD5.getMD5(b1.b(str));
            String str2 = b10 + DomExceptionUtils.SEPARATOR;
            final String str3 = b10 + DomExceptionUtils.SEPARATOR + md5;
            ...
            MBDownloadManager.getInstance().download(downloadMessage).withReadTimeout(30000L).withConnectTimeout(20000L).withDownloadPriority(DownloadPriority.HIGH).withHttpRetryCounter(1).withDirectoryPathInternal(str2).withTimeout(ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS).withDownloadStateListener(new OnDownloadStateListener() { // from class: com.mbridge.msdk.foundation.download.download.H5DownLoadManager.3
                ...
                public void onCancelDownload(DownloadMessage downloadMessage2) {
                    ...
                    if (eVar2 != null) {
                        ...
                        eVar2.a("cache", Integer.valueOf(i10));
                    }
                ...
                public void onDownloadComplete(DownloadMessage downloadMessage2) {
                    ...
                    try {
                        ...
                        p0.a(H5DownLoadManager.TAG, "下载结束，开始解压缩文件，文件解压成功： " + str3);
                        ZipDownloadListener zipDownloadListener2 = zipDownloadListener;
                        if (zipDownloadListener2 != null) {
    ...
    private long getPreSaveTimeFromSp(String str) {
        try {
            Context d10 = c.m().d();
            Object a10 = x0.a(d10, SP_ENDING_PAGE_SAVE_TIME + str, 0L);
            if (a10 != null && (a10 instanceof Long)) {
    ...
    private void saveSourceContent(String str, String str2) {
        try {
            ...
            Context d10 = c.m().d();
            x0.b(d10, SP_ENDING_PAGE_SOURCE + str2, str);
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    }
    ...
    private void updateEndingPageSaveTime(String str) {
        try {
            Context d10 = c.m().d();
            x0.b(d10, SP_ENDING_PAGE_SAVE_TIME + str, Long.valueOf(System.currentTimeMillis()));
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    }
    ...
    public String getSourceContentFromSp(String str) {
        try {
            Context d10 = c.m().d();
            Object a10 = x0.a(d10, SP_ENDING_PAGE_SOURCE + str, "");
