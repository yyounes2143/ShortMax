...
public class ResDownloadCheckManager {
        ...
        if (list != null && list.size() != 0) {
            for (String str : list) {
                if (!TextUtils.isEmpty(str) && (concurrentHashMap = recordImageMap) != null && !concurrentHashMap.containsKey(str)) {
                    boolean c10 = b.a(c.m().d()).c(str);
                    if (!TextUtils.isEmpty(str)) {
                        recordImageMap.put(str, Boolean.valueOf(c10));
                    }
                }
            }
        }
    ...
    private boolean getIsEffectivePath(String str) {
        String d10 = n0.d(str);
        File file = new File(e.b(com.mbridge.msdk.foundation.same.directory.c.MBRIDGE_VC) + File.separator + d10);
        try {
    ...
    public boolean checkImageState(boolean z10, CampaignEx.c cVar) {
        ...
        if (cVar != null && (a10 = cVar.a()) != null) {
            for (CampaignEx.c.a aVar : a10) {
                if (aVar != null && (list = aVar.f26841a) != null) {
                    for (String str : list) {
                        if (!checkImageUrlState(z10, str)) {
                            return false;
                        }
                    }
                    continue;
