...
public class m extends a<Campaign> {
    ...
    /* JADX WARN: Type inference failed for: r1v11, types: [com.mbridge.msdk.foundation.entity.m] */
    ...
    */
    public synchronized com.mbridge.msdk.foundation.entity.m b(java.lang.String r6, java.lang.String r7) {
        /*
            ...
            return r0
        La:
            com.mbridge.msdk.foundation.entity.m r7 = new com.mbridge.msdk.foundation.entity.m     // Catch: java.lang.Throwable -> La8
        ...
        L95:
            ...
            com.mbridge.msdk.foundation.tools.p0.b(r1, r6)     // Catch: java.lang.Throwable -> L8e
        La2:
            if (r0 == 0) goto Laa
        La4:
    ...
    public synchronized long b(String str, long j10) {
        ...
        if (a(str, "")) {
            ...
            synchronized (new Object()) {
                i10 = getWritableDatabase().update("video", contentValues, "video_url = ? ", strArr);
            }
        }
        return i10;
    }
    ...
    public synchronized long a(String str, long j10, int i10) {
        ...
        if (a(str, "")) {
            String[] strArr = {str};
            synchronized (new Object()) {
                i11 = getWritableDatabase().update("video", contentValues, "video_url = ? ", strArr);
            }
        }
        return i11;
    }
