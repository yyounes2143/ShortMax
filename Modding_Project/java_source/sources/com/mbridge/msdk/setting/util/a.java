...
public class a {
    ...
    /* loaded from: classes6.dex */
    public class C0420a extends com.mbridge.msdk.foundation.same.net.handler.a {
        ...
        public void a(String str) {
            p0.a("MraidJSController", "fail request mraid js. " + str);
        }

        @Override // com.mbridge.msdk.foundation.same.net.handler.a
        public void b(String str) {
            p0.a("MraidJSController", "request mraid js success, content = " + str);
            if (!TextUtils.isEmpty(str)) {
                a.this.f29039a = str;
                a.this.a(str, this.f29040b);
            }
        }
    }
    ...
    public class b implements Runnable {
        ...
        public void run() {
            try {
                ...
                n0.a(this.f29042a.getBytes(), file);
                com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController", this.f29043b);
            } catch (Exception e10) {
                p0.a("MraidJSController", e10.getMessage());
            }
        }
    }
    ...
    public void a(Context context, String str) {
        ...
        String a10 = com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController");
        if (TextUtils.isEmpty(a10) || !a10.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0420a(str), "mraid_js", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
            } catch (Exception e10) {
                p0.b("MraidJSController", e10.getMessage());
            }
        }
    }
