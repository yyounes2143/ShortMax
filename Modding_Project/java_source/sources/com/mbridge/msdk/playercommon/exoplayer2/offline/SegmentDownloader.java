...
public abstract class SegmentDownloader<M extends FilterableManifest<M, K>, K> implements Downloader {
    ...
    public static class Segment implements Comparable<Segment> {
        ...
        public int compareTo(@NonNull Segment segment) {
            int i10 = ((this.startTimeUs - segment.startTimeUs) > 0L ? 1 : ((this.startTimeUs - segment.startTimeUs) == 0L ? 0 : -1));
            if (i10 == 0) {
                return 0;
            }
            return i10 < 0 ? -1 : 1;
    ...
    protected abstract List<Segment> getSegments(DataSource dataSource, M m10, boolean z10) throws InterruptedException, IOException;
