...
public class MBSplashShakeView extends MBLinearLayout {
    ...
    private final String f26226j;

    /* renamed from: k  reason: collision with root package name */
    private final String f26227k;

    /* renamed from: l  reason: collision with root package name */
    private ImageView f26228l;

    /* renamed from: m  reason: collision with root package name */
    private Animation f26229m;

    public MBSplashShakeView(Context context) {
        super(context);
        this.f26222f = "浏览第三方应用";
        this.f26223g = "View";
        this.f26224h = "打开第三方应用";
        this.f26225i = "Open";
        this.f26226j = "下载第三方应用";
        this.f26227k = "Install";
    }
    ...
    public void initView(String str) {
        ...
        this.f26228l = new ImageView(getContext());
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(u0.a(getContext(), 40.0f), u0.a(getContext(), 40.0f));
        layoutParams.gravity = 17;
        this.f26228l.setLayoutParams(layoutParams);
        this.f26228l.setImageResource(getResources().getIdentifier("mbridge_cm_btn_shake", "drawable", c.m().h()));
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        frameLayout.addView(imageView);
        frameLayout.addView(this.f26228l);
    ...
    private void a() {
        ...
        this.f26229m = rotateAnimation;
        rotateAnimation.setDuration(100L);
        this.f26229m.setRepeatMode(2);
        this.f26229m.setRepeatCount(-1);
        this.f26228l.startAnimation(this.f26229m);
    }
