...
public class d {
    ...
    private static final String f27749a = c.class.getSimpleName();
    ...
    public static e a(Context context, String str, String str2, int i10, a aVar) {
        ...
        String a10 = u0.a(context, str);
        String a11 = com.mbridge.msdk.foundation.same.buffer.b.a(str, "banner");
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f27191h, a10);
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, CampaignEx.JSON_KEY_AD_SOURCE_ID, "1");
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f27192i, str2);
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f27190g, a11);
