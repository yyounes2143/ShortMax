...
public class c {
    ...
    private final LinkedHashMap<String, b> f26129a;
    ...
    public c(int i10) {
        if (i10 > 0) {
            this.f26130b = i10;
            this.f26129a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", Integer.valueOf(this.f26130b));
    }
    ...
    public final void b(String str) {
        if (str != null) {
            synchronized (this) {
                try {
                    b remove = this.f26129a.remove(str);
                    if (remove != null) {
                        this.f26131c -= b(str, remove);
                    }
                } catch (Throwable th2) {
                    throw th2;
                }
    ...
    public final boolean a(String str, b bVar) {
        if (str != null && bVar != null) {
            synchronized (this) {
                try {
                    this.f26131c += b(str, bVar);
                    b put = this.f26129a.put(str, bVar);
                    if (put != null) {
                        this.f26131c -= b(str, put);
                    }
                } catch (Throwable th2) {
                    throw th2;
                }
    ...
    */
    private void a(int r4) {
        ...
        L0:
            monitor-enter(r3)
            int r0 = r3.f26131c     // Catch: java.lang.Throwable -> L12
            if (r0 < 0) goto L53
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.click.retry.b> r0 = r3.f26129a     // Catch: java.lang.Throwable -> L12
        ...
        L35:
            ...
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.click.retry.b> r2 = r3.f26129a     // Catch: java.lang.Throwable -> L4f
            r2.remove(r1)     // Catch: java.lang.Throwable -> L4f
            int r1 = r3.f26131c     // Catch: java.lang.Throwable -> L4f
            int r1 = r1 - r0
            r3.f26131c = r1     // Catch: java.lang.Throwable -> L4f
        L4f:
            monitor-exit(r3)     // Catch: java.lang.Throwable -> L12
            goto L0
        L51:
    ...
    public Collection<String> a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f26129a.keySet());
        }
        return hashSet;
    }
}
