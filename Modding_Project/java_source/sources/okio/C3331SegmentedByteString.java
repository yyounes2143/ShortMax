...
public final class C3331SegmentedByteString extends ByteString {
    @NotNull
    ...
    public C3331SegmentedByteString(@NotNull byte[][] segments, @NotNull int[] directory) {
    ...
    public void copyInto(int i10, @NotNull byte[] target, int i11, int i12) {
        ...
        int i14 = i12 + i10;
        int segment = okio.internal.SegmentedByteString.segment(this, i10);
        while (i10 < i14) {
            if (segment == 0) {
                i13 = 0;
            } else {
            ...
            int i16 = i15 + (i10 - i13);
            n.h(getSegments$okio()[segment], target, i11, i16, i16 + min);
            i11 += min;
            i10 += min;
            segment++;
        }
        ...
        if (i10 >= 0) {
            if (resolveDefaultParameter <= size()) {
                ...
                if (i12 >= 0) {
                    ...
                    byte[][] bArr = (byte[][]) n.y(getSegments$okio(), segment, segment2 + 1);
    ...
    public byte[] toByteArray() {
        ...
        while (i10 < length) {
            ...
            int i14 = getDirectory$okio()[i10];
            int i15 = i14 - i11;
            n.h(getSegments$okio()[i10], bArr, i12, i13, i13 + i15);
            i12 += i15;
            i10++;
            i11 = i14;
        }
