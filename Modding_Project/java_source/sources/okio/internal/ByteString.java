...
public final class ByteString {
        ...
        if (i10 >= 0) {
            if (resolveDefaultParameter <= byteString.getData$okio().length) {
                if (resolveDefaultParameter - i10 >= 0) {
                    ...
                    return new okio.ByteString(n.w(byteString.getData$okio(), i10, resolveDefaultParameter));
                }
    ...
    public static final okio.ByteString commonToByteString(@NotNull byte[] bArr, int i10, int i11) {
        ...
        return new okio.ByteString(n.w(bArr, i10, resolveDefaultParameter + i10));
    }
            ...
            if (codePointIndexToCharIndex == -1) {
                ...
                if (resolveDefaultParameter <= byteString.getData$okio().length) {
                    if (resolveDefaultParameter >= 0) {
                        if (resolveDefaultParameter != byteString.getData$okio().length) {
                            byteString2 = new okio.ByteString(n.w(byteString.getData$okio(), 0, resolveDefaultParameter));
                        }
