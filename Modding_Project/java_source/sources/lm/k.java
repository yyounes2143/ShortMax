...
public class k extends r {
    ...
    public static final class b extends RewardedAdLoadCallback {
        ...
        private final k f62260a;
        @NonNull

        /* renamed from: b  reason: collision with root package name */
        private final q f62261b;
        ...
        public /* synthetic */ void c(LoadAdError loadAdError) {
            this.f62261b.b(this.f62260a, o.b(fr.a.f51921q, loadAdError));
        }
        ...
        public /* synthetic */ void d(RewardedAd rewardedAd) {
            ...
            this.f62260a.C(e10);
            this.f62261b.a(this.f62260a, e10);
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(@NonNull final LoadAdError loadAdError) {
            this.f62260a.E(new Runnable() { // from class: lm.l
        ...
        public void onAdLoaded(@NonNull final RewardedAd rewardedAd) {
            ...
            this.f62260a.f62259k = rewardedAd;
            this.f62260a.E(new Runnable() { // from class: lm.m
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static final class c implements OnPaidEventListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final k f62262a;

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void b(AdValue adValue) {
            this.f62262a.F(o.f(adValue));
        }

        @Override // com.google.android.gms.ads.OnPaidEventListener
        public void onPaidEvent(@NonNull final AdValue adValue) {
            this.f62262a.E(new Runnable() { // from class: lm.n
                @Override // java.lang.Runnable
                public final void run() {
                    k.c.this.b(adValue);
                }
    ...
    protected void N(@NonNull Activity activity, @NonNull hm.o oVar) {
        RewardedAd rewardedAd = this.f62259k;
        if (rewardedAd != null) {
            rewardedAd.setFullScreenContentCallback(new f(oVar));
            this.f62259k.show(activity, new d());
            return;
        }
    ...
    protected void k() {
        ...
        if (rewardedAd != null) {
            ...
            this.f62259k.setOnPaidEventListener(null);
            this.f62259k = null;
        }
    }
