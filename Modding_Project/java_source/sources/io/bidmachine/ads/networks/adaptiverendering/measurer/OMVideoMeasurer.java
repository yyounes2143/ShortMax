...
public class OMVideoMeasurer extends OMMeasurer<View> implements VideoMeasurer {
    ...
    final List<VerificationScriptResource> f53625g;
    @NonNull
    @VisibleForTesting

    /* renamed from: h  reason: collision with root package name */
    final VastProperties f53626h;
    ...
    class b implements Runnable {
        ...
        final /* synthetic */ float f53628a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ float f53629b;
        ...
        public void run() {
            try {
                MediaEvents mediaEvents = OMVideoMeasurer.this.f53613f;
                if (mediaEvents != null) {
                    mediaEvents.start(this.f53628a / 1000.0f, this.f53629b);
                    OMVideoMeasurer.this.h("onMediaStarted");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
        ...
        public void run() {
            try {
                ...
                if (mediaEvents != null) {
                    ...
                    OMVideoMeasurer.this.h("onMediaFirstQuartile");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
        ...
        public void run() {
            try {
                ...
                if (mediaEvents != null) {
                    ...
                    OMVideoMeasurer.this.h("onMediaMidpoint");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
        ...
        public void run() {
            try {
                ...
                if (mediaEvents != null) {
                    ...
                    OMVideoMeasurer.this.h("onMediaThirdQuartile");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
        ...
        public void run() {
            try {
                ...
                if (mediaEvents != null) {
                    ...
                    OMVideoMeasurer.this.h("onMediaCompleted");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
    ...
    class g implements Runnable {
        ...
        public void run() {
            try {
                ...
                if (mediaEvents != null) {
                    mediaEvents.pause();
                    OMVideoMeasurer.this.h("onMediaPaused");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
    ...
    class h implements Runnable {
        ...
        public void run() {
            try {
                ...
                if (mediaEvents != null) {
                    mediaEvents.resume();
                    OMVideoMeasurer.this.h("onMediaResumed");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
    ...
    class i implements Runnable {
        ...
        public void run() {
            try {
                MediaEvents mediaEvents = OMVideoMeasurer.this.f53613f;
                if (mediaEvents != null) {
                    mediaEvents.volumeChange(this.f53637a);
                    OMVideoMeasurer.this.h("onMediaVolumeChanged");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
    ...
    class j implements Runnable {
        ...
        public void run() {
            try {
                ...
                if (mediaEvents != null) {
                    mediaEvents.skipped();
                    OMVideoMeasurer.this.h("onMediaSkipped");
                }
            } catch (Throwable th2) {
                io.bidmachine.core.a.m(th2);
            }
    ...
    public OMVideoMeasurer(@NonNull List<VerificationScriptResource> list, @Nullable Float f10) {
        ...
        if (f10 != null && f10.floatValue() >= 0.0f) {
            createVastPropertiesForNonSkippableMedia = VastProperties.createVastPropertiesForSkippableMedia(f10.floatValue(), true, Position.STANDALONE);
        } else {
        ...
        this.f53626h = createVastPropertiesForNonSkippableMedia;
    }
    ...
    public void F0(@FloatRange(from = 0.0d, to = 1.0d) float f10) {
        io.bidmachine.core.g.Z(new i(f10));
    }
    ...
    protected void i(@NonNull AdEvents adEvents) throws Throwable {
        adEvents.loaded(this.f53626h);
    }
    ...
    @Override // io.bidmachine.rendering.measurer.Measurer
    public void w(@NonNull View view, @NonNull ViewGroup viewGroup) {
        k(viewGroup);
    }

    @Override // io.bidmachine.rendering.measurer.VideoMeasurer
    public void z0(float f10, @FloatRange(from = 0.0d, to = 1.0d) float f11) {
        io.bidmachine.core.g.Z(new b(f10, f11));
    }
}
