...
public final class Requirements implements Parcelable {
    ...
    public Requirements(int i10) {
        this.f56679a = (i10 & 2) != 0 ? i10 | 1 : i10;
    }
    ...
    private int a(Context context) {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) cn.a.e(context.getSystemService("connectivity"));
    ...
    private boolean e(Context context) {
        PowerManager powerManager = (PowerManager) cn.a.e(context.getSystemService("power"));
        if (m0.f3614a >= 23) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && Requirements.class == obj.getClass() && this.f56679a == ((Requirements) obj).f56679a) {
            return true;
        }
        return false;
    }
